...
<div class="container">
    ...
    <h1 class="h4 text-truncate mb-4"><i class="fas fa-fw fa-xs fa-mobile mr-1"></i> <?= l('pwa_create.header') ?></h1>
                ...
                <div class="card-body">
                    ...
                    <form id="pwa_create" action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="start_url" name="start_url" class="form-control" value="<?= $data->values['start_url'] ?>" maxlength="2048" placeholder="<?= l('global.url_placeholder') ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_url" name="app_icon_url" class="form-control" value="<?= $data->values['app_icon_url'] ?? '' ?>" maxlength="2048" required="required" placeholder="<?= l('pwas.icon_url_placeholder') ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_maskable_url" name="app_icon_maskable_url" class="form-control" value="<?= $data->values['app_icon_maskable_url'] ?? '' ?>" maxlength="2048" placeholder="<?= l('pwas.icon_url_placeholder') ?>" />
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="advanced_container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="scope_url" name="scope_url" class="form-control <?= \Altum\Alerts::has_field_errors('scope_url') ? 'is-invalid' : null ?>" maxlength="2048" value="<?= $data->values['scope_url'] ?>" placeholder="<?= l('global.url_placeholder') ?>" />
