...
<div dir="{{DIRECTION}}" class="altum" style="margin: 0 !important; padding: 15px !important; width: {{WIDTH}}px !important; max-width: 450px !important; background: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 10px;">
