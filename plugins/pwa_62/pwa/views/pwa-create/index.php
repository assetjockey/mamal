    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('pwa_create.breadcrumb') ?></li>
            </ol>
        </nav>
    <?php endif ?>

    <h1 class="h4 text-truncate"><i class="fas fa-fw fa-xs fa-mobile mr-1"></i> <?= l('pwa_create.header') ?></h1>
    <p></p>
                ...
                <div class="card-body">
                    ...
                    <form id="pwa_create" action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control <?= \Altum\Alerts::has_field_errors('name') ? 'is-invalid' : null ?>" value="<?= $data->values['name'] ?>" maxlength="30" required="required" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="short_name" name="short_name" class="form-control <?= \Altum\Alerts::has_field_errors('short_name') ? 'is-invalid' : null ?>" maxlength="12" value="<?= $data->values['short_name'] ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="description" name="description" class="form-control <?= \Altum\Alerts::has_field_errors('description') ? 'is-invalid' : null ?>" maxlength="300" value="<?= $data->values['description'] ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="start_url" name="start_url" class="form-control" value="<?= $data->values['start_url'] ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="background_color" name="background_color" class="form-control" value="<?= $data->values['background_color'] ?>" data-color-picker />
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="theme_color" name="theme_color" class="form-control" value="<?= $data->values['theme_color'] ?>" data-color-picker />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_url" name="app_icon_url" class="form-control" value="<?= $data->values['app_icon_url'] ?? '' ?>" maxlength="2048" required="required" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_maskable_url" name="app_icon_maskable_url" class="form-control" value="<?= $data->values['app_icon_maskable_url'] ?? '' ?>" maxlength="2048" />
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="mobile_screenshots_container">
                            ...
                            <?php for($i = 1; $i <= 6; $i++): ?>
                                <div class="form-group">
                                    ...
                                    <input type="url" id="mobile_screenshot_url_<?= $i ?>" name="mobile_screenshot_url_<?= $i ?>" class="form-control" value="<?= $data->values['mobile_screenshot_url_' . $i] ?? '' ?>" placeholder="<?= l('pwas.mobile_screenshot_url_placeholder') ?>" maxlength="2048" />
                                </div>
                            <?php endfor ?>
                        </div>
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="desktop_screenshots_container">
                            ...
                            <?php for($i = 1; $i <= 6; $i++): ?>
                                <div class="form-group">
                                    ...
                                    <input type="url" id="desktop_screenshot_url_<?= $i ?>" name="desktop_screenshot_url_<?= $i ?>" class="form-control" value="<?= $data->values['desktop_screenshot_url_' . $i] ?? '' ?>" placeholder="<?= l('pwas.desktop_screenshot_url_placeholder') ?>" maxlength="2048" />
                                </div>
                            <?php endfor ?>
                        </div>
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="shortcuts_container">
                            <?php for($i = 1; $i <= 3; $i++): ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="shortcut_name_<?= $i ?>" name="shortcut_name_<?= $i ?>" class="form-control" value="<?= $data->values['shortcut_name_' . $i] ?? '' ?>" maxlength="20" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="shortcut_description_<?= $i ?>" name="shortcut_description_<?= $i ?>" class="form-control" value="<?= $data->values['shortcut_description_' . $i] ?? '' ?>" maxlength="60" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="shortcut_url_<?= $i ?>" name="shortcut_url_<?= $i ?>" class="form-control" value="<?= $data->values['shortcut_url_' . $i] ?? '' ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="shortcut_icon_url_<?= $i ?>" name="shortcut_icon_url_<?= $i ?>" class="form-control" value="<?= $data->values['shortcut_icon_url_' . $i] ?? '' ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="advanced_container">
                            <div class="form-group">
                                ...
                                <input type="text" id="id" name="id" class="form-control <?= \Altum\Alerts::has_field_errors('id') ? 'is-invalid' : null ?>" maxlength="200" value="<?= $data->values['id'] ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <select id="display" name="display" class="form-control">
                                    <option value="fullscreen" <?= $data->values['display'] == 'fullscreen' ? 'selected' : '' ?>>fullscreen</option>
                                    <option value="standalone" <?= $data->values['display'] == 'standalone' ? 'selected' : '' ?>>standalone</option>
                                    <option value="minimal-ui" <?= $data->values['display'] == 'minimal-ui' ? 'selected' : '' ?>>minimal-ui</option>
                                    <option value="browser" <?= $data->values['display'] == 'browser' ? 'selected' : '' ?>>browser</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="orientation" name="orientation" class="form-control">
                                    <option value="any" <?= $data->values['orientation'] == 'any' ? 'selected' : '' ?>>any</option>
                                    <option value="portrait" <?= $data->values['orientation'] == 'portrait' ? 'selected' : '' ?>>portrait</option>
                                    <option value="landscape" <?= $data->values['orientation'] == 'landscape' ? 'selected' : '' ?>>landscape</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="dir" name="dir" class="form-control">
                                    <option value="auto" <?= $data->values['dir'] == 'auto' ? 'selected' : '' ?>>auto</option>
                                    <option value="rtl" <?= $data->values['dir'] == 'rtl' ? 'selected' : '' ?>>rtl</option>
                                    <option value="ltr" <?= $data->values['dir'] == 'ltr' ? 'selected' : '' ?>>ltr</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="lang"><i class="fas fa-fw fa-sm fa-language text-muted mr-1"></i> <?= l('pwas.lang') ?></label>
                                <input type="text" id="lang" name="lang" class="form-control <?= \Altum\Alerts::has_field_errors('lang') ? 'is-invalid' : null ?>" maxlength="8" value="<?= $data->values['lang'] ?>" />
                                <?= \Altum\Alerts::output_field_error('lang') ?>
                                <small class="form-text text-muted"><?= l('pwas.lang_help') ?></small>
                            </div>

                            <div class="form-group">
                                <label for="scope"><i class="fas fa-fw fa-sm fa-globe text-muted mr-1"></i> <?= l('pwas.scope') ?></label>
                                <input type="text" id="scope" name="scope" class="form-control <?= \Altum\Alerts::has_field_errors('scope') ? 'is-invalid' : null ?>" maxlength="2048" value="<?= $data->values['scope'] ?>" />
                                <?= \Altum\Alerts::output_field_error('scope') ?>
                                <small class="form-text text-muted"><?= l('pwas.scope_help') ?></small>
                            </div>
                        </div>
            ...
            <div class="sticky">
                ...
                <div class="mt-5">
                    <ul class="list-style-none">
                        <li class="mb-2"><?= l('pwas.tutorial.one') ?></li>
                        <li><?= l('pwas.tutorial.two') ?></li>
                    </ul>
