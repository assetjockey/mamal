                ...
                <div class="card-body">
                    ...
                    <form id="pwa_create" action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="start_url" name="start_url" class="form-control" value="<?= $data->pwa->settings->start_url ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_url" name="app_icon_url" class="form-control" value="<?= $data->pwa->settings->app_icon_url ?? '' ?>" maxlength="2048" required="required" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="app_icon_maskable_url" name="app_icon_maskable_url" class="form-control" value="<?= $data->pwa->settings->app_icon_maskable_url ?? '' ?>" maxlength="2048" />
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="shortcuts_container">
                            <?php for($i = 1; $i <= 3; $i++): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="shortcut_icon_url_<?= $i ?>" name="shortcut_icon_url_<?= $i ?>" class="form-control" value="<?= $data->pwa->settings->{'shortcut_icon_url_' . $i} ?? '' ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
                        ...
                        <div class="collapse" data-parent="#pwa_create" id="advanced_container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="scope" name="scope" class="form-control <?= \Altum\Alerts::has_field_errors('scope') ? 'is-invalid' : null ?>" maxlength="2048" value="<?= $data->pwa->settings->scope ?>" />
