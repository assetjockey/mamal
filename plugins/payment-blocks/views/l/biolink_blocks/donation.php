    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="<?= 'donation_form_' . $data->link->biolink_block_id ?>" method="post" role="form" enctype="multipart/form-data">
...
<script>
    ...
    document.querySelectorAll('<?= '#donation_' . $data->link->biolink_block_id ?> [data-processor]').forEach(element => element.addEventListener('click', event => {
        ...
        document.querySelectorAll('<?= '#donation_' . $data->link->biolink_block_id ?> [data-payment-processor-custom-container]').forEach(element => {
        ...
        if(processor === 'plisio') {
            ...
            document.querySelectorAll('<?= '#donation_' . $data->link->biolink_block_id ?> [data-offline-payment-container]').forEach(offline_payment_element => {
...
<?php if(!\Altum\Event::exists_content_type_key('javascript', 'donation')): ?>
    ...
    <script>
        ...
        /* Modal handling */
        $('div[id^="donation_"]').on('show.bs.modal', event => {
