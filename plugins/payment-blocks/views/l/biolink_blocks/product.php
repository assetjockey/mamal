...
<script>
    ...
    document.querySelectorAll('<?= '#product_' . $data->link->biolink_block_id ?> [data-processor]').forEach(element => element.addEventListener('click', event => {
        ...
        document.querySelectorAll('<?= '#product_' . $data->link->biolink_block_id ?> [data-payment-processor-custom-container]').forEach(element => {
        ...
        if(processor === 'plisio') {
            ...
            document.querySelectorAll('<?= '#product_' . $data->link->biolink_block_id ?> [data-offline-payment-container]').forEach(offline_payment_element => {
