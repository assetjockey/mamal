                ...
                <div class="col-12">
                    ...
                    <div class="row mx-n2 mb-4">
                        ...
                        <div class="col-auto px-2">
                            <a href="{{ route('spaces.new') }}" class="btn btn-primary">{{ __('New') }}</a>
                        </div>
                    </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col text-truncate">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="d-none d-lg-block col-lg-2">
                                                                    <a href="{{ route('links', ['space_id' => $space->id]) }}" class="text-inverse">{{ $space->totalLinksCount }}</a>
                                                                </div>
