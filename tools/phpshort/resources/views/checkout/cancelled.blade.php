    ...
    <div class="container">
        <div class="h-full d-flex flex-column justify-content-center align-items-center my-12">
            <div class="position-relative w-32 h-32 d-flex align-items-center justify-content-center">
                ...
                @include('icons.cancel-filled', ['class' => 'position-absolute end-0 bottom-0 text-danger fill-current w-8 h-8'])
            </div>

            <div>
                <h1 class="fs-xl fw-medium mb-2 mt-6 text-center">{{ __('Payment cancelled') }}</h1>
                <p class="text-center text-muted mb-0">{{ __('The payment was cancelled.') }}</p>
