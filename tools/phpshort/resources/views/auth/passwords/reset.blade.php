    ...
    <div class="bg-base-1 d-flex align-items-center flex-fill">
        <div class="container h-full py-16">
            ...
            <div class="text-center d-block d-lg-none">
                <h1 class="fs-3xl fw-semibold  tracking-tight m-0">{{ Str::ucfirst(mb_strtolower(__('Reset Password'))) }}</h1>
                <div class="mx-auto mt-4">
                    <p class="text-muted fw-normal fs-lg mb-0">{{ __('Recover your account.') }}</p>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-lg-7 d-none d-lg-flex flex-fill background-size-cover bg-center" style="background-image: url({{ asset('img/password.svg') }})">
                                <div class="card-body p-lg-12 d-flex flex-column flex-fill position-absolute top-0 end-0 bottom-0 start-0">
                                    <div class="d-flex align-items-center d-flex flex-fill">
                                        <div class="text-light ms-12">
                                            <div class="fs-3xl fw-bold  tracking-tight m-0">{{ Str::ucfirst(mb_strtolower(__('Reset Password'))) }}</div>
