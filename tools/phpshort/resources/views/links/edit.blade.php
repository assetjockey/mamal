                ...
                <div class="col-12">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header align-items-center">
                            <div class="fw-medium py-1">{{ __('Link') }}</div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row mx-n2">
                                    ...
                                    <div class="col-12 col-md-6 px-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="alias" class="form-control{{ $errors->has('alias') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" id="i-alias" value="{{ old('alias') ?? $link->alias }}" @cannot('linkAlias', [App\Models\User::class]) disabled @endcannot>
                                            @if ($errors->has('alias'))
                                                <span class="invalid-feedback d-block" role="alert">
                                ...
                                <div class="pb-4">
                                    ...
                                    <div class="collapse {{ ($errors->has('active_period_start_at') || $errors->has('active_period_end_at') || $errors->has('clicks_limit') || $errors->has('expiration_url') ? 'show' : '') }}" id="collapseSchedules">
                                            ...
                                            <div class="col-12 col-lg-6 px-2">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="datetime-local" step="1" dir="ltr" name="active_period_start_at" class="form-control{{ $errors->has('active_period_start_at') ? ' is-invalid' : '' }}" id="i-active-period-start-at" value="{{ old('active_period_start_at') ?? ($link->active_period_start_at ? $link->active_period_start_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format('Y-m-d\TH:i:s') : '') }}" placeholder="{{ Carbon\Carbon::now()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format('Y-m-d\TH:i:s') }}">
                                                    </div>
                                            ...
                                            <div class="col-12 col-lg-6 px-2">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="datetime-local" step="1" dir="ltr" name="active_period_end_at" class="form-control{{ $errors->has('active_period_end_at') ? ' is-invalid' : '' }}" id="i-active-period-end-at" value="{{ old('active_period_end_at') ?? ($link->active_period_end_at ? $link->active_period_end_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format('Y-m-d\TH:i:s') : '') }}" placeholder="{{ Carbon\Carbon::now()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format('Y-m-d\TH:i:s') }}">
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="clicks_limit" id="i-clicks-limit" class="form-control {{ $errors->has('clicks_limit') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('clicks_limit') ?? $link->clicks_limit }}" @cannot('linkExpiration', [App\Models\User::class]) disabled @endcannot>
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="input-group">
                                                <input type="text" dir="ltr" name="expiration_url" id="i-expiration-url" class="form-control{{ $errors->has('expiration_url') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_url') ?? $link->expiration_url }}" @cannot('linkExpiration', [App\Models\User::class]) disabled @endcannot>
                                            </div>
                                ...
                                <div class="pb-4">
                                    ...
                                    <div class="collapse {{ ($errors->has('redirect_password') || $errors->has('sensitive_content') ? 'show' : '') }}" id="collapseProtections">
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="input-group">
                                                <input type="password" name="redirect_password" class="form-control{{ $errors->has('redirect_password') ? ' is-invalid' : '' }}" id="i-redirect-password" value="{{ old('redirect_password') ?? $link->redirect_password }}" autocomplete="new-password" @cannot('linkPassword', [App\Models\User::class]) disabled @endcannot>
                                                ...
                                                <div class="row mx-n2">
                                                    <div class="col-12 col-lg-4 px-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="i-privacy1" name="privacy" class="custom-control-input{{ $errors->has('privacy') ? ' is-invalid' : '' }}" value="1" @if($link->privacy == 1 && old('privacy') == null || old('privacy') == 1) checked @endif @cannot('linkStats', [App\Models\User::class]) disabled @endcannot>
                                                    ...
                                                    <div class="col-12 col-lg-4 px-2 pt-2 pt-lg-0">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="i-privacy0" name="privacy" class="custom-control-input{{ $errors->has('privacy') ? ' is-invalid' : '' }}" value="0" @if($link->privacy == 0 && old('privacy') == null || old('privacy') == 0 && old('privacy') != null) checked @endif @cannot('linkStats', [App\Models\User::class]) disabled @endcannot>
                                                    ...
                                                    <div class="col-12 col-lg-4 px-2 pt-2 pt-lg-0">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="i-privacy2" name="privacy" class="custom-control-input{{ $errors->has('privacy') ? ' is-invalid' : '' }}" value="2" @if($link->privacy == 2 && old('privacy') == null || old('privacy') == 2) checked @endif @cannot('linkStats', [App\Models\User::class]) disabled @endcannot>
                                                            ...
                                                            <div id="input-password" class="{{ (((old('privacy') == 2) || (old('privacy') == null && $link->privacy == 2)) ? '' : 'd-none')}}">
                                                                <div class="input-group mt-2">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text cursor-pointer" data-tooltip="true" data-title="{{ __('Show password') }}" data-password="i-password" data-password-show-text="{{ __('Show password') }}" data-password-hide-text="{{ __('Hide password') }}">@include('icons.visibility_off', ['class' => 'w-4 h-4 fill-current text-muted'])@include('icons.visibility', ['class' => 'w-4 h-4 fill-current text-muted d-none'])</div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 p-2">
                                    <div class="card border-0 shadow-sm h-full">
                                        <div class="card-body d-flex align-items-center text-truncate">
                                            <img src="{{ $link->user->avatar_url }}" alt="" class="w-8 h-8 rounded-circle" alt="">

                                            <a href="{{ route('admin.users.edit', ['id' => $link->user->id]) }}" class="text-decoration-none fw-medium text-inverse text-truncate stretched-link mx-4">{{ $link->user->name }}</a>
                            ...
                            @else
                                <div class="col-12 col-md-6 col-lg-4 p-2">
                                    <div class="card border-0 shadow-sm h-full cursor-default">
                                        <div class="card-body d-flex align-items-center text-truncate">
                                            <img src="{{ asset('img/user.png') }}" class="w-8 h-8 rounded-circle" alt="">

                                            <span class="fw-medium text-decoration-none text-truncate me-2 ms-4">{{ __('Guest') }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-12 col-md-6 col-lg-4 p-2">
                                    <div class="card border-0 shadow-sm h-full">
                                        <div class="card-body d-flex align-items-center text-truncate">
                                            ...
                                            <a href="{{ route('admin.spaces', ['link_id' => $link->id]) }}" class="text-decoration-none fw-medium text-inverse text-truncate stretched-link mx-4">{{ __('Space') }}</a>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 p-2">
                                    <div class="card border-0 shadow-sm h-full">
                                        <div class="card-body d-flex align-items-center text-truncate">
                                            ...
                                            <a href="{{ route('admin.domains', ['link_id' => $link->id]) }}" class="text-decoration-none fw-medium text-inverse text-truncate stretched-link mx-4">{{ __('Domain') }}</a>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 p-2">
                                    <div class="card border-0 shadow-sm h-full">
                                        <div class="card-body d-flex align-items-center text-truncate">
                                            ...
                                            <a href="{{ route('admin.pixels', ['link_id' => $link->id]) }}" class="text-decoration-none fw-medium text-inverse text-truncate stretched-link me-2 ms-4">{{ __('Pixels') }}</a>

                                            <span class="badge badge-primary me-4">{{ number_format($link->pixels_count, 0, __('.'), __(',')) }}</span>
