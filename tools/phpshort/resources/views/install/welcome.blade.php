                ...
                <div class="card border-0 shadow-sm overflow-hidden">
                    <div class="card-body p-12">
                        <div class="h-full d-flex flex-column justify-content-center align-items-center my-16">
                            ...
                            <div>
                                <h1 class="fs-xl fw-medium mb-2 mt-6 text-center">{{ __('Install') }}</h1>
                                <p class="text-center text-muted mb-0">{!! __(':name installation wizard.', ['name' => '<span class="fw-medium">'.config('info.software.name').'</span>']) !!}</p>
                            </div>
                        </div>
                    </div>
                </div>

                <a href="{{ route('install.requirements') }}" class="btn btn-block btn-primary d-inline-flex align-items-center mt-4 py-2">
