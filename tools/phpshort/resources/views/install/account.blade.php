                ...
                <form action="{{ route('install.account') }}" method="post">
                    ...
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="card-header">
                            <div class="fw-medium py-1">{{ __('Admin credentials') }}</div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group {{ $errors->has('timezone') ? '' : 'd-none' }}">
                                ...
                                <select name="timezone" id="i-timezone" class="custom-select{{ $errors->has('timezone') ? ' is-invalid' : '' }}">
                                    @foreach(timezone_identifiers_list() as $value)
                                        <option value="{{ $value }}" @if ($value == 'UTC') selected @endif>{{ $value }}</option>
                                    @endforeach
                                </select>
                    ...
                    <button type="submit" class="btn btn-block btn-primary d-inline-flex align-items-center mt-4 py-2">
