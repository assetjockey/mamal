                ...
                <div class="d-flex flex-column">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header align-items-center">
                            <div class="row mx-n2">
                                <div class="col px-2">
                                    <div class="fw-medium py-1">{{ __('Cities') }}</div>
                                </div>
                            ...
                            @else
                                <div class="list-group list-group-flush my-n4">
                                        ...
                                        <div class="list-group-item px-0 border-0">
                                            <div class="d-flex flex-column">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <div class="d-flex text-truncate align-items-center">
                                                        <div class="d-flex align-items-center me-2"><img src="{{ asset('img/icons/countries/' . flagIcon($city->value)) }}.svg" class="w-4 h-4" alt=""></div>
                                                        <div class="text-truncate">
                                    ...
                                    <div class="mt-4 align-items-center">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mt-2 mb-4">{{ __('Showing :from-:to of :total', ['from' => $cities->firstItem(), 'to' => $cities->lastItem(), 'total' => $cities->total()]) }}
                                                </div>
                                            </div>
                                            <div class="col-auto">
