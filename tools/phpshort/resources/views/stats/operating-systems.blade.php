...
@section('site_title', formatTitle([$link->alias, __('Operating systems'), __('Stats'), config('settings.title')]))
                            ...
                            @else
                                <div class="list-group list-group-flush my-n4">
                                        ...
                                        <div class="list-group-item px-0 border-0">
                                            <div class="d-flex flex-column">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <div class="d-flex text-truncate align-items-center">
                                                        <div class="d-flex align-items-center me-2"><img src="{{ asset('img/icons/os/' . operatingSystemIcon($operatingSystem->value)) }}.svg" class="w-4 h-4" alt=""></div>
                                                        <div class="text-truncate">
                                                ...
                                                <div class="progress h-1.25 w-full">
                                                    <div class="progress-bar rounded" role="progressbar" style="width: {{ (($operatingSystem->count / $total->count) * 100) }}%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="mt-4 align-items-center">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mt-2 mb-4">{{ __('Showing :from-:to of :total', ['from' => $operatingSystems->firstItem(), 'to' => $operatingSystems->lastItem(), 'total' => $operatingSystems->total()]) }}
                                                </div>
                                            </div>
                                            <div class="col-auto">
