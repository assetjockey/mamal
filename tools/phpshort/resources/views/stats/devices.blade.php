                ...
                <div class="d-flex flex-column">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header align-items-center">
                            <div class="row mx-n2">
                                <div class="col px-2">
                                    <div class="fw-medium py-1">{{ __('Devices') }}</div>
                                </div>
                                <div class="col-auto px-2">
                                    <div class="row mx-n1">
                                        <div class="col-auto px-1">
                                            @include('stats.partials.table-search', ['name' => __('Type'), 'count' => __('Clicks')])
                                        </div>
                            ...
                            @else
                                <div class="list-group list-group-flush my-n4">
                                        ...
                                        <div class="list-group-item px-0 border-0">
                                            <div class="d-flex flex-column">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <div class="d-flex text-truncate align-items-center">
                                                        <div class="d-flex align-items-center me-2"><img src="{{ asset('img/icons/devices/' . deviceIcon($device->value)) }}.svg" class="w-4 h-4" alt=""></div>
                                                        <div class="text-truncate">
                                                            @if($device->value)
                                    ...
                                    <div class="mt-4 align-items-center">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mt-2 mb-4">{{ __('Showing :from-:to of :total', ['from' => $devices->firstItem(), 'to' => $devices->lastItem(), 'total' => $devices->total()]) }}
                                                </div>
                                            </div>
                                            <div class="col-auto">
