    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            @include('shared.breadcrumbs', ['breadcrumbs' => [
                ...
                ['url' => route('admin.tax-rates'), 'title' => __('Tax rates')],
                ['title' => __('Edit')],
            ]])
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="fw-medium py-1">{{ __('Tax rate') }}</div>
                </div>
                <div class="card-body">
                    ...
                    @if($taxRate->trashed())
                        <div class="alert alert-danger">
                            {{ __('This :resource is disabled.', ['resource' => mb_strtolower(__('Tax rate'))]) }}
                        </div>
                    @endif

                    <form action="{{ route('admin.tax-rates.edit', $taxRate->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
