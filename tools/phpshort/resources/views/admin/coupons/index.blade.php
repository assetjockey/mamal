    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                <div class="col px-2">
                    <h1 class="fs-3xl fw-medium tracking-tight m-0">{{ __('Coupons') }}</h1>
                </div>
                <div class="col-auto px-2">
                    <a href="{{ route('admin.coupons.new') }}" class="btn btn-primary">{{ __('New') }}</a>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="row mx-n2">
                        <div class="col px-2">
                            <div class="fw-medium py-1">{{ __('Coupons') }}</div>
                        </div>
                        <div class="col-auto px-2">
                    ...
                    @else
                        <div class="list-group list-group-flush my-n4">
                                ...
                                <div class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col text-truncate">
                                            <div class="row text-truncate">
                                                <div class="col-12 col-lg-5 text-truncate d-flex align-items-center">
                                                    <a href="{{ route('admin.coupons.edit', $coupon->id) }}" class="text-truncate">{{ $coupon->name }}</a> <span class="badge badge-secondary ms-2" data-tooltip="true" title="{{ __('Coupon code') }}">{{ $coupon->code }}</span>
                                                </div>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            @include('admin.coupons.partials.context-menu')
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="mt-4 align-items-center">
                                <div class="row">
                                    <div class="col">
                                        <div class="mt-2 mb-4">{{ __('Showing :from-:to of :total', ['from' => $coupons->firstItem(), 'to' => $coupons->lastItem(), 'total' => $coupons->total()]) }}
                                        </div>
                                    </div>
                                    <div class="col-auto">
