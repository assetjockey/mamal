        ...
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="row mx-n2">
                        <div class="col px-2">
                            <div class="fw-medium py-1">{{ __('Spaces') }}</div>
                        </div>
                    ...
                    @else
                        <div class="list-group list-group-flush my-n4">
                                                    ...
                                                    <div class="row align-items-center">
                                                            ...
                                                            <div class="text-truncate">
                                                                <div class="d-flex">
                                                                    <div class="d-flex align-items-center text-truncate">
                                                                        <div class="w-4 h-4 rounded-circle {{ match ((int) $space->color) { 1 => 'bg-success', 2 => 'bg-danger', 3 => 'bg-warning', 4 => 'bg-info', 5 => 'bg-inverse', 6 => 'bg-primary' } }} me-4"></div>
                                                        ...
                                                        <div class="col-12 col-lg-5 d-flex align-items-center">
                                                            <div class="d-inline-block me-4">
                                                                <img src="{{ $space->user->avatarUrl }}" class="rounded-circle w-6 h-6" alt="">
                                                            </div>
                                                            <a href="{{ route('admin.users.edit', $space->user->id) }}">{{ $space->user->name }}</a>
                                                        </div>

                                                        <div class="col-12 col-lg-2 d-flex">
                                                            <a href="{{ route('admin.links', ['space_id' => $space->id]) }}" class="text-inverse">{{ $space->totalLinksCount }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <div class="mt-4 align-items-center">
                                <div class="row">
                                    <div class="col">
                                        <div class="mt-2 mb-4">{{ __('Showing :from-:to of :total', ['from' => $spaces->firstItem(), 'to' => $spaces->lastItem(), 'total' => $spaces->total()]) }}
                                        </div>
                                    </div>
                                    <div class="col-auto">
