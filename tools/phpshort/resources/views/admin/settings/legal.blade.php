    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                <div class="col px-2">
                    <h1 class="fs-3xl fw-medium tracking-tight m-0">{{ __('Legal') }}</h1>
                </div>
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="fw-medium py-1">{{ __('Legal') }}</div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings', 'legal') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="i-legal-terms-url">{{ __('Terms of service URL') }}</label>
                            ...
                            @endif
                            <small class="form-text text-muted">{{ __('The URL of the page that contains the website\'s terms of service.') }}</small>
                        </div>

                        <div class="form-group">
                            <label for="i-privacy-url">{{ __('Privacy policy URL') }}</label>
                            ...
                            @endif
                            <small class="form-text text-muted">{{ __('The URL of the page that contains the website\'s privacy policy.') }}</small>
                        </div>

                        <div class="form-group">
                            <label for="i-cookie-url">{{ __('Cookie policy URL') }}</label>
                            ...
                            @endif
                            <small class="form-text text-muted">{{ __('The URL of the page that contains the website\'s cookie policy.') }}</small>
                        </div>
