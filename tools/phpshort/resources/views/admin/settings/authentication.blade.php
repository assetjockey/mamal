    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                <div class="col px-2">
                    <h1 class="fs-3xl fw-medium tracking-tight m-0">{{ __('Authentication') }}</h1>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings', 'authentication') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="i-registration-tfa" class="d-inline-flex align-items-center"><span class="me-2">{{ __('Two-factor authentication') }}</span><span class="badge badge-secondary">{{ __('Default') }}</span></label>
                        ...
                        <div class="pb-4">
                            <button class="btn btn-soft-inverse d-block w-full d-flex align-items-center justify-content-center" type="button" data-toggle="collapse" data-target="#collapseGoogle" aria-expanded="{{ ($errors->has('auth_google') || $errors->has('auth_google_client_id') || $errors->has('auth_google_client_secret') ? 'true' : 'false') }}" aria-controls="collapseGoogle">
                                @include('icons.google', ['class' => 'w-4 h-4 fill-current me-2']) Google
                            </button>
                            ...
                            <div class="collapse {{ ($errors->has('auth_google') || $errors->has('auth_google_client_id') || $errors->has('auth_google_client_secret') ? 'show' : '') }}" id="collapseGoogle">
                                <div class="alert alert-info mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ config('info.software.url') }}/{{ mb_strtolower(config('info.software.name')) }}/documentation#google" class="alert-link fw-medium" target="_blank">{{ __('Learn more') }}</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pb-4">
                            <button class="btn btn-soft-inverse d-block w-full d-flex align-items-center justify-content-center" type="button" data-toggle="collapse" data-target="#collapseMicrosoft" aria-expanded="{{ ($errors->has('auth_microsoft') || $errors->has('auth_microsoft_client_id') || $errors->has('auth_microsoft_client_secret') ? 'true' : 'false') }}" aria-controls="collapseMicrosoft">
                                @include('icons.microsoft', ['class' => 'w-4 h-4 fill-current me-2']) Microsoft
                            </button>
                            ...
                            <div class="collapse {{ ($errors->has('auth_microsoft') || $errors->has('auth_microsoft_client_id') || $errors->has('auth_microsoft_client_secret') ? 'show' : '') }}" id="collapseMicrosoft">
                                <div class="alert alert-info mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ config('info.software.url') }}/{{ mb_strtolower(config('info.software.name')) }}/documentation#microsoft" class="alert-link fw-medium" target="_blank">{{ __('Learn more') }}</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pb-4">
                            <button class="btn btn-soft-inverse d-block w-full d-flex align-items-center justify-content-center" type="button" data-toggle="collapse" data-target="#collapseApple" aria-expanded="{{ ($errors->has('auth_apple') || $errors->has('auth_apple_client_id') || $errors->has('auth_apple_team_id') || $errors->has('auth_apple_key_id') || $errors->has('auth_apple_private_key') ? 'true' : 'false') }}" aria-controls="collapseApple">
                                @include('icons.apple', ['class' => 'w-4 h-4 fill-current me-2']) Apple
                            </button>
                            ...
                            <div class="collapse {{ ($errors->has('auth_apple') || $errors->has('auth_apple_client_id') || $errors->has('auth_apple_team_id') || $errors->has('auth_apple_key_id') || $errors->has('auth_apple_private_key') ? 'show' : '') }}" id="collapseApple">
                                <div class="alert alert-info mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ config('info.software.url') }}/{{ mb_strtolower(config('info.software.name')) }}/documentation#apple" class="alert-link fw-medium" target="_blank">{{ __('Learn more') }}</a>
                                        </div>
                                    </div>
                                </div>
