    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                <div class="col px-2">
                    <h1 class="fs-3xl fw-medium tracking-tight m-0">{{ __('Contact') }}</h1>
                </div>
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="fw-medium py-1">{{ __('Contact') }}</div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings', 'contact') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                {{ __('Enable or disable the contact form on the contact page.') }} {{ __('When disabled, visitors will not be able to send messages through the form.') }}
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <small class="form-text text-muted">
                                {{ __('The email address used to receive messages from the contact form.') }} {{ __('If set to Public, the address will also be displayed on the contact page as a clickable link.') }} {{ __('If set to Private, it will only be used as the recipient for form submissions.') }}
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <small class="form-text text-muted">
                                {{ __('The phone number displayed on the contact page as a clickable link.') }}
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <small class="form-text text-muted">
                                {{ __('The physical address displayed on the contact page.') }}
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="i-social-facebook">{{ __(':name URL', ['name' => 'Facebook']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-x">{{ __(':name URL', ['name' => 'X']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-instagram">{{ __(':name URL', ['name' => 'Instagram']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-youtube">{{ __(':name URL', ['name' => 'YouTube']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-linkedin">{{ __(':name URL', ['name' => 'LinkedIn']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-github">{{ __(':name URL', ['name' => 'GitHub']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-discord">{{ __(':name URL', ['name' => 'Discord']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-reddit">{{ __(':name URL', ['name' => 'Reddit']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-tiktok">{{ __(':name URL', ['name' => 'TikTok']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-threads">{{ __(':name URL', ['name' => 'Threads']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-tumblr">{{ __(':name URL', ['name' => 'Tumblr']) }}</label>
                        ...
                        <div class="form-group">
                            <label for="i-social-pinterest">{{ __(':name URL', ['name' => 'Pinterest']) }}</label>
