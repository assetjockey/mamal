    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                <div class="col px-2">
                    <h1 class="fs-3xl fw-medium tracking-tight m-0">{{ __('Captcha') }}</h1>
                </div>
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-header align-items-center">
                    <div class="fw-medium py-1">{{ __('Captcha') }}</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <div class="row">
                            <div class="col">
                                {{ __('Captcha used to protect forms on the website from automated submissions.') }}
                            </div>
                            <div class="col-auto">
                                <a href="{{ config('info.software.url') }}/{{ mb_strtolower(config('info.software.name')) }}/documentation#captcha" class="alert-link fw-medium" target="_blank">{{ __('Learn more') }}</a>
                            </div>
                        </div>
                    </div>
