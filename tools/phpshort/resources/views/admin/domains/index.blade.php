        ...
        <div class="container pt-4 mt-4 pb-16">
            ...
            <div class="row mx-n2 mb-4">
                ...
                <div class="col-auto px-2">
                    <a href="{{ route('admin.domains.new') }}" class="btn btn-primary">{{ __('New') }}</a>
                </div>
            </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col text-truncate">
                                                    <div class="row align-items-center">
                                                            ...
                                                            <div class="text-truncate">
                                                                <div class="d-flex">
                                                                    <div class="d-flex align-items-center text-truncate">
                                                                        ...
                                                                        @if(!$domain->user_id)
                                                                            <span class="badge badge-secondary ms-2">{{ __('Global') }}</span>
                                                        ...
                                                        <div class="col-12 col-lg-5 d-flex align-items-center">
                                                            @if(isset($domain->user))
                                                                <div class="d-inline-block me-4">
                                                                    <img src="{{ $domain->user->avatarUrl }}" class="rounded-circle w-6 h-6" alt="">
                                                                </div>
                                                        ...
                                                        <div class="col-12 col-lg-2 d-flex">
                                                            <a href="{{ route('admin.links', ['domain_id' => $domain->id]) }}" class="text-inverse">{{ $domain->totalLinksCount }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
