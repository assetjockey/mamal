...
<div>
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php if($feature == 'audits_retention'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div data-toggle="tooltip" title="<?= ($data->plan_settings->audits_retention == -1 ? '' : $data->plan_settings->audits_retention . ' ' . l('global.date.days')) ?>">
        ...
        <?php if($feature == 'ai_is_enabled' && settings()->audits->ai_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3 <?= $data->plan_settings->ai_is_enabled ? null : 'text-muted' ?>">
                <div>
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->ai_is_enabled ? 'fa-check text-success' : 'fa-times' ?>"></i>
            </div>
        <?php endif ?>

        <?php if($feature == 'directory_is_enabled' && settings()->audits->directory_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3 <?= $data->plan_settings->directory_is_enabled ? null : 'text-muted' ?>">
                <div>
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->directory_is_enabled ? 'fa-check text-success' : 'fa-times' ?>"></i>
            </div>
        <?php endif ?>
