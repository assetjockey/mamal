...
<div class="app-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="app-sidebar-links">
			...
			<?php if(settings()->audits->directory_is_enabled && (settings()->audits->directory_access == 'everyone' || (settings()->audits->directory_access == 'users' && is_logged_in()))): ?>
                <li class="<?= \Altum\Router::$controller == 'Directory' ? 'active' : null ?>">
                    <a href="<?= url('top-websites') ?>"><i class="fas fa-fw fa-sm fa-sitemap mr-2"></i> <?= l('top_websites.menu') ?></a>
                </li>
			<?php endif ?>
