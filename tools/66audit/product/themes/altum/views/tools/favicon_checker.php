...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('tools.favicon_checker.name') ?></li>
            </ol>
        </nav>
    <?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.favicon_checker.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.favicon_checker.description') ?>">
        ...
        <div class="mt-4">
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.favicon_checker.result') ?>
                        </td>
                        <td class="text-nowrap">
                            <?= $data->result ? '<a href="' . $data->result . '" target="_blank" rel="nofollow noreferrer">' . $data->result . '</a>' : l('global.none') ?>
                        </td>
                    </tr>
