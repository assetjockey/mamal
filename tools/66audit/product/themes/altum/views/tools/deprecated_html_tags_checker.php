...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('tools.deprecated_html_tags_checker.name') ?></li>
            </ol>
        </nav>
    <?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.deprecated_html_tags_checker.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.deprecated_html_tags_checker.description') ?>">
            ...
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <?php if($data->result['deprecated_html_tags_count']): ?>
                                <i class="fas fa-fw fa-sm fa-exclamation-circle text-warning mr-1"></i> <?= sprintf(l('tools.deprecated_html_tags_checker.result.deprecated'), nr($data->result['deprecated_html_tags_count'])) ?>
                            <?php else: ?>
                                <i class="fas fa-fw fa-sm fa-check-circle text-success mr-1"></i> <?= l('tools.deprecated_html_tags_checker.result.none') ?>
                            <?php endif ?>
                        </td>
                    </tr>
        ...
        <div class="mt-4">
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.deprecated_html_tags_checker.result.deprecated_html_tags') ?>
                        </td>
                        <td class="text-nowrap">
                            <span class="badge badge-light"><?= nr($data->result['deprecated_html_tags_count']) ?></span>
                        </td>
                    </tr>

                    <?php foreach($data->result['deprecated_html_tags'] as $tag => $count): ?>
                        <tr>
                            <td class="text-nowrap">
                                <code>&lt;<?= $tag ?>&gt;</code>
                            </td>
