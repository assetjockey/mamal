...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('tools.noindex_checker.name') ?></li>
            </ol>
        </nav>
    <?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.noindex_checker.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.noindex_checker.description') ?>">
        ...
        <div class="mt-4">
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.noindex_checker.result.meta_robots') ?>
                        </td>
                        <td class="text-nowrap">
                            <?php if($data->result['meta_robots_indexable']): ?>
                                <i class="fas fa-fw fa-sm fa-check-circle text-success mr-1"></i> <?= l('tools.noindex_checker.result.indexable') ?>
                            <?php else: ?>
                                <i class="fas fa-fw fa-sm fa-times-circle text-danger mr-1"></i> <?= l('tools.noindex_checker.result.not_indexable') ?>
                            <?php endif ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.noindex_checker.result.x_robots_tag') ?>
                        </td>
                        <td class="text-nowrap">
                            <?php if($data->result['x_robots_tag_indexable']): ?>
                                <i class="fas fa-fw fa-sm fa-check-circle text-success mr-1"></i> <?= l('tools.noindex_checker.result.indexable') ?>
                            <?php else: ?>
                                <i class="fas fa-fw fa-sm fa-times-circle text-danger mr-1"></i> <?= l('tools.noindex_checker.result.not_indexable') ?>
                            <?php endif ?>
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.noindex_checker.result.robots_txt') ?>
                        </td>
                        <td class="text-nowrap">
                            <?php if($data->result['robots_txt_indexable']): ?>
                                <i class="fas fa-fw fa-sm fa-check-circle text-success mr-1"></i> <?= l('tools.noindex_checker.result.indexable') ?>
                            <?php else: ?>
                                <i class="fas fa-fw fa-sm fa-times-circle text-danger mr-1"></i> <?= l('tools.noindex_checker.result.not_indexable') ?>
                            <?php endif ?>
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.noindex_checker.result.final') ?>
                        </td>
                        <td class="text-nowrap font-weight-bold">
                            <?php if($data->result['meta_robots_indexable'] && $data->result['x_robots_tag_indexable'] && $data->result['robots_txt_indexable']): ?>
                                <i class="fas fa-fw fa-sm fa-check-circle text-success mr-1"></i> <?= l('tools.noindex_checker.result.indexable') ?>
                            <?php else: ?>
                                <i class="fas fa-fw fa-sm fa-times-circle text-danger mr-1"></i> <?= l('tools.noindex_checker.result.not_indexable') ?>
                            <?php endif ?>
