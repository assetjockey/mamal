                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', ['datetime', 'last_datetime', 'last_audit_datetime']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['website_id', 'datetime', 'last_datetime', 'last_audit_datetime', 'host', 'score', 'total_audits', 'total_archived_audits', 'total_issues']) . '</code>') ?></td>
                            </tr>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>{empty_string}</code>,' . '<code>' . implode('</code>, <code>', array_keys(require APP_PATH . 'includes/audits_check_intervals.php')) . '</code>') ?> <?= '(' . l('global.date.seconds') . ')' ?></td>
                            </tr>
                            <tr>
                                <td>notifications</td>
                                <td>
                            ...
                            <tr>
                                <td>directory_is_enabled_and_verified</td>
                                <td>
                                    <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-toggle-on mr-1"></i> <?= l('api_documentation.boolean') ?></span>
                                </td>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                ...
                                --form 'is_public=<span class="text-primary">1</span>' \<br />
                                --form 'password=<span class="text-primary">example</span>' \<br />
                            </div>
                        </div>
                    </div>
