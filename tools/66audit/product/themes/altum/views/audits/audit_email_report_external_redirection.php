...
<p><?= sprintf(l('audits.email_report_external_redirection.p1', $data->row->language), remove_url_protocol_from_url($data->row->url)) ?></p>
...
<div>
    <table>
        <tbody>
            ...
            <tr>
                <th style="text-align: left;"><?= l('audits.resolved_url', $data->row->language) ?></th>
                <td class="word-break-all">
                    <span>
            ...
            <tr>
                <th style="text-align: left;"><?= l('audits.total_redirects', $data->row->language) ?></th>
                <td class="word-break-all">
                    <span>
                        <?= nr($data->data['total_redirects']) ?>
                    </span>
                </td>
            </tr>
