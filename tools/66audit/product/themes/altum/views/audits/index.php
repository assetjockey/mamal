...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex flex-wrap gap-3 d-print-none">
            ...
            <div>
                <div class="dropdown">
                    <button type="button" class="btn btn-light dropdown-toggle-simple <?= !empty($data->audits) ? null : 'disabled' ?>" data-toggle="dropdown" data-boundary="viewport" data-tooltip title="<?= l('global.export') ?>" data-tooltip-hide-on-click>
                        <i class="fas fa-fw fa-sm fa-download"></i>
                    </button>

                    <div class="dropdown-menu dropdown-menu-right d-print-none">
                        <a href="<?= url('audits?' . $data->filters->get_get() . '&export=csv')  ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->csv ? null : get_plan_feature_disabled_info() ?>>
                            <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                        </a>
                        <a href="<?= url('audits?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->json ? null : get_plan_feature_disabled_info() ?>>
                ...
                <div id="bulk_group" class="btn-group d-none" role="group">
                    <div class="btn-group dropdown" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="bulk_actions">
                            ...
                            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#audits_bulk_refresh_modal"><i class="fas fa-fw fa-sm fa-retweet mr-2"></i> <?= l('audits_bulk_refresh_modal.button') ?></a>
                        </div>
                    </div>
    ...
    <?php endif ?>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <?php
                $major_issues_percentage = $data->audits_stats['total_tests'] ? number_format($data->audits_stats['major_issues'] * 100 / $data->audits_stats['total_tests'], '2', '.', '') : 0;
                $moderate_issues_percentage = $data->audits_stats['total_tests'] ? number_format($data->audits_stats['moderate_issues'] * 100 / $data->audits_stats['total_tests'], '2', '.', '') : 0;
                $minor_issues_percentage = $data->audits_stats['total_tests'] ? number_format($data->audits_stats['minor_issues'] * 100 / $data->audits_stats['total_tests'], '2', '.', '') : 0;
                $passed_tests_percentage = $data->audits_stats['total_tests'] ? number_format($data->audits_stats['passed_tests'] * 100 / $data->audits_stats['total_tests'], '2', '.', '') : 0;
...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/audits/audits_bulk_refresh_modal.php'), 'modals'); ?>
