            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/audits') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="audits">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="audits_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/archived-audits') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="archived_audits">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="archived_audits_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="tools_submissions">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>
                </div>
...
<script>
    ...
    (async function fetch_statistics() {
        ...
        if(data.status == 'error') {
            ...
            document.querySelector('#audits').innerHTML = data.details.audits ? nr(data.details.audits) : 0;
            document.querySelector('#audits_current_month').innerHTML = data.details.audits_current_month ? nr(data.details.audits_current_month) : 0;

            document.querySelector('#archived_audits').innerHTML = data.details.archived_audits ? nr(data.details.archived_audits) : 0;
            document.querySelector('#archived_audits_current_month').innerHTML = data.details.archived_audits_current_month ? nr(data.details.archived_audits_current_month) : 0;

            document.querySelector('#tools_views').innerHTML = data.details.tools.views ? nr(data.details.tools.views) : 0;
            document.querySelector('#tools_submissions').innerHTML = data.details.tools.submissions ? nr(data.details.tools.submissions) : 0;
