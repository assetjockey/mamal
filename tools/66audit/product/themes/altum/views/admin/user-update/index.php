    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="ai_is_enabled" name="ai_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->ai_is_enabled ? 'checked="checked"' : null ?>>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="directory_is_enabled" name="directory_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->directory_is_enabled ? 'checked="checked"' : null ?>>
