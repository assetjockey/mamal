        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="ai_is_enabled" name="ai_is_enabled" type="checkbox" class="custom-control-input">
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="directory_is_enabled" name="directory_is_enabled" type="checkbox" class="custom-control-input">
