        ...
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <optgroup label="<?= l('admin_statistics.content') ?>">
                    ...
                    <option value="<?= url('admin/statistics/audits?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'audits' ? 'selected' : null ?>>⚡ <?= l('admin_audits.menu') ?></option>
                    <option value="<?= url('admin/statistics/archived_audits?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'archived_audits' ? 'selected' : null ?>>🗃️ <?= l('admin_archived_audits.menu') ?></option>
