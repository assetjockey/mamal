        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="ai_is_enabled" name="ai_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->ai_is_enabled ? 'checked="checked"' : null ?>>
                    <label class="custom-control-label" for="ai_is_enabled"><?= l('admin_plans.plan.ai_is_enabled') ?></label>
                    <div><small class="form-text text-muted"><?= l('admin_plans.plan.ai_is_enabled_help') ?></small></div>
                </div>

                <div class="form-group custom-control custom-switch">
                    <input id="directory_is_enabled" name="directory_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->directory_is_enabled ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    <label class="custom-control-label" for="directory_is_enabled"><?= l('admin_plans.plan.directory_is_enabled') ?></label>
                    <div><small class="form-text text-muted"><?= l('admin_plans.plan.directory_is_enabled_help') ?></small></div>
                </div>
