                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/users/', 'uploads/cache/', 'uploads/cookie_consent', 'uploads/logs', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/dynamic_og_images/'] as $key): ?>
                                    <tr>
                                        <td>/<?= $key ?></td>
