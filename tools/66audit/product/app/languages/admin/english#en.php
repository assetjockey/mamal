...
return [
    ...
    'admin_plans.plan.ai_is_enabled' => 'AI summaries',
    'admin_plans.plan.ai_is_enabled_help' => 'Enabling this will automatically generate an AI summary for each audit report generated.',
    'admin_plans.plan.directory_is_enabled' => 'Directory submission',
    'admin_plans.plan.directory_is_enabled_help' => 'Enabling this will allow your users to submit their websites to the directory system.',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
	...
	'admin_settings.internal_notifications.users_help' => '%sSend direct%s or bulk internal messages to your users.',
    ...
    'admin_settings.audits.audits_per_cron' => 'Audits refreshed per cron run',
    'admin_settings.audits.domains' => 'Domains',
    'admin_settings.audits.requests' => 'Requests',
    'admin_settings.audits.audits' => 'Audits',
	'admin_settings.audits.proxies' => 'Proxies',
	'admin_settings.audits.proxy_test' => 'Run test',
	'admin_settings.audits.proxy_test.success' => 'Proxy is working.',
	'admin_settings.audits.proxy_test.error' => 'Proxy test failed.',
    'admin_settings.audits.proxies_is_enabled' => 'Enable the Proxy system',
    'admin_settings.audits.proxies_is_enabled_help' => 'Enabling this will force the system to take a random proxy from the list below and use it to do the request for the audited web pages.',
    'admin_settings.audits.proxies_exclusive' => 'Proxy-only mode',
    'admin_settings.audits.proxies_exclusive_help' => 'When enabled, all requests will be sent through configured proxies. Direct connections from the server will not be used.',
    'admin_settings.audits.proxy_is_enabled' => 'Enable proxy',
    'admin_settings.audits.proxy_address' => 'Address',
    'admin_settings.audits.proxy_address_placeholder' => 'ip:port or username:password@ip:port',
    'admin_settings.audits.ai' => 'AI',
    'admin_settings.audits.ai_is_enabled' => 'Enable the AI audits system',
    'admin_settings.audits.ai_is_enabled_help' => 'Enabling this will automatically generate AI summaries for each audit report to people who have the plan feature enabled.',
    'admin_settings.audits.openai_api_key' => 'OpenAI API key',
    'admin_settings.audits.openai_api_key_help' => 'This field is only used for the automatic AI summaries for audits.',
    'admin_settings.audits.openai_webhook_secret_key' => 'OpenAI Webhook Secret Key',
    'admin_settings.audits.openai_webhook_secret_key_help' => 'Setup the webhook system on OpenAI to process AI summaries in background, instead of making waiting a long time for the AI processing until the report is displayed.',
    'admin_settings.audits.openai_webhook_url' => 'Webhook URL',
    'admin_settings.audits.openai_webhook_url_help' => 'Event types: %s.',
    'admin_settings.audits.openai_model' => 'OpenAI model',
    'admin_settings.audits.openai_model_help' => 'The model ID of your AI provider. Some of the flagship OpenAI models: %s',
    'admin_settings.audits.openai_api_url' => 'OpenAI API URL',
    'admin_settings.audits.openai_api_url_help' => 'Only change this if you want to use a proxy URL for OpenAI or another compatible API provider.',
    ...
    'admin_settings.audits.google_safe_browsing_api_key' => 'Google Safe Browsing API Key',
    'admin_settings.audits.google_safe_browsing_api_key_help' => 'The google safe browsing tests checks the audited link for malicious warnings provided by google.',
    'admin_settings.audits.excluded_words' => 'Excluded words',
    'admin_settings.audits.excluded_words_help' => 'Useful to exclude stop words like: "to", "and", "at", etc from being counted as keywords. Comma separated values.',
    'admin_settings.audits.bulk_processing_before_queue' => 'Instant bulk audit processing amount',
    'admin_settings.audits.bulk_processing_before_queue_help' => 'How many audits to be processed at once (instantly) when using Bulk or Sitemap audit generation. All remaining audits beside the instantly generated ones will be automatically processed by the cron queue. Keep it as low as possible for better UX.',
	'admin_settings.audits.directory' => 'Directory system',
	'admin_settings.audits.directory_is_enabled' => 'Enable the directory system',
	'admin_settings.audits.directory_is_enabled_help' => 'Enabling this will give your users the ability to add & discover the best SEO websites.',
	'admin_settings.audits.directory_access' => 'Who gets access',
	'admin_settings.audits.directory_access_everyone' => 'Guests & users',
	'admin_settings.audits.directory_access_users' => 'Users only',
