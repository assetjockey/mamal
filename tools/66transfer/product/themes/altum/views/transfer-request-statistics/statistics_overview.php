...
<div class="row mb-4">
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=country&continent_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class="">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=continent_code&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=city_name&country_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= get_country_from_country_code($key) ?></a>
                                <?php else: ?>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=city_name&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=referrer_path&referrer_host=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= $key ?></a>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
</div>
...
<div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('transfer-request-statistics/' . $data->transfer_request->transfer_request_id . '?type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none small">
