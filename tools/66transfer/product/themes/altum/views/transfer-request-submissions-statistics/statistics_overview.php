    ...
    <div class="row m-n2">
            ...
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="pl-3 d-flex flex-column justify-content-center">
                    <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                        <i class="fas fa-fw fa-sm fa-file-upload"></i>
                    </div>
                </div>

                <div class="card-body text-truncate">
                    <span class="h6"><?= nr($data->totals['pageviews']) . ' ' . l('transfer_request_submissions_statistics.submissions') ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                ...
                <div class="card-body text-truncate">
                    <span class="h6"><?= nr($data->totals['visitors']) . ' ' . l('transfer_request_submissions_statistics.unique_submissions') ?></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row mb-4">
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=country&continent_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class="">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=continent_code&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=city_name&country_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= get_country_from_country_code($key) ?></a>
                                <?php else: ?>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=city_name&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=referrer_path&referrer_host=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= $key ?></a>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
</div>
...
<div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=referrer_path&referrer_host=' . $row->referrer_host . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->referrer_host ?>" class=""><?= $row->referrer_host ?></a>
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('transfer-request-submissions-statistics/' . $data->transfer_request->transfer_request_id . '?type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none small">
...
<?php if (!empty($data->pageviews)): ?>
    ...
    new Chart(pageviews_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('transfer_request_submissions_statistics.submissions')) ?>,
                ...
                {
                    label: <?= json_encode(l('transfer_request_submissions_statistics.unique_submissions')) ?>,
