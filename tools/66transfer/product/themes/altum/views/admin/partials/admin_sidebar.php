...
<div class="admin-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminTransferRequests']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/transfer-requests') ?>">
                    <i class="fas fa-fw fa-sm fa-inbox mr-2"></i> <?= l('admin_transfer_requests.menu') ?>
                </a>
            </li>
