                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?= url('admin/transfer-requests?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('transfer_requests.title') ?>">
                                <i class="fas fa-fw fa-inbox text-muted"></i>
                            </a>
                        </div>
                    </td>
                    <td class="text-nowrap">
