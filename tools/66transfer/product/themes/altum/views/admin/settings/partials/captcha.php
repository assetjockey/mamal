...
<div>
    ...
    <?php foreach(['login', 'register', 'lost_password', 'resend_activation', 'contact', 'transfer_upload', 'transfer_download', 'transfer_request_create', 'transfer_request_upload'] as $key): ?>
