...
<div>
    ...
    <div class="form-group">
        <label for="header_transfers"><?= l('admin_settings.ads.header_transfers') ?></label>
        <textarea id="header_transfers" name="header_transfers" class="form-control"><?= settings()->ads->header_transfers ?></textarea>
    </div>

    <div class="form-group">
        <label for="footer_transfers"><?= l('admin_settings.ads.footer_transfers') ?></label>
        <textarea id="footer_transfers" name="footer_transfers" class="form-control"><?= settings()->ads->footer_transfers ?></textarea>
    </div>
</div>
