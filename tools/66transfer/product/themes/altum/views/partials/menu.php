...
<div class="container mt-4">
    <nav class="navbar navbar-main navbar-expand-lg navbar-light bg-white rounded-2x <?= \Altum\Router::$controller_key == 'index' ? null : 'mb-5' ?>">
        <div class="container">
            <a
                    href="<?= url() ?>"
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    <div class="pr-lg-3">
                                        ...
                                        <?php if(settings()->transfers->transfer_requests_is_enabled): ?>
                                            <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['TransferRequests', 'TransferRequestUpdate', 'TransferRequest', 'TransferRequestUploads', 'TransferRequestStatistics', 'TransferRequestQr']) ? 'active' : null ?>" href="<?= url('transfer-requests') ?>"><i class="fas fa-fw fa-sm fa-inbox mr-2"></i> <?= l('transfer_requests.menu') ?></a>
                                        <?php endif ?>
