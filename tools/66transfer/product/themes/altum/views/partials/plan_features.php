...
<ul class="list-style-none m-0">
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php ob_start() ?>
        <?php if($feature == 'storage_size_limit'): ?>
        ...
        <?php if($feature == 'transfers_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if(settings()->transfers->transfer_requests_is_enabled): ?>
            <?php if($feature == 'transfer_requests_limit'): ?>
                <li class="d-flex align-items-baseline mb-2">
                    <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->transfer_requests_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
                    <div class="<?= $data->plan_settings->transfer_requests_limit ? null : 'text-muted' ?>">
                        <?= sprintf(l('global.plan_settings.transfer_requests_limit'), '<strong>' . ($data->plan_settings->transfer_requests_limit == -1 ? l('global.unlimited') : nr($data->plan_settings->transfer_requests_limit)) . '</strong>') ?>
                    </div>
                </li>
            <?php endif ?>
        <?php endif ?>

        <?php if($feature == 'transfer_size_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'files_per_transfer_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'downloads_per_transfer_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'transfers_retention'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'download_unlocking_time'): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'projects_limit' && settings()->transfers->projects_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'pixels_limit' && settings()->transfers->pixels_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'domains_limit' && settings()->transfers->domains_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
        ...
        <?php if($feature == 'additional_domains' && settings()->transfers->additional_domains_is_enabled): ?>
        ...
        <?php if($feature == 'file_encryption_is_enabled'): ?>
            <li class="d-flex align-items-baseline mb-2">
