                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <div>
                                    <button type="button" class="btn btn-light" title="<?= l('teams_member_login_modal.menu') ?>" data-team-member-id="<?= $row->team_member_id ?>" data-tooltip data-tooltip-hide-on-click <?= !$row->status ? 'disabled="disabled"' : null ?>>
