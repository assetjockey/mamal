...
<script>
    ...
    document.querySelectorAll('[data-team-member-login][data-team-member-id]').forEach(element => {
        element.addEventListener('click', event => {
            event.preventDefault();

            const team_member_id = element.getAttribute('data-team-member-id');
            const form = document.querySelector('#teams_member_login_modal form[name="teams_member_login_modal"]');
