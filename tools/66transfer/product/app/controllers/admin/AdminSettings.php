...
class AdminSettings extends Controller {
    ...
    public function captcha() {
        ...
        if(!empty($_POST)) {
            ...
            foreach(['login', 'register', 'lost_password', 'resend_activation', 'contact', 'transfer_upload', 'transfer_download', 'transfer_request_create', 'transfer_request_upload'] as $key) {
            ...
            $value = json_encode([
                ...
                'transfer_request_create_is_enabled' => $_POST['transfer_request_create_is_enabled'],
                'transfer_request_upload_is_enabled' => $_POST['transfer_request_upload_is_enabled'],
            ]);
    ...
    public function transfers() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['transfer_requests_is_enabled'] = (int) isset($_POST['transfer_requests_is_enabled']);
            ...
            $value = json_encode([
                ...
                'transfer_requests_is_enabled' => $_POST['transfer_requests_is_enabled'],
