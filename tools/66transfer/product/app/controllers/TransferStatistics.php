    ...
    public function index() {
        ...
        switch($type) {
            ...
            case 'entries':
                ...
                $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('transfer-statistics/' . $transfer->transfer_id . '?type=' . $type . '&start_date=' . $datetime['start_date'] . '&end_date=' . $datetime['end_date'] . $filters->get_get() . '&page={{PAGE}}')));
