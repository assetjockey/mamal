    ...
    <style>
        * { box-sizing: border-box; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .badge { background: #fff !important; color: #09090b !important; }
            .spinner { border-color: rgba(255,255,255,0.12) !important; border-top-color: #fff !important; }
            h1 { color: #fafafa !important; }
            p { color: #a1a1aa !important; }
            .secured { color: #52525b !important; }
            .back { color: #fafafa !important; }
        }
        .card {
            width: 100%;
            max-width: 400px;
        ...
        h1 { font-size: 1.1rem; font-weight: 700; color: #18181b; margin: 0 0 0.5rem; }
...
<body>
    <div class="card">
        ...
        <a id="back-link" class="back" href="{{ route('admin.themes') }}">{{ __('Return to Themes') }}</a>
    ...
    <script>
        (function () {
            const processUrl = @json(route('admin.themes.payments.process'));
