    ...
    <div class="flex justify-center">
        <div class="w-full lg:w-8/12 space-y-6 pb-10">
            ...
            <flux:breadcrumbs>
                ...
                <flux:breadcrumbs.item separator="slash" class="text-xs">{{ __('Create') }}</flux:breadcrumbs.item>
            </flux:breadcrumbs>

            {{-- Page header --}}
            <div class="flex items-center justify-between mt-8 mb-10">
                <h1 class="text-lg font-bold">{{ __('Create New User') }}</h1>
            ...
            <form wire:submit="save" class="space-y-10">
                ...
                <div class="rounded-2xl border border-(--default-border-color) bg-(--default-element-bg-color) overflow-hidden">
                    <div class="px-6 py-4 border-b border-(--default-border-color) flex items-center gap-2">
                        <x-heroicon-o-lock-closed class="w-4 h-4 text-(--default-primary-color)" />
                        <h2 class="font-semibold text-sm">{{ __('Login Credentials') }}</h2>
                    </div>
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div class="sm:col-span-2">
                            <label class="block text-xs font-medium text-gray-500 mb-1.5">{{ __('Email Address') }} <span class="text-red-400">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1.5">{{ __('Password') }} <span class="text-red-400">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1.5">{{ __('Confirm Password') }} <span class="text-red-400">*</span></label>
                ...
                <div class="rounded-2xl border border-(--default-border-color) bg-(--default-element-bg-color)">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input wire:model="credits" type="number" min="0"
                                   class="w-full rounded-xl border border-(--default-border-color) bg-(--default-element-bg-color) px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-(--default-primary-color) focus:border-transparent transition" />
