...
class ProductPhotoshootShoot extends Model
{
    protected $guarded = [];
     ...
     * (public/results/...) exactly like AdCreative / Fashion Studio, so it is
     * served by the web server with no symlink involvement.
     */
