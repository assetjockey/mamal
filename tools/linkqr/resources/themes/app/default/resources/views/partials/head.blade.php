...
<script>
    (() => {
        ...
        const initialMode = () => {
            ...
            const storedDefault = storedValue(defaultStorageKey);

            if (storedDefault !== configuredMode()) {
                return configuredMode();
            }
        ...
        const getMode = () => normalizeMode(document.documentElement.dataset.themeMode || initialMode());
