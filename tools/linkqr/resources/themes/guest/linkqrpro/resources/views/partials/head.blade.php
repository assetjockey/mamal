...
<style>
    ...
    html[data-theme-resolved='dark'] body[style] {
        background:
            linear-gradient(rgba(96, 165, 250, 0.055) 1px, transparent 1px),
            linear-gradient(90deg, rgba(96, 165, 250, 0.055) 1px, transparent 1px),
            radial-gradient(circle at 20% 8%, rgba(37, 99, 235, 0.22), transparent 28%),
    ...
    html[data-theme-resolved='dark'] header {
        background: rgba(7, 17, 31, 0.82);
        backdrop-filter: blur(18px);
    }

    html[data-theme-resolved='dark'] header img,
    html[data-theme-resolved='dark'] footer img,
    html[data-theme-resolved='dark'] .linkqr-brand-logo img {
        filter: brightness(0) invert(1);
    }

    html[data-theme-resolved='dark'] [class*="text-[#181714]"],
    html[data-theme-resolved='dark'] [class*="text-[#0F172A]"],
    html[data-theme-resolved='dark'] [class*="text-gray-900"],
    html[data-theme-resolved='dark'] [class*="text-blueGray-900"] {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] [class*="text-[#57534b]"],
    html[data-theme-resolved='dark'] [class*="text-[#6d685f]"],
    html[data-theme-resolved='dark'] [class*="text-[#8a867d]"],
    html[data-theme-resolved='dark'] [class*="text-gray-600"],
    html[data-theme-resolved='dark'] [class*="text-gray-500"],
    html[data-theme-resolved='dark'] [class*="text-blueGray-600"],
    html[data-theme-resolved='dark'] [class*="text-blueGray-500"] {
        color: #cbd5e1 !important;
    }

    html[data-theme-resolved='dark'] [class*="hover:text-[#181714]"]:hover {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] [class*="bg-[#fbfaf6]"],
    html[data-theme-resolved='dark'] [class*="bg-[#fffdf8]"],
    html[data-theme-resolved='dark'] [class*="bg-[#f4f1ea]"],
    html[data-theme-resolved='dark'] [class*="bg-[#f4f0e7]"],
    html[data-theme-resolved='dark'] [class*="bg-white/70"],
    html[data-theme-resolved='dark'] [class*="bg-white/80"],
    html[data-theme-resolved='dark'] [class*="bg-white/90"] {
        background-color: rgba(15, 23, 42, 0.84) !important;
    }

    html[data-theme-resolved='dark'] [class*="bg-[#d8f2fb]"],
    html[data-theme-resolved='dark'] [class*="bg-[#eef7ff]"],
    html[data-theme-resolved='dark'] [class*="bg-[#edf6ff]"],
    html[data-theme-resolved='dark'] [class*="bg-[#cfeefd]"],
    html[data-theme-resolved='dark'] [class*="bg-[#fff6dd]"],
    html[data-theme-resolved='dark'] [class*="bg-[#fff0c2]"],
    html[data-theme-resolved='dark'] [class*="bg-[#f9f3df]"],
    html[data-theme-resolved='dark'] [class*="bg-[#fff3d8]"] {
        background-color: rgba(30, 41, 59, 0.86) !important;
    }

    html[data-theme-resolved='dark'] [class*="border-[#ded7ca]"],
    html[data-theme-resolved='dark'] [class*="border-[#d8d3c7]"],
    html[data-theme-resolved='dark'] [class*="border-[#e8dfd1]"],
    html[data-theme-resolved='dark'] [class*="border-[#e5dfd2]"],
    html[data-theme-resolved='dark'] [class*="border-[#eadfca]"],
    html[data-theme-resolved='dark'] [class*="border-[#eee7da]"] {
    ...
    html[data-theme-resolved='dark'] [class*="bg-[#181714]"] {
        background-color: #f8fafc !important;
        color: #07111f !important;
    }

    html[data-theme-resolved='dark'] [class*="text-white"] {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] [class*="bg-[#181714]"][class*="text-white"],
    html[data-theme-resolved='dark'] a[class*="bg-[#181714]"],
    html[data-theme-resolved='dark'] button[class*="bg-[#181714]"] {
        color: #07111f !important;
    }
    ...
    html[data-theme-resolved='dark'] .prose h1,
    html[data-theme-resolved='dark'] .prose h2,
    html[data-theme-resolved='dark'] .prose h3,
    html[data-theme-resolved='dark'] .prose strong {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .prose a {
        color: #93c5fd !important;
    }

    html[data-theme-resolved='dark'] .linkqrpro-paper,
    html[data-theme-resolved='dark'] .linkqrpro-blue-paper {
        background-color: #07111f !important;
        background-image:
            linear-gradient(rgba(96, 165, 250, 0.07) 1px, transparent 1px),
            linear-gradient(90deg, rgba(96, 165, 250, 0.07) 1px, transparent 1px),
            radial-gradient(circle at 18% 12%, rgba(37, 99, 235, 0.18), transparent 30%),
            radial-gradient(circle at 86% 20%, rgba(20, 184, 166, 0.14), transparent 28%) !important;
        background-size: 36px 36px, 36px 36px, auto, auto !important;
    }

    html[data-theme-resolved='dark'] .lq-hero-preview,
    html[data-theme-resolved='dark'] .lq-feature-card,
    html[data-theme-resolved='dark'] .lq-step-card,
    html[data-theme-resolved='dark'] .lq-use-card,
    html[data-theme-resolved='dark'] .lq-shortlink-window,
    html[data-theme-resolved='dark'] .lq-feature-showcase,
    html[data-theme-resolved='dark'] .lq-card,
    html[data-theme-resolved='dark'] .lq-username-card {
        background:
            radial-gradient(circle at 18% 0%, rgba(96, 165, 250, 0.10), transparent 34%),
            linear-gradient(135deg, rgba(15, 23, 42, 0.96), rgba(11, 21, 38, 0.92)) !important;
        border-color: rgba(96, 165, 250, 0.26) !important;
        box-shadow: 0 28px 86px -58px rgba(0, 0, 0, 0.88) !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-card::before {
        opacity: .48 !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-card::after {
    ...
    html[data-theme-resolved='dark'] .lq-shortlink-window {
        background:
            ...
            radial-gradient(circle at 12% 18%, rgba(255, 197, 45, 0.16), transparent 28%),
            linear-gradient(135deg, rgba(15, 23, 42, 0.96), rgba(11, 21, 38, 0.9)) !important;
        background-size: 26px 26px, 26px 26px, auto, auto !important;
    }

    html[data-theme-resolved='dark'] .lq-workflow-panel {
        background:
            radial-gradient(circle at 18% 12%, rgba(147, 197, 253, .18), transparent 28%),
            radial-gradient(circle at 86% 24%, rgba(20, 184, 166, .12), transparent 32%),
            linear-gradient(180deg, #1d4ed8 0%, #0f2d63 100%) !important;
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-workflow-panel [class*="text-[#102453]"],
    html[data-theme-resolved='dark'] .lq-workflow-panel i,
    html[data-theme-resolved='dark'] .lq-workflow-panel span,
    html[data-theme-resolved='dark'] .lq-workflow-panel p,
    html[data-theme-resolved='dark'] .lq-workflow-panel h2 {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-workflow-panel [class*="bg-[#102453]"] {
        background-color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-workflow-panel [class*="bg-white/"] {
        background-color: rgba(255, 255, 255, 0.13) !important;
    }

    html[data-theme-resolved='dark'] .lq-hero-preview .linkqrpro-blue-paper {
        background-color: rgba(216, 242, 251, 0.12) !important;
    }

    html[data-theme-resolved='dark'] .lq-link-row,
    html[data-theme-resolved='dark'] .lq-use-link,
    html[data-theme-resolved='dark'] .lq-shortlink-window > div,
    html[data-theme-resolved='dark'] .lq-metric {
        background-color: rgba(15, 23, 42, 0.82) !important;
        border-color: rgba(96, 165, 250, 0.22) !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-card > .relative:first-child > div,
    html[data-theme-resolved='dark'] .lq-use-icon,
    html[data-theme-resolved='dark'] .lq-step-icon,
    html[data-theme-resolved='dark'] .lq-badge-icon,
    html[data-theme-resolved='dark'] span[class*="bg-[#cef8dc]"],
    html[data-theme-resolved='dark'] span[class*="bg-[#cfeefd]"],
    html[data-theme-resolved='dark'] div[class*="bg-[#cfeefd]"],
    html[data-theme-resolved='dark'] div[class*="bg-[#ffc52d]"],
    html[data-theme-resolved='dark'] div[class*="bg-[#f7d1e6]"],
    html[data-theme-resolved='dark'] div[class*="bg-[#e4ddff]"],
    html[data-theme-resolved='dark'] div[class*="bg-[#dff3ce]"],
    html[data-theme-resolved='dark'] div[style*="background: #"] {
        color: #07111f !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-card > .relative:first-child > div i,
    html[data-theme-resolved='dark'] .lq-use-icon i,
    html[data-theme-resolved='dark'] .lq-step-icon i,
    html[data-theme-resolved='dark'] .lq-badge-icon i {
        color: #07111f !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-card > i,
    html[data-theme-resolved='dark'] .lq-use-card > i,
    html[data-theme-resolved='dark'] .lq-feature-showcase > i {
        color: rgba(226, 232, 240, 0.13) !important;
    }

    html[data-theme-resolved='dark'] [class*="bg-[#f9f3df]"] p,
    html[data-theme-resolved='dark'] [class*="bg-[#fff6dd]"] p,
    html[data-theme-resolved='dark'] [class*="bg-[#fffdf8]"] p,
    html[data-theme-resolved='dark'] [class*="bg-white/75"],
    html[data-theme-resolved='dark'] [class*="bg-white/86"] {
        color: #e8eef7 !important;
    }
    ...
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#fff3d8]"],
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#f9f3df]"],
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#fffdf8]"] {
        background-color: rgba(30, 41, 59, 0.92) !important;
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-shortlink-window span[class*="bg-white"],
    html[data-theme-resolved='dark'] .lq-feature-showcase span[class*="bg-white"] {
        background-color: rgba(15, 23, 42, 0.92) !important;
        color: #e8eef7 !important;
        border-color: rgba(96, 165, 250, 0.24) !important;
    }

    html[data-theme-resolved='dark'] .lq-draw {
        background-color: #fbbf24 !important;
        color: #181714 !important;
    }

    html[data-theme-resolved='dark'] .lq-draw h2,
    html[data-theme-resolved='dark'] .lq-draw p {
        color: #181714 !important;
    }

    html[data-theme-resolved='dark'] .lq-draw a {
        background-color: #181714 !important;
        color: #ffffff !important;
    }

    html[data-theme-resolved='dark'] .lq-hero-copy .lq-reveal {
        background: rgba(15, 23, 42, 0.76) !important;
        border-color: rgba(96, 165, 250, 0.38) !important;
        color: #e8eef7 !important;
        box-shadow: 0 18px 42px -34px rgba(96, 165, 250, 0.75);
    }

    html[data-theme-resolved='dark'] .lq-hero-copy .lq-reveal > span:last-child {
        color: #e8eef7 !important;
    }

    html[data-theme-resolved='dark'] .lq-badge-icon,
    html[data-theme-resolved='dark'] .lq-step-icon {
        background: #cfeefd !important;
        color: #07111f !important;
        opacity: 1 !important;
        box-shadow: 0 18px 36px -28px rgba(147, 197, 253, 0.9);
    }
    ...
    html[data-theme-resolved='dark'] .lq-feature-showcase [class*="bg-[#f9f3df]"],
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#fffdf8]"],
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-white/90"] {
        background: rgba(15, 23, 42, 0.88) !important;
        border-color: rgba(96, 165, 250, 0.26) !important;
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-showcase [class*="bg-[#f9f3df]"] p,
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#fffdf8]"] p,
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-white/90"] p {
        color: #f8fafc !important;
    }

    html[data-theme-resolved='dark'] .lq-feature-showcase [class*="bg-[#f9f3df]"] p:last-child,
    html[data-theme-resolved='dark'] .lq-shortlink-window [class*="bg-[#fffdf8]"] p:last-child {
        color: #cbd5e1 !important;
    }
    ...
    html[data-theme-resolved='dark'] .lq-shortlink-window span[class*="bg-[#181714]"] {
    ...
    html[data-theme-resolved='dark'] .lq-draw a,
    html[data-theme-resolved='dark'] .lq-draw a[class*="bg-[#181714]"] {
        background: #181714 !important;
        color: #ffffff !important;
        border-color: rgba(24, 23, 20, 0.45) !important;
    }
    ...
    html[data-theme-resolved='dark'] body > div[class*="bg-[linear-gradient"] {
        background:
            linear-gradient(rgba(96, 165, 250, 0.1) 1px, transparent 1px),
            linear-gradient(90deg, rgba(96, 165, 250, 0.1) 1px, transparent 1px),
            radial-gradient(circle at 14% 8%, rgba(37, 99, 235, 0.22), transparent 28rem),
            radial-gradient(circle at 86% 12%, rgba(20, 184, 166, 0.18), transparent 32rem),
            #07111f !important;
        background-size: 34px 34px, 34px 34px, auto, auto, auto !important;
    }

    html[data-theme-resolved='dark'] img[src*="logo-brand-dark"],
    html[data-theme-resolved='dark'] img[src*="logo-dark"] {
        filter: brightness(0) invert(1);
    }
...
<script>
    (() => {
        ...
        const defaultMode = @js(theme_setting('default_appearance', 'guest', theme_setting('appearance', 'guest', 'light')));
        const normalize = (mode) => {
            const allowedModes = supportsDark ? ['light', 'dark', 'system'] : ['light'];
            const fallback = supportsDark ? (defaultMode || 'light') : 'light';
        ...
        const configuredMode = normalize(defaultMode || 'light');
        const initialMode = () => {
            if (!allowToggle) {
