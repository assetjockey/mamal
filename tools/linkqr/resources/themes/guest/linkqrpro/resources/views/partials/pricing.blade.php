                ...
                @foreach($planTypes as $typeKey => $typeLabel)
                    ...
                    @foreach($plans as $index => $plan)
                        ...
                        <div class="w-full lg:w-1/3 lg:flex-1"
                            ...
                            <div class="linkqr-pricing-card relative h-full px-9 pt-8 pb-11 {{ !empty($plan['featured']) ? 'is-featured' : '' }}" style="backdrop-filter: blur(46px);">
                                            ...
                                            @if(!empty($feature['subfeature']))
                                                <div x-data="{ open: false, timer: null }" class="relative ml-2">
                                                    ...
                                                    <div
                                                        ...
                                                        @mouseenter="clearTimeout(timer); open = true"
                                                        @mouseleave="timer = setTimeout(() => open = false, 120)"
                                                        class="absolute right-0 top-full mt-3 z-30 min-w-[320px] w-[320px] max-w-[calc(100vw-2rem)] max-h-[400px] overflow-y-auto rounded-xl border border-gray-200 bg-white text-gray-800 p-4 shadow-xl"
                                                        x-transition
                                                    >
