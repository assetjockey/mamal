...
>
    <div class="mx-auto max-w-5xl rounded-[1.1rem] border p-4 shadow-[0_28px_90px_-58px_rgba(15,23,42,0.7)] backdrop-blur-xl sm:p-5" style="border-color: rgba(var(--theme-border-color-rgb),0.78); background: rgba(var(--theme-surface-bg-rgb),0.94);">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                ...
                <button type="button" x-on:click="accept()" class="linkqr-button-primary inline-flex h-11 items-center justify-center rounded-[var(--theme-button-radius)] px-4 text-sm font-bold">
                    {{ __('Allow') }}
                </button>
            </div>
        </div>
