<div class="flex flex-col gap-6">
    <div class="space-y-2 text-center">
        <h1 class="text-3xl font-extrabold tracking-[-0.045em] text-slate-950">{{ __('Reset password') }}</h1>
        <p class="text-sm text-slate-500">{{ __('Please enter your new password below') }}</p>
    </div>
