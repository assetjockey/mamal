...
<div class="mx-auto w-full max-w-3xl">
    <div class="flex flex-col gap-6">
        <div class="space-y-4 text-center">
            <span class="inline-flex items-center rounded-full border bg-blue-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-blue-700" style="border-color: rgba(var(--theme-border-color-rgb),0.8);">
                {{ __('Create workspace') }}
            </span>
            <div class="space-y-3">
                <h1 class="text-4xl font-extrabold tracking-[-0.055em] text-slate-950">{{ __('Create your account') }}</h1>
                <p class="mx-auto max-w-2xl text-base leading-8 text-slate-500">
