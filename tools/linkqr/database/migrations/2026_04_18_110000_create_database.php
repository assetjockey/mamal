...
return new class extends Migration
{
    public function up(): void
    {
        ...
        (static function (): void {
            ...
            try {
                ...
                Schema::create('plans', function (Blueprint $table): void {
                    ...
                    $table->boolean('featured')->default(0);
                    $table->boolean('publicly_visible')->default(1);
                    $table->string('currency', 10)->default('USD');
                    $table->decimal('price', 12, 2)->default(0);
                    $table->unsignedTinyInteger('type')->default(1);
                ...
                Schema::create('analytics_alert_rules', function (Blueprint $table): void {
                    ...
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    $table->string('scope', 40)->default('qr');
                    $table->string('name', 160);
                    $table->string('metric', 80)->default('scan_spike');
                    $table->decimal('threshold', 12, 2)->default(100);
                ...
                Schema::create('app_qr_codes', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    ...
                    $table->string('short_code', 48)->nullable()->unique();
                    $table->string('short_domain', 190)->nullable()->index();
                    $table->string('foreground_color', 24)->default('#0f172a');
                    $table->string('background_color', 24)->default('#ffffff');
                    $table->string('pattern', 60)->default('square');
                ...
                Schema::create('app_qr_scan_events', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('app_qr_code_id')->index();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    ...
                    $table->index(['owner_user_id', 'created_at'], 'app_qr_scan_events_owner_created_idx');
                    $table->index(['owner_user_id', 'app_qr_code_id', 'created_at'], 'app_qr_scan_events_owner_code_created_idx');
                });
    
                Schema::create('link_bio_folders', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                ...
                Schema::create('link_bio_pages', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    ...
                    $table->string('public_path', 180)->nullable();
                    $table->string('headline', 190)->nullable();
                    $table->text('description')->nullable();
                    $table->string('accent_color', 24)->nullable();
                    $table->text('avatar_url')->nullable();
                    $table->text('cover_url')->nullable();
                    $table->string('template_key', 60)->default('paper-stack');
                    $table->string('status', 30)->default('draft')->index();
                    $table->boolean('is_published')->default(false)->index();
                    $table->json('blocks')->nullable();
                    $table->json('settings')->nullable();
                    $table->timestamps();
                    $table->index(['owner_user_id', 'folder_id']);
                });
    
                Schema::create('link_bio_events', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('link_bio_page_id')->index();
                    ...
                    $table->json('metadata')->nullable();
                    $table->timestamps();
                    $table->index(['link_bio_page_id', 'type']);
                    $table->index(['link_bio_page_id', 'block_index', 'item_index']);
                });
    
                Schema::create('link_bio_short_links', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('link_bio_page_id')->index();
                    $table->unsignedBigInteger('owner_user_id')->index();
                ...
                Schema::create('link_bio_qr_designs', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('link_bio_page_id')->index();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->string('name', 120)->default('Default');
                    $table->string('pattern', 60)->default('square');
                    $table->string('finder_shape', 60)->default('square');
                    $table->string('finder_dot_shape', 60)->default('square');
                    $table->string('foreground_color', 24)->default('#0f172a');
                    $table->string('background_color', 24)->default('#ffffff');
                    $table->string('gradient_type', 30)->nullable();
                    $table->json('gradient_stops')->nullable();
                    $table->text('logo_url')->nullable();
                    $table->string('logo_background_color', 24)->nullable();
                    $table->string('sticker_text', 160)->nullable();
                    $table->string('sticker_font', 120)->default('Inter');
                    $table->string('sticker_shape', 60)->default('none');
                    $table->json('settings')->nullable();
                    $table->timestamps();
                    $table->index(['link_bio_page_id', 'owner_user_id']);
                });
    
                Schema::create('app_brand_kits', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    $table->string('brand_name')->nullable();
                    $table->string('logo_url')->nullable();
                    $table->string('primary_color', 24)->default('#2563eb');
                    $table->string('secondary_color', 24)->default('#0f172a');
                    $table->string('accent_color', 24)->default('#10b981');
                    $table->string('font_family')->default('Inter');
                    $table->json('settings')->nullable();
                    $table->timestamps();
                    $table->unique(['owner_user_id', 'team_id']);
                });
                ...
                Schema::create('app_utm_presets', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    $table->string('name');
                    ...
                    $table->timestamps();
                    $table->index(['owner_user_id', 'is_default']);
                });
    
                Schema::create('app_tracking_pixels', function (Blueprint $table): void {
                    $table->id();
                    $table->unsignedBigInteger('owner_user_id')->index();
                    $table->unsignedBigInteger('team_id')->nullable()->index();
                    $table->string('name');
                ...
                Schema::table('analytics_alert_rules', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'analytics_alert_rules_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'analytics_alert_rules_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('app_qr_codes', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'app_qr_codes_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'app_qr_codes_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('app_qr_scan_events', function (Blueprint $table): void {
                    $table->foreign('app_qr_code_id', 'app_qr_scan_events_app_qr_code_id_foreign')->references('id')->on('app_qr_codes')->cascadeOnDelete();
                    $table->foreign('owner_user_id', 'app_qr_scan_events_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                });
    
                Schema::table('link_bio_folders', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'link_bio_folders_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'link_bio_folders_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('link_bio_pages', function (Blueprint $table): void {
                    $table->foreign('folder_id', 'link_bio_pages_folder_id_foreign')->references('id')->on('link_bio_folders')->nullOnDelete();
                    $table->foreign('owner_user_id', 'link_bio_pages_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'link_bio_pages_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('link_bio_events', function (Blueprint $table): void {
                    $table->foreign('link_bio_page_id', 'link_bio_events_link_bio_page_id_foreign')->references('id')->on('link_bio_pages')->cascadeOnDelete();
                });
    
                Schema::table('link_bio_short_links', function (Blueprint $table): void {
                    $table->foreign('link_bio_page_id', 'link_bio_short_links_link_bio_page_id_foreign')->references('id')->on('link_bio_pages')->cascadeOnDelete();
                    $table->foreign('owner_user_id', 'link_bio_short_links_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                });
    
                Schema::table('link_bio_qr_designs', function (Blueprint $table): void {
                    $table->foreign('link_bio_page_id', 'link_bio_qr_designs_link_bio_page_id_foreign')->references('id')->on('link_bio_pages')->cascadeOnDelete();
                    $table->foreign('owner_user_id', 'link_bio_qr_designs_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                });
    
                Schema::table('app_brand_kits', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'app_brand_kits_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'app_brand_kits_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('app_utm_presets', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'app_utm_presets_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'app_utm_presets_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
    
                Schema::table('app_tracking_pixels', function (Blueprint $table): void {
                    $table->foreign('owner_user_id', 'app_tracking_pixels_owner_user_id_foreign')->references('id')->on('users')->cascadeOnDelete();
                    $table->foreign('team_id', 'app_tracking_pixels_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                });
        ...
        // Source: modules\AppLinkBio\database\migrations\2026_05_04_000002_backfill_link_bio_pricing_permissions.php
        (static function (): void {
            ...
            DB::table('plans')
                ...
                ->chunkById(100, function ($plans): void {
                    foreach ($plans as $plan) {
                        ...
                        if (! is_array($permissions) || empty($permissions['link_bio'])) {
                            continue;
                        }
    
                        $changed = false;
    
                        if (! array_key_exists('link_bio_ai_assistant', $permissions)) {
                            $permissions['link_bio_ai_assistant'] = true;
                            $changed = true;
                        }
    
                        if (! array_key_exists('link_bio_remove_branding', $permissions)) {
                            $permissions['link_bio_remove_branding'] = false;
                            $changed = true;
                        }
        ...
        // Source: modules\AppLinkBio\database\migrations\2026_05_04_000004_backfill_link_bio_saas_feature_permissions.php
        (static function (): void {
            if (! Schema::hasTable('plans') || ! Schema::hasColumn('plans', 'permissions')) {
                return;
            }
            ...
            DB::table('plans')
                ...
                ->chunkById(100, function ($plans): void {
                    foreach ($plans as $plan) {
                        ...
                        foreach (['link_bio_templates', 'link_bio_analytics', 'link_bio_qr_codes'] as $key) {
        ...
        // Source: modules\AppBrandKit\database\migrations\2026_05_06_000001_split_brand_plan_permissions.php
        (static function (): void {
            if (! Schema::hasTable('plans') || ! Schema::hasColumn('plans', 'permissions')) {
                return;
            }
            ...
            DB::table('plans')
                ...
                ->chunkById(100, function ($plans): void {
                    foreach ($plans as $plan) {
                        ...
                        $fallback = $permissions['qr_custom_domains'] ?? true;
                        $changed = false;
    
                        foreach (['brand_kit', 'tracking_pixels', 'utm_presets'] as $key) {
                            if (! array_key_exists($key, $permissions)) {
        ...
        // Source: modules\AppQRCodes\database\migrations\2026_05_06_000002_add_qr_plan_limits.php
        (static function (): void {
            if (! Schema::hasTable('plans') || ! Schema::hasColumn('plans', 'permissions')) {
                return;
            }
            ...
            DB::table('plans')
                ...
                ->chunkById(100, function ($plans): void {
                    foreach ($plans as $plan) {
                        ...
                        $defaults = [
                            'max_qr_codes' => -1,
                            'max_qr_scans_monthly' => -1,
                            'max_dynamic_rules_per_qr' => 10,
                            'max_qr_bulk_rows' => -1,
                        ];
                        $changed = false;
        ...
        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000001_create_app_short_links_tables.php
        (static function (): void {
            Schema::create('app_short_links', function (Blueprint $table): void {
                $table->id();
                $table->unsignedBigInteger('owner_user_id')->index();
                $table->unsignedBigInteger('team_id')->nullable()->index();
                $table->string('name', 160);
                $table->text('destination_url');
                $table->string('short_code', 48)->unique();
            ...
            Schema::create('app_short_link_clicks', function (Blueprint $table): void {
                $table->id();
                $table->unsignedBigInteger('app_short_link_id')->index();
                $table->unsignedBigInteger('owner_user_id')->index();
                $table->string('ip_address', 64)->nullable();
                $table->text('user_agent')->nullable();
                $table->text('referer')->nullable();
                ...
                $table->foreign('app_short_link_id')->references('id')->on('app_short_links')->cascadeOnDelete();
                $table->foreign('owner_user_id')->references('id')->on('users')->cascadeOnDelete();
            });
        
        })();

        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000002_add_saas_fields_to_app_short_links.php
        (static function (): void {
            Schema::table('app_short_links', function (Blueprint $table): void {
                $table->unsignedBigInteger('custom_domain_id')->nullable()->after('team_id')->index();
                $table->unsignedBigInteger('utm_preset_id')->nullable()->after('custom_domain_id')->index();
                $table->json('tracking_pixel_ids')->nullable()->after('utm_preset_id');
                $table->timestamp('expires_at')->nullable()->after('status')->index();
                $table->unsignedBigInteger('click_limit')->nullable()->after('expires_at');
                $table->string('password_hash')->nullable()->after('click_limit');
                $table->string('og_title', 160)->nullable()->after('last_clicked_at');
                $table->text('og_description')->nullable()->after('og_title');
                $table->text('og_image')->nullable()->after('og_description');
                $table->json('settings')->nullable()->after('og_image');
            });
        
        })();

        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000003_create_app_short_link_abuse_reports_table.php
        (static function (): void {
            if (Schema::hasTable('app_short_link_abuse_reports')) {
                return;
            }
    
            Schema::create('app_short_link_abuse_reports', function (Blueprint $table): void {
                $table->id();
                $table->foreignId('app_short_link_id')->constrained('app_short_links')->cascadeOnDelete();
                ...
                $table->timestamps();
                $table->index(['app_short_link_id', 'status']);
            });
        
        })();

        // Source: modules\AppShortLinkApi\database\migrations\2026_05_08_000001_create_short_link_api_tables.php
        (static function (): void {
            Schema::create('app_short_link_api_keys', function (Blueprint $table): void {
                $table->id();
                $table->unsignedBigInteger('owner_user_id')->index();
                $table->unsignedBigInteger('team_id')->nullable()->index();
                $table->string('name', 120);
            ...
            Schema::create('app_short_link_webhooks', function (Blueprint $table): void {
                $table->id();
                $table->unsignedBigInteger('owner_user_id')->index();
                $table->unsignedBigInteger('team_id')->nullable()->index();
                $table->string('name', 120);
        ...
        // Source: modules\AppShortLinkCampaigns\database\migrations\2026_05_08_000001_add_campaign_fields_to_app_short_links.php
        (static function (): void {
            Schema::table('app_short_links', function (Blueprint $table): void {
                $table->string('folder', 120)->nullable()->after('name')->index();
                $table->string('campaign', 160)->nullable()->after('folder')->index();
                $table->json('tags')->nullable()->after('campaign');
            });
        
        })();

        // Source: modules\AppShortLinkRules\database\migrations\2026_05_08_000001_add_rule_fields_to_app_short_links.php
        (static function (): void {
            Schema::table('app_short_links', function (Blueprint $table): void {
                $table->json('redirect_rules')->nullable()->after('settings');
                $table->string('moderation_status', 30)->default('approved')->after('redirect_rules')->index();
                $table->text('moderation_note')->nullable()->after('moderation_status');
            });
        
        })();

        // Source: modules\AppTrackingPixels\database\migrations\2026_05_08_000001_add_default_to_app_tracking_pixels_table.php
        (static function (): void {
            if (! Schema::hasTable('app_tracking_pixels') || Schema::hasColumn('app_tracking_pixels', 'is_default')) {
                return;
            }
        ...
        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000004_seed_short_link_plan_limits.php
        (static function (): void {
            if (! Schema::hasTable('admin_plans')) {
                return;
            }
    
            $plans = DB::table('admin_plans')->select(['id', 'slug', 'name', 'permissions'])->get();
    
            foreach ($plans as $plan) {
                $tier = $this->tier((string) ($plan->slug ?: $plan->name));
                $permissions = json_decode((string) $plan->permissions, true);
                ...
                DB::table('admin_plans')
                    ->where('id', $plan->id)
                    ->update([
                        'permissions' => json_encode(array_replace($permissions, $this->permissionsForTier($tier))),
                        'updated_at' => now(),
                    ]);
            }
        ...
        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000005_apply_short_link_limits_to_plans.php
        (static function (): void {
            if (! Schema::hasTable('plans')) {
                return;
            }
    
            $plans = DB::table('plans')->select(['id', 'slug', 'name', 'permissions'])->get();
        ...
        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000006_apply_short_link_ab_testing_to_plans.php
        (static function (): void {
            if (! Schema::hasTable('plans')) {
                return;
            }
            ...
            foreach ($plans as $plan) {
                ...
                $permissions = json_decode((string) $plan->permissions, true);
                $permissions = is_array($permissions) ? $permissions : [];
                $permissions['short_link_ab_testing'] = in_array($tier, ['growth', 'agency'], true);
    ...
    public function down(): void
    {
        ...
        (static function (): void {
            ...
            foreach ($plans as $plan) {
                ...
                unset($permissions['short_link_ab_testing']);
        ...
        (static function (): void {
            ...
            $keys = [
                'max_short_links',
                'max_short_link_clicks_monthly',
                'max_short_link_bulk_rows',
                'short_link_bulk_import',
                'short_link_analytics_retention_days',
                'short_link_advanced_rules',
                'short_link_ab_testing',
                'short_link_password_protection',
                'short_link_expiration_controls',
                'short_link_custom_alias',
                'short_link_api_access',
                'max_short_link_api_keys',
                'max_short_link_webhooks',
            ];
        ...
        (static function (): void {
            ...
            $plans = DB::table('admin_plans')->select(['id', 'permissions'])->get();
        ...
        (static function (): void {
            Schema::table('app_short_links', function (Blueprint $table): void {
                $table->dropColumn(['redirect_rules', 'moderation_status', 'moderation_note']);
            });
        ...
        (static function (): void {
            Schema::table('app_short_links', function (Blueprint $table): void {
                $table->dropColumn(['folder', 'campaign', 'tags']);
            });
        ...
        // Source: modules\AppShortLinkApi\database\migrations\2026_05_08_000001_create_short_link_api_tables.php
        (static function (): void {
            Schema::dropIfExists('app_short_link_webhooks');
            Schema::dropIfExists('app_short_link_api_keys');
        
        })();

        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000003_create_app_short_link_abuse_reports_table.php
        (static function (): void {
            Schema::dropIfExists('app_short_link_abuse_reports');
        ...
        // Source: modules\AppShortLinks\database\migrations\2026_05_08_000001_create_app_short_links_tables.php
        (static function (): void {
            Schema::dropIfExists('app_short_link_clicks');
            Schema::dropIfExists('app_short_links');
            ...
            DB::table('plans')
                ...
                ->chunkById(100, function ($plans): void {
                    foreach ($plans as $plan) {
                        ...
                        foreach (['max_qr_codes', 'max_qr_scans_monthly', 'max_dynamic_rules_per_qr', 'max_qr_bulk_rows'] as $key) {
                            if (array_key_exists($key, $permissions)) {
                                unset($permissions[$key]);
                                $changed = true;
                            }
        ...
        (static function (): void {
            ...
            Schema::dropIfExists('app_tracking_pixels');
            Schema::dropIfExists('app_utm_presets');
            Schema::dropIfExists('custom_domains');
            Schema::dropIfExists('app_brand_kits');
            Schema::dropIfExists('link_bio_qr_designs');
            Schema::dropIfExists('link_bio_short_links');
            Schema::dropIfExists('link_bio_events');
            Schema::dropIfExists('link_bio_pages');
            Schema::dropIfExists('link_bio_folders');
            Schema::dropIfExists('app_qr_scan_events');
            Schema::dropIfExists('app_qr_codes');
