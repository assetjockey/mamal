@php
    ...
    $parameters[] = [
        ...
        'type' => 0,
        'format' => 'string',
        'description' => __('The password for the report page.') . ' ' . __('Only works with :field field set to :value.', ['field' => '<code>privacy</code>', 'value' => '<code>2</code>'])
    ];
    ...
    if(!$type) {
        $parameters[] = [
            ...
            'type' => $type,
            'format' => 'integer',
            'description' => __('Update') . '. ' . __('Possible values are: :values.', [
                'values' => implode(', ', [
