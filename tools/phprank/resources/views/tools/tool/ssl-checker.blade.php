                ...
                <div class="list-group list-group-flush my-n3">
                    ...
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-lg-8 text-break">
                                {{ __(':date at :time (UTC :offset)', ['date' => $result->validFromDate()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d')), 'time' => $result->validFromDate()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('H:i:s')), 'offset' => \Carbon\CarbonTimeZone::create((Auth::user()->timezone ?? config('settings.timezone')))->toOffsetName()]) }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-lg-8 text-break">
                                {{ __(':date at :time (UTC :offset)', ['date' => $result->expirationDate()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d')), 'time' => $result->expirationDate()->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('H:i:s')), 'offset' => \Carbon\CarbonTimeZone::create((Auth::user()->timezone ?? config('settings.timezone')))->toOffsetName()]) }}
                            </div>
                        </div>
                    </div>
                </div>
