                ...
                <div class="row no-gutters">
                    <div class="col">
                        <div class="small text-muted">
                            {{ __(':number of :total reports used.', ['number' => shortenNumber($reportsCount), 'total' => (Auth::user()->active_plan->features->reports < 0 ? '∞' : shortenNumber(Auth::user()->active_plan->features->reports))]) }}
                        </div>
                    </div>
                </div>

                <div class="progress w-100 my-2 height-1.25">
                    <div class="progress-bar rounded" role="progressbar" style="width: {{ (Auth::user()->active_plan->features->reports == 0 ? 100 : (($reportsCount / Auth::user()->active_plan->features->reports) * 100)) }}%"></div>
                </div>
            </a>
