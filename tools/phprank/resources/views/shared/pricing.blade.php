                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="row m-n2">
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->reports == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                @if($plan->features->reports < 0)
                        ...
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->branded_reports == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                {{ __('Branded reports') }}
                            </div>
                        ...
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->white_label_reports == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                        ...
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->tools == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                {{ __('Tools') }}
                            </div>
