                                                                ...
                                                                <div class="pb-2">
                                                                    <ol class="mb-0">
                                                                        @foreach($value as $source)
                                                                            <li class="py-1 text-break"><a href="{{ $source }}" rel="nofollow noreferrer noopener" target="_blank">{{ $source ?: __('Empty') }}</a></li>
                                                                        @endforeach
                                                                    </ol>
                                                                </div>
                                                            </div>
            ...
            <div class="alert alert-secondary mb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-auto">
                        <a href="https://developer.mozilla.org/en-US/docs/Web/Security/Mixed_content" class="alert-link font-weight-medium d-flex align-items-center" target="_blank" rel="nofollow noreferrer noopener">Mozilla @include('icons.external', ['class' => 'fill-current width-3 height-3 ' . (__('lang_dir') == 'rtl' ? 'mr-1' : 'ml-1')])</a>
                    </div>

                    <div class="col-12 col-md-auto">
                        <a href="https://web.dev/what-is-mixed-content/" class="alert-link font-weight-medium d-flex align-items-center" target="_blank" rel="nofollow noreferrer noopener">Google @include('icons.external', ['class' => 'fill-current width-3 height-3 ' . (__('lang_dir') == 'rtl' ? 'mr-1' : 'ml-1')])</a>
                    </div>
                </div>
            </div>
        </div>
