                                                            ...
                                                            <div class="pb-2">
                                                                <ol class="mb-0">
                                                                    @foreach($details as $url)
                                                                        <li class="py-1"><a href="{{ $url }}" class="text-break" rel="nofollow noreferrer noopener" target="_blank">{{ $url }}</a></li>
                                                                    @endforeach
                                                                </ol>
                                                            </div>
                                                        </div>
            ...
            <div class="alert alert-secondary mb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-auto">
                        <a href="https://web.dev/external-anchors-use-rel-noopener/" class="alert-link font-weight-medium d-flex align-items-center" target="_blank" rel="nofollow noreferrer noopener">Google @include('icons.external', ['class' => 'fill-current width-3 height-3 ' . (__('lang_dir') == 'rtl' ? 'mr-1' : 'ml-1')])</a>
                    </div>
                </div>
            </div>
        </div>
