        ...
        if(!empty($_POST)) {
            ...
            switch($_POST['plan_id']) {
                ...
                case 'custom':
                    ...
                    /* AI models */
                    $_POST['images_api'] = input_clean($_POST['images_api'], 64);
                    $_POST['transcriptions_model'] = input_clean($_POST['transcriptions_model'], 64);
                    $_POST['chats_model'] = input_clean($_POST['chats_model'], 64);
                    $_POST['syntheses_model'] = input_clean($_POST['syntheses_model'], 64);

                    if(!\Altum\Plugin::is_active('newsletters')) {
                        /* Preserve hidden newsletter limits */
                        $_POST['newsletters_limit'] = $user->plan_settings->newsletters_limit ?? 0;
                        $_POST['newsletter_subscribers_limit'] = $user->plan_settings->newsletter_subscribers_limit ?? 0;
                        $_POST['newsletter_emails_per_month_limit'] = $user->plan_settings->newsletter_emails_per_month_limit ?? 0;
                        $_POST['force_newsletters_custom_smtp_is_enabled'] = $user->plan_settings->force_newsletters_custom_smtp_is_enabled ?? false;
                    }
                    ...
                    $settings = [
                        ...
                        'newsletters_limit' => (int) ($_POST['newsletters_limit'] ?? 0),
                        'newsletter_subscribers_limit' => (int) ($_POST['newsletter_subscribers_limit'] ?? 0),
                        'newsletter_emails_per_month_limit' => (int) ($_POST['newsletter_emails_per_month_limit'] ?? 0),
                        'force_newsletters_custom_smtp_is_enabled' => !empty($_POST['force_newsletters_custom_smtp_is_enabled']),
                        ...
                        'transcriptions_model'              => $_POST['transcriptions_model'],
                        ...
                        'syntheses_model'                   => $_POST['syntheses_model'],
