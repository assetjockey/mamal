...
class AdminTeamMembers extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['team_member_id', 'user_id', 'team_id', 'status'], ['user_email'], ['team_member_id', 'last_datetime', 'datetime', 'user_email'], allowed_datetime_fields: ['datetime', 'last_datetime']));
