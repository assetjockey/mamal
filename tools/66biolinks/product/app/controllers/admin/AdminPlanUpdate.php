    ...
    public function index() {
        ...
        $purifier_config->set('Cache.SerializerPath', UPLOADS_PATH . 'cache');
            ...
            if(!\Altum\Plugin::is_active('newsletters')) {
                ...
                $_POST['newsletters_limit'] = $plan->settings->newsletters_limit ?? 0;
                $_POST['newsletter_subscribers_limit'] = $plan->settings->newsletter_subscribers_limit ?? 0;
                $_POST['newsletter_emails_per_month_limit'] = $plan->settings->newsletter_emails_per_month_limit ?? 0;
                $_POST['force_newsletters_custom_smtp_is_enabled'] = $plan->settings->force_newsletters_custom_smtp_is_enabled ?? false;
            }
