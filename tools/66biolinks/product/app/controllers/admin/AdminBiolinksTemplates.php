...
class AdminBiolinksTemplates extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['biolink_template_id', 'is_enabled'], ['name'], ['biolink_template_id', 'datetime', 'last_datetime', 'name', 'order', 'total_usage'], allowed_datetime_fields: ['datetime', 'last_datetime']));
