...
class AdminBiolinksThemes extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['biolink_theme_id', 'is_enabled'], ['name'], ['biolink_theme_id', 'datetime', 'last_datetime', 'name', 'order'], allowed_datetime_fields: ['datetime', 'last_datetime']));
