...
class AdminQrCodes extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['qr_code_id', 'user_id', 'project_id', 'type'], ['name'], ['qr_code_id', 'type', 'name', 'datetime', 'last_datetime'], allowed_datetime_fields: ['datetime', 'last_datetime']));
