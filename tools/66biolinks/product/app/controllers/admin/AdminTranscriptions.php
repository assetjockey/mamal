...
class AdminTranscriptions extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['transcription_id', 'user_id', 'project_id', 'language', 'model'], ['name'], ['transcription_id', 'last_datetime', 'datetime', 'name', 'words'], allowed_datetime_fields: ['last_datetime', 'datetime']));
