...
class AdminBiolinksBlocks extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['biolink_block_id', 'is_enabled', 'user_id', 'link_id', 'type'], ['location_url'], ['biolink_block_id', 'order', 'last_datetime', 'datetime', 'location_url', 'clicks'], allowed_datetime_fields: ['last_datetime', 'datetime']));
