    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!\Altum\Plugin::is_active('newsletters')) {
                /* Set hidden newsletter limits */
                $_POST['newsletters_limit'] = 0;
                $_POST['newsletter_subscribers_limit'] = 0;
                $_POST['newsletter_emails_per_month_limit'] = 0;
                $_POST['force_newsletters_custom_smtp_is_enabled'] = false;
            }
