...
class AdminChats extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['chat_id', 'user_id'], ['name'], ['chat_id', 'last_datetime', 'datetime', 'name', 'total_messages', 'used_tokens'], allowed_datetime_fields: ['last_datetime', 'datetime']));
