...
class AdminSignatures extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['signature_id', 'user_id', 'project_id'], ['name'], ['signature_id', 'last_datetime', 'datetime', 'name'], allowed_datetime_fields: ['last_datetime', 'datetime']));
