...
class Transcriptions extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'project_id', 'language', 'model'], ['name'], ['transcription_id', 'last_datetime', 'datetime', 'name', 'words'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        /* Export handler */
        process_export_csv($transcriptions, ['transcription_id', 'project_id', 'user_id', 'name', 'input', 'content', 'words', 'language', 'model', 'api_response_time', 'datetime', 'last_datetime'], sprintf(l('transcriptions.title')));
        process_export_json($transcriptions, ['transcription_id', 'project_id', 'user_id', 'name', 'input', 'content', 'words', 'language', 'model', 'settings', 'api_response_time', 'datetime', 'last_datetime'], sprintf(l('transcriptions.title')));
