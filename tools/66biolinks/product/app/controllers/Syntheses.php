...
class Syntheses extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'project_id', 'format', 'voice_id', 'model'], ['name'], ['synthesis_id', 'last_datetime', 'datetime', 'name', 'characters'], allowed_datetime_fields: ['last_datetime', 'datetime']));
