...
class BiolinkBlockAjax extends Controller {
    ...
    private function create_biolink_digital_wallet() {
        ...
        $_POST['wallet_provider'] = isset($_POST['wallet_provider']) && in_array($_POST['wallet_provider'], ['google', 'apple', 'both']) ? $_POST['wallet_provider'] : 'google';
        ...
        if(
            ($_POST['wallet_provider'] == 'google' && !digital_wallets_is_google_wallet_ready())
            || ($_POST['wallet_provider'] == 'apple' && !digital_wallets_is_apple_wallet_ready())
            || ($_POST['wallet_provider'] == 'both' && (!digital_wallets_is_google_wallet_ready() || !digital_wallets_is_apple_wallet_ready()))
        ) {
            Response::json(l('global.error_message.basic'), 'error');
        }
        ...
        $settings = json_encode([
            ...
            'wallet_provider' => $_POST['wallet_provider'],
            'open_in_new_tab' => false,
