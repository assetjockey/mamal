...
class ChatCreate extends Controller {
    ...
    public function index() {
        ...
        /* Default values */
        $values = [
            'name' => isset($_POST['name']) ? $_POST['name'] : (isset($_GET['name']) ? $_GET['name'] : sprintf(l('chat_create.name_x'), \Altum\Date::get())),
            'chat_assistant_id' => isset($_GET['chat_assistant_id']) ? $_GET['chat_assistant_id'] : (isset($_POST['chat_assistant_id']) ? $_POST['chat_assistant_id'] : array_key_first($chats_assistants)),
        ];
