...
class SplashPages extends Controller {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            switch($_POST['type']) {
                case 'delete':
                    ...
                    (new \Altum\Models\SplashPages())->bulk_delete($_POST['selected'], $this->user->user_id);
    ...
    public function delete() {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            (new \Altum\Models\SplashPages())->delete($splash_page->splash_page_id, $this->user->user_id);
