    ...
    public function main() {
        ...
        if(settings()->content->pages_is_enabled) {
            ...
            foreach ($pages as $page) {
                ...
                $new_sitemap_urls[] = SITE_URL . $language_code . 'page/' . $page->url;
            }
            ...
            foreach ($pages_categories as $pages_category) {
                ...
                $new_sitemap_urls[] = SITE_URL . $language_code . 'pages/' . $pages_category->url;
            }
        }
        ...
        if(settings()->content->blog_is_enabled) {
            ...
            foreach ($blog_posts as $blog_post) {
                ...
                $new_sitemap_urls[] = SITE_URL . $language_code . 'blog/' . $blog_post->url;
            }
            ...
            foreach ($blog_posts_categories as $blog_posts_category) {
                ...
                $new_sitemap_urls[] = SITE_URL . $language_code . 'blog/category/' . $blog_posts_category->url;
            }
        }
