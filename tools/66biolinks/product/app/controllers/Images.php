...
class Images extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'project_id', 'size'], ['name'], ['image_id', 'last_datetime', 'datetime', 'name'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        /* Export handler */
        process_export_csv($images, ['image_id', 'project_id', 'user_id', 'name', 'input', 'image', 'image_url', 'size', 'datetime', 'last_datetime'], sprintf(l('images.title')));
        process_export_json($images, ['image_id', 'project_id', 'user_id', 'name', 'input', 'image', 'image_url', 'size', 'settings', 'datetime', 'last_datetime'], sprintf(l('images.title')));
