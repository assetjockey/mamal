...
class SynthesisUpdate extends Controller {
    ...
    public function index() {
        ...
        /* Legacy model data */
        if(!isset($synthesis->model) && isset($synthesis->voice_engine)) {
            $synthesis->model = $synthesis->voice_engine;
        }

        /* Languages */
        $ai_languages = require \Altum\Plugin::get('aix')->path . 'includes/ai_syntheses_openai_audio_languages.php';
