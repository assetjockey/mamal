...
if(\Altum\Plugin::is_active('newsletters') && settings()->links->biolinks_is_enabled && (settings()->newsletters->is_enabled ?? false)) {
    $features[] = 'newsletters_limit';
    $features[] = 'newsletter_subscribers_limit';
    $features[] = 'newsletter_emails_per_month_limit';
    $features[] = 'force_newsletters_custom_smtp_is_enabled';
}
...
if(
    ...
    && (
        ...
        || settings()->aix->syntheses_is_enabled
    )
) {
    /* Images */
    ...
    if(settings()->aix->syntheses_is_enabled) {
        $features[] = 'syntheses_per_month_limit';
        $features[] = 'synthesized_characters_per_month_limit';
    }
}
