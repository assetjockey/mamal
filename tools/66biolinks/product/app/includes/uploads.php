...
return [
    ...
    /* AIX */
    'images' => [
        'whitelisted_file_extensions' => ['png', 'webp', 'jpeg'],
        'path' => 'images/',
    ],

    'transcriptions' => [
        'whitelisted_file_extensions' => ['flac', 'mp3', 'mp4', 'mpeg', 'mpga', 'm4a', 'ogg', 'wav', 'webm'],
        'path' => 'cache/',
    ],
    ...
    'syntheses' => [
        'whitelisted_file_extensions' => ['mp3', 'opus', 'aac', 'flac', 'wav'],
        'path' => 'syntheses/',
    ],
    ...
    'apple_wallet_credentials' => [
        'whitelisted_file_extensions' => ['p12', 'pfx', 'cer', 'pem'],
        'path' => 'main/',
    ],
];
