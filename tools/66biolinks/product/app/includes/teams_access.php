...
if(settings()->links->biolinks_is_enabled) {
    ...
    if(\Altum\Plugin::is_active('newsletters') && settings()->links->biolinks_is_enabled && (settings()->newsletters->is_enabled ?? false)) {
        $access['create']['create.newsletters'] = l('newsletters.title');
        $access['update']['update.newsletters'] = l('newsletters.title');
        $access['delete']['delete.newsletters'] = l('newsletters.title');

        $access['create']['create.newsletter_subscribers'] = l('newsletter_subscribers.title');
        $access['update']['update.newsletter_subscribers'] = l('newsletter_subscribers.title');
        $access['delete']['delete.newsletter_subscribers'] = l('newsletter_subscribers.title');
    }
}
