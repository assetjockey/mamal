    ...
    public static $routes = [
        ...
        '' => [
            ...
            'newsletter-subscribers' => [
                'controller' => 'NewsletterSubscribers',
                'settings' => [
                    'wrapper' => 'app_wrapper',
                    'ads' => true,
                ]
            ...
            'newsletter-subscriber-create' => [
                'controller' => 'NewsletterSubscriberCreate',
                'settings' => [
                    'wrapper' => 'app_wrapper',
                    'ads' => true,
                ]
            ...
            'newsletter-subscribers-import' => [
                'controller' => 'NewsletterSubscribersImport',
                'settings' => [
                    'wrapper' => 'app_wrapper',
                    'ads' => true,
                ]
        ...
        'admin' => [
            ...
            'newsletters' => [
                'controller' => 'AdminNewsletters',
            ],

            'newsletter-subscribers' => [
                'controller' => 'AdminNewsletterSubscribers',
            ],
