...
return [
    ...
    'global.emails.is_newsletter' => 'You are receiving this email because you subscribed to %s newsletters. You can %sUnsubscribe here%s at any point in time.',
    ...
    'global.plan_settings.newsletters_limit' => '<strong>%s</strong> newsletters',
    'global.plan_settings.newsletter_subscribers_limit' => '<strong>%s</strong> newsletter subscribers',
    'global.plan_settings.newsletter_emails_per_month_limit' => '<strong>%s</strong> newsletter emails <span class="small text-muted">/ month</span>',
    'global.plan_settings.no_forced_newsletters_custom_smtp' => 'No forced newsletter SMTP',
    'global.plan_settings.no_forced_newsletters_custom_smtp_help' => 'Use the platform SMTP for newsletters when no custom SMTP is configured.',
    ...
    'global.plan_settings.syntheses_per_month_limit' => '<strong>%s</strong> AI syntheses <span class="small text-muted">/ month</span>',
    'global.plan_settings.synthesized_characters_per_month_limit' => '<strong>%s</strong> AI synthesized characters <span class="small text-muted">/ month</span>',
    ...
    'account_preferences.newsletters_smtp' => 'Newsletters SMTP',
    'account_preferences.newsletters_smtp_is_enabled' => 'Enable custom SMTP for newsletters',
    'account_preferences.newsletters_smtp_is_enabled_help' => 'When enabled, your newsletters will be sent with these SMTP details instead of the platform SMTP.',
    'account_preferences.newsletters_smtp_host' => 'SMTP host',
    'account_preferences.newsletters_smtp_port' => 'SMTP port',
    'account_preferences.newsletters_smtp_encryption' => 'SMTP encryption',
    'account_preferences.newsletters_smtp_auth' => 'SMTP authentication',
    'account_preferences.newsletters_smtp_username' => 'SMTP username',
    'account_preferences.newsletters_smtp_password' => 'SMTP password',
    'account_preferences.newsletters_smtp_from' => 'From email',
    'account_preferences.newsletters_smtp_from_name' => 'From name',
    'account_preferences.newsletters_smtp_reply_to' => 'Reply-to email',
    'account_preferences.newsletters_smtp_reply_to_name' => 'Reply-to name',
    ...
    'newsletters.breadcrumb' => 'Newsletters',
    'newsletters.header' => 'Newsletters',
    'newsletters.subheader' => 'Send emails to subscribers collected from your biolink forms.',
    'newsletters.no_data' => 'No newsletters created yet',
    'newsletters.create' => 'Create newsletter',
    'newsletters.newsletter' => 'Newsletter',
    'newsletters.name_help' => 'Name used for internal purposes only, it is not public in the email newsletter.',
    'newsletters.subject' => 'Subject',
    'newsletters.subject_help' => 'The title of the email. It is recommended you do not use more than 9 words / 60 characters.',
    'newsletters.content' => 'Content',
    'newsletters.segment' => 'Segment',
    'newsletters.segment_help' => 'Select the group of subscribers that you want to send the email to.',
    'newsletters.segment.all' => 'All subscribers',
    'newsletters.segment.project' => 'Project subscribers',
    'newsletters.segment.link' => 'Biolink subscribers',
    'newsletters.segment.biolink_block' => 'Block subscribers',
    'newsletters.segment.custom' => 'Custom',
    'newsletters.subscribers_ids' => 'Subscriber IDs',
    'newsletters.subscribers_ids_placeholder' => '1,2,3',
    'newsletters.subscribers_ids_help' => 'Comma separated values.',
    'newsletters.status.draft' => 'Draft',
    'newsletters.status.processing' => 'Processing',
    'newsletters.status.sent' => 'Sent',
    'newsletters.total_emails' => 'Total emails',
    'newsletters.sent_emails' => 'Sent emails',
    'newsletters.views' => 'Views',
    'newsletters.clicks' => 'Clicks',
    'newsletters.latest_views' => 'Latest views',
    'newsletters.last_sent_email_datetime' => 'Last sent email %s',

    'newsletter_create.breadcrumb' => 'Create newsletter',
    'newsletter_create.title' => 'Create newsletter',
    'newsletter_create.menu' => 'Create newsletter',
    'newsletter_create.header' => 'Create a new newsletter',
    'newsletter_create.content_placeholder' => 'Your email content goes here..',
    'newsletter_create.info1' => 'You must first make sure your SMTP works properly and that your server is capable to handle the processing.',
    'newsletter_create.info2' => 'Sending bulk emails puts your server under load and takes time to process.',
    'newsletter_create.save_draft' => 'Save draft',
    'newsletter_create.send_preview' => 'Send preview',
    'newsletter_create.send_newsletter' => 'Send newsletter',
    'newsletter_create.success_message.preview' => 'Preview email sent to %s',
    'newsletter_create.success_message.save' => '%s newsletter was saved. You can come back later and send it.',
    'newsletter_create.success_message.send' => '%s newsletter will start to be processed.',
    'newsletter_create.error_message.custom_smtp_required' => 'You must add your SMTP details before sending newsletters. You can add them from your %saccount preferences%s.',

    'newsletter_update.breadcrumb' => 'Update newsletter',
    'newsletter_update.title' => 'Update newsletter',
    'newsletter_update.menu' => 'Update newsletter',
    'newsletter_update.header' => 'Update newsletter',
    'newsletter_update.error_message.processing' => 'You can not update a newsletter while it is processing.',

    'newsletter_view.breadcrumb' => 'View newsletter',
    'newsletter_view.title' => 'View newsletter',
    'newsletter_view.menu' => 'View newsletter',
    'newsletter_view.header' => 'View newsletter',

    'newsletter_subscribers.title' => 'Newsletter subscribers',
    'newsletter_subscribers.menu' => 'Newsletter subscribers',
    'newsletter_subscribers.breadcrumb' => 'Newsletter subscribers',
    'newsletter_subscribers.header' => 'Newsletter subscribers',
    'newsletter_subscribers.subheader' => 'All email subscribers collected from your biolink forms.',
    'newsletter_subscribers.no_data' => 'No newsletter subscribers yet',
    'newsletter_subscribers.create' => 'Add subscriber',
    'newsletter_subscribers.import' => 'Import subscribers',
    'newsletter_subscribers.subscriber' => 'Subscriber',
    'newsletter_subscribers.source' => 'Source',
    'newsletter_subscribers.source.manual' => 'Manual import',
    'newsletter_subscribers.status.subscribed' => 'Subscribed',
    'newsletter_subscribers.status.unsubscribed' => 'Unsubscribed',
    'newsletter_subscribers.subscribe' => 'Subscribe',
    'newsletter_subscribers.unsubscribe' => 'Unsubscribe',
    'newsletter_subscriber_update_status_modal.subheader' => 'Confirm that you want to update the status of this subscriber.',
    'newsletter_subscribers.unsubscribed_datetime' => 'Unsubscribed date',
    'newsletter_subscriber_create.title' => 'Add subscriber',
    'newsletter_subscriber_create.breadcrumb' => 'Add subscriber',
    'newsletter_subscriber_create.header' => 'Add subscriber',
    'newsletter_subscriber_create.status_help' => 'Existing subscribers with the same email will be updated.',
    'newsletter_subscribers_import.title' => 'Import subscribers',
    'newsletter_subscribers_import.breadcrumb' => 'Import subscribers',
    'newsletter_subscribers_import.header' => 'Import subscribers',

    'newsletter_unsubscribe.title' => 'Unsubscribe',
    'newsletter_unsubscribe.header' => 'Unsubscribe',
    'newsletter_unsubscribe.subheader' => 'Confirm that you want to unsubscribe from this newsletter.',
    'newsletter_unsubscribe.success.title' => 'Unsubscribed',
    'newsletter_unsubscribe.success.header' => 'You have been unsubscribed',
    'newsletter_unsubscribe.success.subheader' => 'You will no longer receive these newsletters.',
    ...
    'link.static.ai_improve' => 'Improve with AI',
    'link.static.ai_improve_placeholder' => 'Make the hero section more premium, improve the copy, and add a pricing section...',
    'link.static.ai_improve_submit' => 'Change with AI',
    'link.static.ai_restore_submit' => 'Restore previous version',
    'link.static.ai_restore_success' => 'Previous version restored.',
    'link.static.ai_restore_help' => 'Restore the version saved before the latest applied AI changes.',
    'link.static.ai_redo_submit' => 'Redo AI improvements',
    'link.static.ai_redo_success' => 'AI improvements restored.',
    'link.static.ai_redo_help' => 'Restore the AI-improved version saved before the latest restore.',
    'link.static.ai_restore_no_backup' => 'No previous version is available to restore.',
    'link.static.ai_improve_no_files' => 'No editable static site files were found.',
    'link.static.ai_improve_no_changes' => 'No changes were generated.',
    'link.static.ai_improve_site_too_large' => 'The static site is too large to process with AI.',
    ...
    'images.quality_help' => 'Higher quality can improve the result, but it may take longer to generate.',
    'images.quality.auto' => 'Auto',
    'images.quality.low' => 'Low',
    'images.quality.medium' => 'Medium',
    'images.quality.high' => 'High',
    'images.quality.standard' => 'Standard',
    'images.quality.hd' => 'HD',
    'images.output_format' => 'Output format',
    'images.output_format_help' => 'The file format used for the generated image.',
    'images.background' => 'Background',
    'images.background_help' => 'Choose how the generated image background should be handled.',
    'images.background.auto' => 'Auto',
    'images.background.transparent' => 'Transparent',
    'images.background.opaque' => 'Opaque',
    ...
    'images.error_message.flagged' => 'The keywords/text you\'ve used been flagged as they are breaking the terms of use.',
    'images.error_message.timed_out' => 'Due to breaking the terms of use, you are timed out for a few minutes.',
    'images.error_message.openai_api_key' => 'The OpenAI API key is missing.',
    'images.error_message.invalid_response' => 'The image generation API returned an invalid response.',
    'images.error_message.transparent_background' => 'Transparent backgrounds require PNG or WEBP output.',
    ...
    'transcriptions.input' => 'Prompt / context',
    ...
    'transcriptions.input_help' => 'Add context that helps the AI transcribe the audio. You can leave this field empty.',
    ...
    'transcriptions.error_message.openai_api_key' => 'The OpenAI API key is missing.',
    'transcriptions.error_message.invalid_response' => 'The transcription API returned an invalid response.',
    ...
    'chats.error_message.flagged' => 'The keywords/text you\'ve used been flagged as they are breaking the terms of use.',
    'chats.error_message.timed_out' => 'Due to breaking the terms of use, you are timed out for a few minutes.',
    'chats.error_message.openai_api_key' => 'The OpenAI API key is missing.',
    'chats.error_message.invalid_response' => 'The chat API returned an invalid response.',
    'chats.error_message.assistant_missing' => 'The chat assistant is no longer available.',
    ...
    'syntheses.instructions' => 'Voice instructions',
    'syntheses.instructions_placeholder' => 'Speak in a calm, confident tone with clear pacing.',
    'syntheses.instructions_help' => 'Add voice direction for tone, pacing, accent, emotion, or delivery style.',
    'syntheses.speed' => 'Speed',
    'syntheses.speed_help' => 'Choose a speed between 0.25 and 4. The default is 1.',
    ...
    'syntheses.error_message.openai_api_key' => 'The OpenAI API key is missing.',
    'syntheses.error_message.invalid_response' => 'The text to speech API returned an invalid response.',
