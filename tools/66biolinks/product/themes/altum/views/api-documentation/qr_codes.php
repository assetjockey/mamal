                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = url</span>') ?>. <?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">url_dynamic = 0</span> / <span class="badge badge-light">url_dynamic_existing_link = 0</span>') ?></td>
                            </tr>
                            <tr>
                                <td>phone</td>
                                <td>
