                                ...
                                <div class="d-flex align-items-center">
                                    <a href="<?= url('digital-wallet-update/' . $row->digital_wallet_id) ?>">
										<?php if($row->settings->logo): ?>
                                            <img src="<?= \Altum\Uploads::get_full_url('digital_wallets') . $row->settings->logo ?>" class="table-avatar rounded-circle mr-3" alt="<?= $row->name ?>" />
										<?php else: ?>
                                            <div class="table-avatar rounded-circle mr-3 d-flex align-items-center justify-content-center bg-gray-100">
