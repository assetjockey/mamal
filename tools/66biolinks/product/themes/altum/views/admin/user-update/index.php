        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <?php if(\Altum\Plugin::is_active('newsletters')): ?>
                    <div class="form-group">
                        <label for="newsletters_limit"><?= l('admin_plans.plan.newsletters_limit') ?></label>
                        <input type="number" id="newsletters_limit" name="newsletters_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->newsletters_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group">
                        <label for="newsletter_subscribers_limit"><?= l('admin_plans.plan.newsletter_subscribers_limit') ?></label>
                        <input type="number" id="newsletter_subscribers_limit" name="newsletter_subscribers_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->newsletter_subscribers_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group">
                        <label for="newsletter_emails_per_month_limit"><?= l('admin_plans.plan.newsletter_emails_per_month_limit') ?> <small class="form-text text-muted"><?= l('admin_plans.plan.per_month') ?></small></label>
                        <input type="number" id="newsletter_emails_per_month_limit" name="newsletter_emails_per_month_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->newsletter_emails_per_month_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group custom-control custom-switch">
                        <input id="force_newsletters_custom_smtp_is_enabled" name="force_newsletters_custom_smtp_is_enabled" type="checkbox" class="custom-control-input" <?= ($data->user->plan_settings->force_newsletters_custom_smtp_is_enabled ?? false) ? 'checked="checked"' : null ?>>
                        <label class="custom-control-label" for="force_newsletters_custom_smtp_is_enabled"><?= l('admin_plans.plan.force_newsletters_custom_smtp_is_enabled') ?></label>
                        <div><small class="form-text text-muted"><?= l('admin_plans.plan.force_newsletters_custom_smtp_is_enabled_help') ?></small></div>
                    </div>
                <?php endif ?>
                ...
                <div class="form-group">
                    <label for="ai_static_prompts_characters_limit"><?= l('admin_plans.plan.ai_static_prompts_characters_limit') ?></label>
                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="images_api" name="images_api" class="form-control" value="<?= $data->user->plan_settings->images_api ?>" />
                    ...
                    <div class="form-group">
                        <label for="transcriptions_model"><?= l('admin_plans.plan.transcriptions_model') ?></label>
                        <input type="text" id="transcriptions_model" name="transcriptions_model" class="form-control" value="<?= $data->user->plan_settings->transcriptions_model ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.transcriptions_model_help') ?></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="chats_model" name="chats_model" class="form-control" value="<?= $data->user->plan_settings->chats_model ?>" />
                    ...
                    <div class="form-group">
                        <label for="chat_messages_per_chat_limit"><?= l('admin_plans.plan.chat_messages_per_chat_limit') ?></label>
                    ...
                    <div class="form-group">
                        <label for="syntheses_model"><?= l('admin_plans.plan.syntheses_model') ?></label>
                        <input type="text" id="syntheses_model" name="syntheses_model" class="form-control" value="<?= $data->user->plan_settings->syntheses_model ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.syntheses_model_help') ?></small>
                    </div>
