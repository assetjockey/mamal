    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <?php if(\Altum\Plugin::is_active('newsletters')): ?>
                <li class="<?= in_array(\Altum\Router::$controller, ['AdminNewsletters']) ? 'active' : null ?>">
                    <a class="nav-link text-truncate" href="<?= url('admin/newsletters') ?>">
                        <i class="fas fa-fw fa-sm fa-envelope-open-text mr-2"></i> <?= l('admin_newsletters.menu') ?>
                    </a>
                </li>

                <li class="<?= in_array(\Altum\Router::$controller, ['AdminNewsletterSubscribers']) ? 'active' : null ?>">
                    <a class="nav-link text-truncate" href="<?= url('admin/newsletter-subscribers') ?>">
                        <i class="fas fa-fw fa-sm fa-users mr-2"></i> <?= l('admin_newsletter_subscribers.menu') ?>
                    </a>
                </li>
            <?php endif ?>
