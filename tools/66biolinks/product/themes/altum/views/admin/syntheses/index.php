...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_model" class="small"><?= l('syntheses.model') ?></label>
        ...
        <div class="ml-3">
            <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->syntheses) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
        ...
        <table class="table table-custom">
            ...
            <?php foreach($data->syntheses as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <span class="badge badge-light"><?= $row->model ? $row->model : l('global.na') ?></span>
                    </td>
