            ...
            <div>
                ...
                <?php if(\Altum\Plugin::is_active('newsletters')): ?>
                    <div class="form-group">
                        ...
                        <input type="number" id="newsletters_limit" name="newsletters_limit" min="-1" class="form-control" value="0" required="required" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group">
                        <label for="newsletter_subscribers_limit"><?= l('admin_plans.plan.newsletter_subscribers_limit') ?></label>
                        <input type="number" id="newsletter_subscribers_limit" name="newsletter_subscribers_limit" min="-1" class="form-control" value="0" required="required" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="newsletter_emails_per_month_limit" name="newsletter_emails_per_month_limit" min="-1" class="form-control" value="0" required="required" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group custom-control custom-switch">
                        <input id="force_newsletters_custom_smtp_is_enabled" name="force_newsletters_custom_smtp_is_enabled" type="checkbox" class="custom-control-input">
                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="images_api" name="images_api" class="form-control" value="gpt-image-1" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="transcriptions_model" name="transcriptions_model" class="form-control" value="gpt-4o-mini-transcribe" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="chats_model" name="chats_model" class="form-control" value="gpt-5-mini" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="syntheses_model" name="syntheses_model" class="form-control" value="gpt-4o-mini-tts" />
