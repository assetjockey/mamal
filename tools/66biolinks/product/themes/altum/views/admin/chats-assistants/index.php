                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                ...
                                <option value="total_usage" <?= $data->filters->order_by == 'total_usage' ? 'selected="selected"' : null ?>><?= l('admin_chats_assistants.main.total_usage') ?></option>
                            </select>
                        </div>
...
<?php if(!empty($data->chats_assistants)): ?>
