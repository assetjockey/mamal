...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_model" class="small"><?= l('transcriptions.model') ?></label>
                            <input type="text" name="model" id="filters_model" class="form-control form-control-sm" value="<?= isset($data->filters->filters['model']) ? $data->filters->filters['model'] : null ?>" />
                        </div>
        ...
        <div class="ml-3">
            <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->transcriptions) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
...
<?php if(!empty($data->transcriptions)): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            <?php if($row->model): ?>
                            <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= l('transcriptions.model') . '<br />' . $row->model ?>">
