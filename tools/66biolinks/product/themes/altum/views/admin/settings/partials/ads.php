...
<div>
    ...
    <div class="form-group">
        <label for="ad_blocker_detector_delay"><i class="fas fa-fw fa-sm fa-clock text-muted mr-1"></i> <?= l('admin_settings.ads.ad_blocker_detector_delay') ?></label>
    ...
    <div class="form-group">
        <label for="header"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.header') ?></label>
        <textarea id="header" name="header" class="form-control"><?= settings()->ads->header ?></textarea>
    </div>

    <div class="form-group">
        <label for="footer"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.footer') ?></label>
        <textarea id="footer" name="footer" class="form-control"><?= settings()->ads->footer ?></textarea>
    </div>

    <div class="form-group">
        <label for="header_biolink"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.header_biolink') ?></label>
        <textarea id="header_biolink" name="header_biolink" class="form-control"><?= settings()->ads->header_biolink ?></textarea>
    </div>

    <div class="form-group">
        <label for="footer_biolink"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.footer_biolink') ?></label>
        <textarea id="footer_biolink" name="footer_biolink" class="form-control"><?= settings()->ads->footer_biolink ?></textarea>
    </div>

    <div class="form-group">
        <label for="header_splash"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.header_splash') ?></label>
        <textarea id="header_splash" name="header_splash" class="form-control"><?= settings()->ads->header_splash ?></textarea>
    </div>

    <div class="form-group">
        <label for="footer_splash"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.ads.footer_splash') ?></label>
