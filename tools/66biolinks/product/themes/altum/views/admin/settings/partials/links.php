...
<div id="links">
    ...
    <div class="collapse" data-parent="#links" id="biolinks_container">
        ...
        <div class="form-group">
            <label for="example_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.links.example_url') ?></label>
        ...
        <div class="form-group">
            <label for="biolinks_default_active_tab"><i class="fas fa-fw fa-sm fa-sliders-h text-muted mr-1"></i> <?= l('admin_settings.links.biolinks_default_active_tab') ?></label>
        ...
        <div class="form-group">
            <label for="default_biolink_theme_id"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('admin_settings.links.default_biolink_theme_id') ?></label>
        ...
        <div class="form-group">
            <label for="default_biolink_template_id"><i class="fas fa-fw fa-sm fa-layer-group text-muted mr-1"></i> <?= l('admin_settings.links.default_biolink_template_id') ?></label>
        ...
        <div class="form-group">
            <label for="biolinks_new_blocks_position"><i class="fas fa-fw fa-sm fa-sort text-muted mr-1"></i> <?= l('admin_settings.links.biolinks_new_blocks_position') ?></label>
        ...
        <div class="form-group">
            <label for="branding"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('admin_settings.links.branding') ?></label>
    ...
    <div class="collapse" data-parent="#links" id="links_container">
        <div class="form-group">
            <label for="random_url_length"><i class="fas fa-fw fa-sm fa-text-width text-muted mr-1"></i> <?= l('admin_settings.links.random_url_length') ?></label>
        ...
        <div class="form-group">
            <label for="claim_url_type"><i class="fas fa-fw fa-sm fa-sliders-h text-muted mr-1"></i> <?= l('admin_settings.links.claim_url_type') ?></label>
        ...
        <div class="form-group">
            <label for="blacklisted_domains"><i class="fas fa-fw fa-sm fa-ban text-muted mr-1"></i> <?= l('admin_settings.links.blacklisted_domains') ?></label>
        ...
        <div class="form-group">
            <label for="blacklisted_keywords"><i class="fas fa-fw fa-sm fa-ban text-muted mr-1"></i> <?= l('admin_settings.links.blacklisted_keywords') ?></label>
        ...
        <div class="form-group">
            <label for="projects_email_reports_is_enabled"><i class="fas fa-fw fa-sm fa-fire text-muted mr-1"></i> <?= l('admin_settings.links.projects_email_reports_is_enabled') ?></label>
            <select id="projects_email_reports_is_enabled" name="projects_email_reports_is_enabled" class="custom-select">
                <option value="0" <?= !(settings()->links->projects_email_reports_is_enabled ?? false) ? 'selected="selected"' : null ?>><?= l('global.disabled') ?></option>
                <option value="weekly" <?= (settings()->links->projects_email_reports_is_enabled ?? false) == 'weekly' ? 'selected="selected"' : null ?>><?= l('admin_settings.links.projects_email_reports_is_enabled_weekly') ?></option>
                <option value="monthly" <?= (settings()->links->projects_email_reports_is_enabled ?? false) == 'monthly' ? 'selected="selected"' : null ?>><?= l('admin_settings.links.projects_email_reports_is_enabled_monthly') ?></option>
            </select>
            <small class="form-text text-muted"><?= l('admin_settings.links.projects_email_reports_is_enabled_help') ?></small>
        </div>
    </div>
    ...
    <div class="collapse" data-parent="#links" id="splash_pages_container">
        ...
        <div class="form-group">
            <label for="splash_page_link_unlock_seconds"><i class="fas fa-fw fa-sm fa-clock text-muted mr-1"></i> <?= l('admin_settings.links.splash_page_link_unlock_seconds') ?></label>
    ...
    <div class="collapse" data-parent="#links" id="directory_container">
        ...
        <div class="form-group">
            <label for="directory_access"><i class="fas fa-fw fa-sm fa-users text-muted mr-1"></i> <?= l('admin_settings.links.directory_access') ?></label>
        ...
        <div class="form-group">
            <label for="directory_display"><i class="fas fa-fw fa-sm fa-eye text-muted mr-1"></i> <?= l('admin_settings.links.directory_display') ?></label>
    ...
    <div class="collapse" data-parent="#links" id="domains_container">
        ...
        <div class="form-group">
            <label for="domains_custom_main_ip"><i class="fas fa-fw fa-sm fa-server text-muted mr-1"></i> <?= l('admin_settings.links.domains_custom_main_ip') ?></label>
    ...
    <div class="collapse" data-parent="#links" id="file_size_limits_container">
        <?php foreach(['avatar', 'background', 'favicon', 'seo_image', 'thumbnail_image', 'image', 'audio', 'video', 'file', 'product_file', 'static', 'pwa_icon', 'branded_button_icon', 'offline_payment_proof'] as $key): ?>
            <div class="form-group">
                <label for="<?= $key . '_size_limit' ?>"><i class="fas fa-fw fa-sm fa-file text-muted mr-1"></i> <?= l('admin_settings.links.' . $key . '_size_limit') ?></label>
                <div class="input-group">
    ...
    <div class="collapse" data-parent="#links" id="others_container">
        ...
        <div class="form-group">
            <label for="google_safe_browsing_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.links.google_safe_browsing_api_key') ?></label>
        ...
        <div class="form-group">
            <label for="google_static_maps_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.links.google_static_maps_api_key') ?></label>
        ...
        <div class="form-group">
            <label for="google_geocoding_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.links.google_geocoding_api_key') ?></label>
        ...
        <div class="form-group">
            <label for="open_meteo_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.links.open_meteo_api_key') ?></label>
    ...
    <div class="collapse" data-parent="#links" id="sixsixpusher_container">
        ...
        <div class="form-group">
            <label for="sixsixpusher_service_worker_file_name"><i class="fas fa-fw fa-sm fa-file-code text-muted mr-1"></i> <?= l('admin_settings.links.sixsixpusher_service_worker_file_name') ?></label>
            <div class="input-group">
