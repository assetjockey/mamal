...
<div>
    ...
    <div class="form-group">
        <label for="client_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.microsoft.client_id') ?></label>
        <input id="client_id" type="text" name="client_id" class="form-control" value="<?= settings()->microsoft->client_id ?>" />
    </div>

    <div class="form-group">
        <label for="client_secret"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.microsoft.client_secret') ?></label>
