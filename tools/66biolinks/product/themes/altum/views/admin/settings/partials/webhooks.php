...
<div id="webhooks">
    ...
    <div class="collapse" data-parent="#webhooks" id="biolink_blocks_container">
        <div class="form-group">
            <label for="biolink_block_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.biolink_block_new') ?></label>
        ...
        <div class="form-group">
            <label for="biolink_block_update"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.biolink_block_update') ?></label>
