        ...
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <optgroup label="<?= l('admin_settings.plugins') ?>">
                    ...
                    <option value="<?= url('admin/settings/newsletters') ?>" <?= $data->method == 'newsletters' ? 'selected="selected"' : null ?>>📰 <?= l('admin_settings.newsletters.tab') ?></option>
                </optgroup>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= in_array($data->method, ['facebook', 'google', 'twitter', 'discord', 'linkedin', 'microsoft', 'apple', 'github']) ? 'active' : null ?>" data-toggle="collapse" href="#social_logins_collapse">
                        <i class="fas fa-fw fa-sm fa-share-alt mr-2"></i> <?= l('admin_settings.social_logins') ?> <i class="fas fa-fw fa-sm fa-caret-down"></i>
                    </a>
                    <div class="mt-1 bg-gray-200 rounded collapse <?= in_array($data->method, ['facebook', 'google', 'twitter', 'discord', 'linkedin', 'microsoft', 'apple', 'github']) ? 'show' : null ?>" id="social_logins_collapse">
                        <div>
                            ...
                            <a class="nav-link <?= $data->method == 'apple' ? 'active' : null ?>" href="<?= url('admin/settings/apple') ?>"><i class="fab fa-fw fa-sm fa-apple mr-2"></i> <?= l('admin_settings.apple.tab') ?></a>
                            <a class="nav-link <?= $data->method == 'github' ? 'active' : null ?>" href="<?= url('admin/settings/github') ?>"><i class="fab fa-fw fa-sm fa-github mr-2"></i> <?= l('admin_settings.github.tab') ?></a>
                        </div>
                    </div>
                    ...
                    <a class="nav-link <?= $data->method == 'newsletters' ? 'active' : null ?>" href="<?= url('admin/settings/newsletters') ?>"><i class="fas fa-fw fa-sm fa-envelope-open-text mr-2"></i> <?= l('admin_settings.newsletters.tab') ?></a>
