            ...
            <div>
                ...
                <?php if(\Altum\Plugin::is_active('newsletters')): ?>
                    <div class="form-group">
                        ...
                        <input type="number" id="newsletters_limit" name="newsletters_limit" min="-1" class="form-control" value="<?= $data->plan->settings->newsletters_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group">
                        <label for="newsletter_subscribers_limit"><?= l('admin_plans.plan.newsletter_subscribers_limit') ?></label>
                        <input type="number" id="newsletter_subscribers_limit" name="newsletter_subscribers_limit" min="-1" class="form-control" value="<?= $data->plan->settings->newsletter_subscribers_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="newsletter_emails_per_month_limit" name="newsletter_emails_per_month_limit" min="-1" class="form-control" value="<?= $data->plan->settings->newsletter_emails_per_month_limit ?? 0 ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>

                    <div class="form-group custom-control custom-switch">
                        <input id="force_newsletters_custom_smtp_is_enabled" name="force_newsletters_custom_smtp_is_enabled" type="checkbox" class="custom-control-input" <?= ($data->plan->settings->force_newsletters_custom_smtp_is_enabled ?? false) ? 'checked="checked"' : null ?>>
                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="images_api" name="images_api" class="form-control" value="<?= $data->plan->settings->images_api ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="transcriptions_model" name="transcriptions_model" class="form-control" value="<?= $data->plan->settings->transcriptions_model ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="chats_model" name="chats_model" class="form-control" value="<?= $data->plan->settings->chats_model ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="syntheses_model" name="syntheses_model" class="form-control" value="<?= $data->plan->settings->syntheses_model ?>" />
