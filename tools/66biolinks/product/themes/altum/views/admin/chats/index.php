...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
        ...
        <div class="ml-3">
            <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->chats) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
