...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex flex-wrap gap-3 d-print-none">
            ...
            <div>
                <button id="bulk_enable" type="button" class="btn btn-light <?= !empty($data->splash_pages) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="<?= url('splash-page-update/' . $row->splash_page_id) ?>">
                                        <?php if($row->settings->logo): ?>
                                            <img src="<?= \Altum\Uploads::get_full_url('splash_pages') . $row->settings->logo ?>" class="table-avatar rounded-circle mr-3" alt="<?= $row->name ?>" />
                                        <?php else: ?>
                                            <div class="table-avatar rounded-circle mr-3"></div>
                                        <?php endif ?>
                                    </a>
