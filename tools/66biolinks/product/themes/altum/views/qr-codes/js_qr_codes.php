...
<script>
    ...
    let url_dynamic_url = document.querySelector('#url') ? document.querySelector('#url').value : null;

    if(document.querySelector('#url') && document.querySelector('#url_dynamic') && document.querySelector('#url_dynamic').checked && document.querySelector('#url_dynamic_existing_link') && document.querySelector('#url_dynamic_existing_link').checked && document.querySelector('#link_id')) {
        let link_id_element = document.querySelector('#link_id');
        if(link_id_element.options.length) {
            url_dynamic_url = link_id_element.options[link_id_element.selectedIndex].getAttribute('data-location-url') || url_dynamic_url;
        }
    }
    ...
    let url_dynamic_handler = () => {
        ...
        if(url_dynamic) {
            document.querySelector('#url_dynamic_existing_link') && document.querySelector('#url_dynamic_existing_link').removeAttribute('disabled');
            document.querySelector('[data-url-dynamic-existing-link]') && document.querySelector('[data-url-dynamic-existing-link]').classList.remove('d-none');
            ...
            link_id_element.setAttribute('disabled', 'disabled');
            document.querySelector('[data-link-id]').classList.add('d-none');
            document.querySelector('#url_dynamic_existing_link') && document.querySelector('#url_dynamic_existing_link').setAttribute('disabled', 'disabled');
            document.querySelector('[data-url-dynamic-existing-link]') && document.querySelector('[data-url-dynamic-existing-link]').classList.add('d-none');
            url_element.setAttribute('required', 'required');
            document.querySelector('[data-url]').classList.remove('d-none');
