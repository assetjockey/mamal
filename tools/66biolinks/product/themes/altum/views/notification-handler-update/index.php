    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group" data-type="ntfy">
                    <label for="ntfy"><i class="fas fa-fw fa-sm fa-bell text-muted mr-1"></i> <?= l('notification_handlers.ntfy') ?></label>
                    <input type="url" id="ntfy" name="ntfy" class="form-control" value="<?= isset($data->notification_handler->settings->ntfy) ? $data->notification_handler->settings->ntfy : '' ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" required="required" />
                    <small class="text-muted"><?= l('notification_handlers.ntfy_help') ?></small>
                </div>
                ...
                <div class="form-group" data-type="sixsixtext_send_sms">
                    <label for="sixsixtext_send_sms_api_key"><i class="fa fa-fw fa-sm fa-key text-muted mr-1"></i> <?= sprintf(l('notification_handlers.sixsixtext_api_key'), settings()->notification_handlers->sixsixtext_name) ?></label>
                    <input type="text" id="sixsixtext_send_sms_api_key" name="sixsixtext_send_sms_api_key" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_send_sms_api_key ?? '' ?>" maxlength="32" required="required" />
                    <small class="text-muted"><?= sprintf(l('notification_handlers.sixsixtext_api_key_help'), '<a href="' . settings()->notification_handlers->sixsixtext_url . '" target="_blank">' . settings()->notification_handlers->sixsixtext_name . '</a>') ?></small>
                </div>

                <div class="form-group" data-type="sixsixtext_send_sms">
                    <label for="sixsixtext_send_sms_device_id"><i class="fa fa-fw fa-sm fa-sim-card text-muted mr-1"></i> <?= sprintf(l('notification_handlers.sixsixtext_device_id'), settings()->notification_handlers->sixsixtext_name) ?></label>
                    <input type="number" min="0" id="sixsixtext_send_sms_device_id" name="sixsixtext_send_sms_device_id" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_send_sms_device_id ?>" required="required" />
                </div>

                <div class="form-group" data-type="sixsixtext_send_sms">
                    <label for="sixsixtext_send_sms_device_sim_subscription_id"><i class="fa fa-fw fa-sm fa-mobile text-muted mr-1"></i> <?= sprintf(l('notification_handlers.sixsixtext_device_sim_subscription_id'), settings()->notification_handlers->sixsixtext_name) ?></label>
                    <input type="number" min="0" id="sixsixtext_send_sms_device_sim_subscription_id" name="sixsixtext_send_sms_device_sim_subscription_id" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_send_sms_device_sim_subscription_id ?>" required="required" />
                </div>

                <div class="form-group" data-type="sixsixtext_send_sms">
                    <label for="sixsixtext_send_sms_phone_number"><i class="fa fa-fw fa-sm fa-phone text-muted mr-1"></i> <?= l('notification_handlers.sixsixtext_phone_number') ?></label>
                    <input type="text" id="sixsixtext_send_sms_phone_number" name="sixsixtext_send_sms_phone_number" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_send_sms_phone_number ?? '' ?>" placeholder="<?= l('notification_handlers.sixsixtext_phone_number_placeholder') ?>" required="required" />
                </div>

                <div class="form-group" data-type="sixsixtext_save_contact">
                    <label for="sixsixtext_save_contact_api_key"><i class="fa fa-fw fa-sm fa-key text-muted mr-1"></i> <?= sprintf(l('notification_handlers.sixsixtext_api_key'), settings()->notification_handlers->sixsixtext_name) ?></label>
                    <input type="text" id="sixsixtext_save_contact_api_key" name="sixsixtext_save_contact_api_key" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_save_contact_api_key ?? '' ?>" maxlength="32" required="required" />
                    <small class="text-muted"><?= sprintf(l('notification_handlers.sixsixtext_api_key_help'), '<a href="' . settings()->notification_handlers->sixsixtext_url . '" target="_blank">' . settings()->notification_handlers->sixsixtext_name . '</a>') ?></small>
                </div>

                <div class="form-group" data-type="sixsixtext_save_contact">
                    <label for="sixsixtext_save_contact_phone_number"><i class="fa fa-fw fa-sm fa-phone text-muted mr-1"></i> <?= l('notification_handlers.sixsixtext_test_phone_number') ?></label>
                    <input type="text" id="sixsixtext_save_contact_phone_number" name="sixsixtext_save_contact_phone_number" class="form-control" value="<?= $data->notification_handler->settings->sixsixtext_save_contact_phone_number ?? '' ?>" placeholder="<?= l('notification_handlers.sixsixtext_phone_number_placeholder') ?>" required="required" />
                    <small class="text-muted"><?= l('notification_handlers.sixsixtext_test_phone_number_help') ?></small>
                </div>
