                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="url" data-link-id>
                                ...
                                <select id="link_id" name="link_id" class="custom-select" disabled="disabled" data-is-disabled="true" data-reload-qr-code>
                                    <?php foreach($data->links as $row): ?>
                                        <option value="<?= $row->link_id ?>" <?= ($data->qr_code->link_id ?? null) == $row->link_id ? 'selected="selected"' : null?> data-url="<?= $row->full_url ?>" data-location-url="<?= $row->location_url ?>">
                            ...
                            <div class="form-group" data-type="url" data-url-dynamic-existing-link>
                                <div class="custom-control custom-checkbox">
                                    <input id="url_dynamic_existing_link" name="url_dynamic_existing_link" type="checkbox" class="custom-control-input" <?= ($data->qr_code->settings->url_dynamic_existing_link ?? $data->qr_code->link_id ?? null) ? 'checked="checked"' : null ?> data-reload-qr-code />
