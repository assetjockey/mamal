                                                    ...
                                                    <div class="col text-truncate">
                                                        <div class="text-truncate">
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ $user->avatarUrl }}" class="rounded-circle width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}" alt="{{ $user->name }}">
                                                ...
                                                <div class="list-group-item px-0">
                                                    <div class="row align-items-center">
                                                        <div class="col text-truncate">
                                                            <div class="text-truncate">
                                                                <div class="d-flex align-items-center">
                                                                    <img src="{{ asset('img/icons/payments/' . $payment->processor . '.svg') }}" class="width-4 rounded-sm {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}" alt="{{ config('payment.processors.' . $payment->processor)['name'] }}">
                    ...
                    @else
                        <div class="col-12 col-lg-6 p-2">
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                @if(count($latestMonitors) > 0)
                                    <div class="card-footer bg-base-2 border-0">
                                        <a href="{{ route('admin.monitors') }}" class="text-muted font-weight-medium d-flex align-items-center justify-content-center">{{ __('View all') }} @include((__('lang_dir') == 'rtl' ? 'icons.chevron-left' : 'icons.chevron-right'), ['class' => 'width-3 height-3 fill-current '.(__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2')])</a>
                                    </div>
                                @endif
                            </div>
                        </div>
