                                        ...
                                        <div class="col text-truncate">
                                            <div class="row text-truncate">
                                                <div class="col-12 col-lg-5 text-truncate d-flex align-items-center">
                                                    <a href="{{ route('admin.coupons.edit', $coupon->id) }}" class="text-truncate">{{ $coupon->name }}</a> <span class="badge badge-secondary {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2') }}" data-tooltip="true" title="{{ __('Coupon code') }}">{{ $coupon->code }}</span>
                                                </div>
