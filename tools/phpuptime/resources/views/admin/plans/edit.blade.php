                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.plans.edit', $plan->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="features[monitors]" id="i-features-monitors" class="form-control{{ $errors->has('features.monitors') ? ' is-invalid' : '' }}" value="{{ old('features.monitors') ?? $plan->features->monitors }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="features[monitor_intervals][]" id="i-features-monitor-intervals" class="custom-select{{ ($errors->has('features.monitor_intervals') || $errors->has('features.monitor_intervals.*') ? ' is-invalid' : '') }}" size="{{ (count(config('intervals.http')) == 0 ? 1 : 5) }}" multiple>
                                @foreach(config('intervals.http') as $interval)
                                    <option value="{{ $interval }}" @if((old('features.monitor_intervals') !== null && in_array($interval, old('features.monitor_intervals'))) || (in_array($interval, $plan->features->monitor_intervals) && old('monitor_ids') == null)) selected @endif>{{ Carbon\CarbonInterval::seconds($interval)->cascade()->forHumans() }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="features[ssl_monitoring]" id="i-features-ssl-monitoring" class="custom-select{{ $errors->has('features.ssl_monitoring') ? ' is-invalid' : '' }}">
                                @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                                    <option value="{{ $key }}" @if((old('features.ssl_monitoring') !== null && old('features.ssl_monitoring') == $key) || ($plan->features->ssl_monitoring == $key && old('features.ssl_monitoring') == null)) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="features[domain_monitoring]" id="i-features-domain-monitoring" class="custom-select{{ $errors->has('features.domain_monitoring') ? ' is-invalid' : '' }}">
                                @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                                    <option value="{{ $key }}" @if((old('features.domain_monitoring') !== null && old('features.domain_monitoring') == $key) || ($plan->features->domain_monitoring == $key && old('features.domain_monitoring') == null)) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="features[webhook_alerts]" id="i-features-web-alerts" class="form-control{{ $errors->has('features.webhook_alerts') ? ' is-invalid' : '' }}" value="{{ old('features.webhook_alerts') ?? $plan->features->webhook_alerts }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="features[email_alerts]" id="i-features-email-alerts" class="form-control{{ $errors->has('features.email_alerts') ? ' is-invalid' : '' }}" value="{{ old('features.email_alerts') ?? $plan->features->email_alerts }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="features[sms_alerts]" id="i-features-sms-alerts" class="form-control{{ $errors->has('features.sms_alerts') ? ' is-invalid' : '' }}" value="{{ old('features.sms_alerts') ?? $plan->features->sms_alerts }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="features[status_pages]" id="i-features-status-pages" class="form-control{{ $errors->has('features.status_pages') ? ' is-invalid' : '' }}" value="{{ old('features.status_pages') ?? $plan->features->status_pages }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="features[status_page_customization]" id="i-features-status-page-customization" class="custom-select{{ $errors->has('features.status_page_customization') ? ' is-invalid' : '' }}">
                                @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                                    <option value="{{ $key }}" @if((old('features.status_page_customization') !== null && old('features.status_page_customization') == $key) || ($plan->features->status_page_customization == $key && old('features.status_page_customization') == null)) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
