    ...
    <div class="bg-base-1 flex-fill">
        <div class="container pt-3 mt-3 pb-6">
            ...
            alert('Hello World');
                        ...
                        <div class="form-group">
                            <label for="i-timezone" class="d-inline-flex align-items-center"><span class="{{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ __('Timezone') }}</span><span class="badge badge-secondary">{{ __('Default') }}</span></label>
