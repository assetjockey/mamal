                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a href="{{ config('info.software.url') }}/{{ mb_strtolower(config('info.software.name')) }}/documentation#storage" class="alert-link font-weight-medium" target="_blank">{{ __('Learn more') }}</a>
                            </div>
                        </div>
                    </div>
