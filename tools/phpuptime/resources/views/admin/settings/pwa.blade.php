...
@section('content')
    <div class="bg-base-1 flex-fill">
        <div class="container pt-3 mt-3 pb-6">
            ...
            <h1 class="h2 mb-3 d-inline-block">{{ __('Progressive web app') }}</h1>

            <div class="card border-0 shadow-sm">
                <div class="card-header"><div class="font-weight-medium py-1">{{ __('Progressive web app') }}</div></div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings', 'storage') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="i-pwa-logo" class="d-inline-flex align-items-center"><span class="{{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ __('Logo') }}</span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text py-1 px-2"><img src="{{ asset('uploads/brand/' . config('settings.pwa_logo')) }}" class="max-height-6.5"></span>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="i-pwa-logo-maskable" class="d-inline-flex align-items-center"><span class="{{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ __('Logo') }}</span><span class="badge badge-secondary">{{ __('Maskable') }}</span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text py-1 px-2"><img src="{{ asset('uploads/brand/' . config('settings.pwa_logo_maskable')) }}" class="max-height-6.5"></span>
                                </div>
                                <div class="custom-file">
                        ...
                        <div class="form-group">
                            <label for="i-pwa-logo-monochrome" class="d-inline-flex align-items-center"><span class="{{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">{{ __('Logo') }}</span><span class="badge badge-secondary">{{ __('Monochrome') }}</span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text py-1 px-2"><img src="{{ asset('uploads/brand/' . config('settings.pwa_logo_monochrome')) }}" class="max-height-6.5"></span>
                                </div>
                                <div class="custom-file">
