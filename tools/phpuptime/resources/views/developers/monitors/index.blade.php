...
@section('site_title', formatTitle([__('Monitors'), __('Developers'), config('settings.title')]))
...
<div class="bg-light text-dark p-3 rounded d-flex align-items-center mb-3" dir="ltr">
    ...
    <pre class="m-0">{{ route('api.monitors.index') }}</pre>
</div>
...
curl --location --request GET '{{ route('api.monitors.index') }}' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer <span class="text-primary">{api_key}</span>'
</pre>

                @include('developers.monitors.list', ['type' => 0])
                </div>
            </div>
...
<div class="bg-light text-dark p-3 rounded d-flex align-items-center mb-3" dir="ltr">
<span class="badge badge-success px-2 py-1 mr-3">GET</span>
<pre class="m-0">{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.show', ['id' => ':id'])) !!}</pre>
</div>
...
<pre class="bg-light text-dark p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request GET '{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.show', ['id' => ':id'])) !!}' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer <span class="text-primary">{api_key}</span>'
</pre>
                </div>
...
<pre class="m-0">{{ route('api.monitors.store') }}</pre>
</div>
                    <p class="mb-1">
                        {{ __('Request example') }}:
                    </p>
<pre class="bg-light text-dark p-3 rounded text-left" dir="ltr">
curl --location --request POST '{{ route('api.monitors.store') }}' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Bearer <span class="text-primary">{api_key}</span>' \
--data-urlencode 'name=<span class="text-primary">{name}</span>' \
--data-urlencode 'url=<span class="text-primary">{url}</span>' \
--data-urlencode 'interval=<span class="text-primary">{interval}</span>'
</pre>

                    @include('developers.monitors.store-update', ['type' => 1])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-light text-dark p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0">{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.update', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-light text-dark p-3 rounded text-left" dir="ltr">
curl --location --request PUT '{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.update', ['id' => ':id'])) !!}' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Bearer <span class="text-primary">{api_key}</span>'
</pre>

                    @include('developers.monitors.store-update', ['type' => 0])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-light text-dark p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0">{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.destroy', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-light text-dark p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request DELETE '{!! str_replace(':id', '<span class="text-primary">{id}</span>', route('api.monitors.destroy', ['id' => ':id'])) !!}' \
--header 'Authorization: Bearer <span class="text-primary">{api_key}</span>'
</pre>
                </div>
            </div>
