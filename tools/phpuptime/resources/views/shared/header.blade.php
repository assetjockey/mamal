                ...
                <div class="row no-gutters">
                    <div class="col">
                        <div class="small text-muted">
                            {{ __(':number of :total monitors used.', ['number' => shortenNumber(Auth::user()->monitorsCount), 'total' => (Auth::user()->active_plan->features->monitors < 0 ? '∞' : shortenNumber(Auth::user()->active_plan->features->monitors))]) }}
                        </div>
                    </div>
                </div>

                <div class="progress w-100 my-2 height-1.25">
                    <div class="progress-bar rounded" role="progressbar" style="width: {{ (Auth::user()->active_plan->features->monitors == 0 ? 100 : ((Auth::user()->monitorsCount / Auth::user()->active_plan->features->monitors) * 100)) }}%"></div>
                </div>
            </a>
