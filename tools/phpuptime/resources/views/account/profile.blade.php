        ...
        <div class="container pt-3 mt-3 pb-6">
                            ...
                            <div class="col">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text py-1 px-2"><img src="{{ $user->avatarUrl }}" class="max-height-6.5" alt="{{ $user->name }}"></span>
                                    </div>
                            ...
                            <div class="row mx-n2">
                                ...
                                <div class="col-12 col-lg-4 px-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="plan_ends_at" class="form-control{{ $errors->has('plan_ends_at') ? ' is-invalid' : '' }}" id="i-plan-ends-at" placeholder="Y-m-d" value="{{ old('plan_ends_at') ?? ($user->plan_ends_at ? $user->plan_ends_at->tz($user->timezone ?? config('timezone.timezone'))->format('Y-m-d') : '') }}">
            ...
            @if(request()->is('admin/*'))
                <div class="row m-n2 pt-3">
                    <div class="col-12 col-md-6 col-lg-4 p-2">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body d-flex align-items-center text-truncate">
                                ...
                                <a href="{{ route('admin.plans.edit', ['id' => $user->plan_id]) }}" class="text-decoration-none font-weight-medium text-dark text-truncate stretched-link mx-3">{{ __('Plan') }}</a>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body d-flex align-items-center text-truncate">
                                    ...
                                    <a href="{{ route('admin.payments', ['user_id' => $user->id]) }}" class="text-decoration-none font-weight-medium text-dark text-truncate stretched-link {{ (__('lang_dir') == 'rtl' ? 'ml-2 mr-3' : 'mr-2 ml-3') }}">{{ __('Payments') }}</a>

                                    <span class="badge badge-primary {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">{{ number_format($user->payments_count, 0, __('.'), __(',')) }}</span>
                    ...
                    @if($user->monitors_count)
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <a href="{{ route('admin.monitors', ['user_id' => $user->id]) }}" class="text-decoration-none text-dark">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body d-flex align-items-center text-truncate">
                                        <div class="d-flex position-relative text-primary width-8 height-8 align-items-center justify-content-center flex-shrink-0">
                                            <div class="position-absolute bg-primary opacity-10 top-0 right-0 bottom-0 left-0 border-radius-lg"></div>
                                        ...
                                        <span class="badge badge-primary">{{ number_format($user->monitors_count, 0, __('.'), __(',')) }}</span>
                    ...
                    @if($user->status_pages_count)
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <a href="{{ route('admin.status_pages', ['user_id' => $user->id]) }}" class="text-decoration-none text-dark">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body d-flex align-items-center text-truncate">
                                        <div class="d-flex position-relative text-primary width-8 height-8 align-items-center justify-content-center flex-shrink-0">
                                            <div class="position-absolute bg-primary opacity-10 top-0 right-0 bottom-0 left-0 border-radius-lg"></div>
                                        ...
                                        <span class="badge badge-primary">{{ number_format($user->status_pages_count, 0, __('.'), __(',')) }}</span>
                    ...
                    @if($user->incidents_count)
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <a href="{{ route('admin.incidents', ['user_id' => $user->id]) }}" class="text-decoration-none text-dark">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body d-flex align-items-center text-truncate">
                                        <div class="d-flex position-relative text-primary width-8 height-8 align-items-center justify-content-center flex-shrink-0">
                                            <div class="position-absolute bg-primary opacity-10 top-0 right-0 bottom-0 left-0 border-radius-lg"></div>
                                        ...
                                        <span class="badge badge-primary">{{ number_format($user->incidents_count, 0, __('.'), __(',')) }}</span>
