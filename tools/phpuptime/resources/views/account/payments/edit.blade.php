                        ...
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body d-flex align-items-center text-truncate">
                                    ...
                                    <a href="{{ route('admin.users.edit', ['id' => $payment->user->id]) }}" class="text-decoration-none font-weight-medium text-dark text-truncate stretched-link mx-3">{{ $payment->user->name }}</a>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 p-2">
                            <div class="card border-0 shadow-sm h-100 cursor-default">
                                <div class="card-body d-flex align-items-center text-truncate">
                                    ...
                                    <span class="font-weight-medium text-decoration-none text-truncate {{ (__('lang_dir') == 'rtl' ? 'ml-3 mr-2' : 'mr-2 ml-3') }}">{{ __('Deleted') }}</span>
                                </div>
                            </div>
                        </div>
                    @endif
