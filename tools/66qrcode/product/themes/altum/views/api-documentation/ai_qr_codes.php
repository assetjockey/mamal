                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['ai_qr_code_id', 'datetime', 'last_datetime', 'name']) . '</code>') ?></td>
                            </tr>
            ...
            <div id="qr_codes_read" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="qr_codes_create" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">url_dynamic = 1</span> <span class="badge badge-light">url_dynamic_existing_link = 1</span>') ?></td>
                            </tr>
                            <tr>
                                <td>url_dynamic</td>
                                <td>
                            ...
                            <tr>
                                <td>url_dynamic_existing_link</td>
                                <td>
                                    <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-toggle-on mr-1"></i> <?= l('api_documentation.boolean') ?></span>
                                </td>
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">url_dynamic = 1</span>') ?></td>
                            </tr>
                            <tr>
                                <td>project_id</td>
                                <td>
            ...
            <div id="qr_codes_update" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="qr_codes_delete" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-danger user-select-none mr-3">DELETE</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
