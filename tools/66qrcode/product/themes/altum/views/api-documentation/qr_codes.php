...
<?php $available_api_qr_codes = require APP_PATH . 'includes/enabled_qr_codes.php'; unset($available_api_qr_codes['file']); ?>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = url</span> <span class="badge badge-light">url_dynamic = 1</span> <span class="badge badge-light">url_dynamic_existing_link = 1</span>') ?></td>
                            </tr>
                            <tr>
                                <td>url_dynamic</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = url</span> <span class="badge badge-light">url_dynamic = 1</span>') ?></td>
                            </tr>
                            <tr>
                                <td>project_id</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', array_keys($available_api_qr_codes))) ?></td>
                            </tr>
                            <tr>
                                <td>is_bulk</td>
                                <td>
                            ...
                            <?php /* FaceTime Audio */ ?>
                            <tr>
                                <td>facetime_audio</td>
                                <td>
                                    <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-signature mr-1"></i> <?= l('api_documentation.string') ?></span>
                                </td>
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = facetime_audio</span>') ?></td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>qr_code_background_remove</td>
                                <td>
                                    <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-toggle-on mr-1"></i> <?= l('api_documentation.boolean') ?></span>
                                </td>
                            ...
                            <tr>
                                <td>qr_code_foreground_remove</td>
                                <td>
                                    <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-toggle-on mr-1"></i> <?= l('api_documentation.boolean') ?></span>
                                </td>
