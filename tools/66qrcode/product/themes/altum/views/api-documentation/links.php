                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.search_by'), '<code>' . implode('</code>, <code>', ['url', 'location_url', 'name']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['link_id', 'datetime', 'last_datetime', 'url', 'location_url', 'pageviews', 'name']) . '</code>') ?></td>
                            </tr>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= l('links.input.email_reports_is_enabled_help') ?><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">is_bulk = 0</span>') ?></td>
                            </tr>
                            <tr>
                                <td>schedule</td>
                                <td>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                ...
                                --form 'email_reports_is_enabled=<span class="text-primary">1</span>' \<br />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= l('links.input.email_reports_is_enabled_help') ?></td>
                            </tr>
                            <tr>
                                <td>schedule</td>
                                <td>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                ...
                                --form 'email_reports_is_enabled=<span class="text-primary">0</span>' \<br />
                            </div>
                        </div>
                    </div>
