...
<div class="container">
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-xl-6 mx-lg-n2 mb-3">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate <?= $data->type == 'region_name' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=region_name&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate <?= $data->type == 'acquisition_channel' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=acquisition_channel&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <div class="dropdown w-100">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item <?= in_array($data->type, ['referrer_host', 'referrer_path']) && $data->referrer_type == 'all' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&referrer_type=all&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-list mr-2"></i>
                        <?= l('link_statistics.referrers_all') ?>
                    </a>
                    <a class="dropdown-item <?= in_array($data->type, ['referrer_host', 'referrer_path']) && $data->referrer_type == 'ai' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&referrer_type=ai&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-robot mr-2"></i>
                        <?= l('link_statistics.referrers_ai') ?>
                    </a>
                    <a class="dropdown-item <?= in_array($data->type, ['referrer_host', 'referrer_path']) && $data->referrer_type == 'social_media' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&referrer_type=social_media&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-share-alt mr-2"></i>
                        <?= l('link_statistics.referrers_social_media') ?>
                    </a>
                    <a class="dropdown-item <?= in_array($data->type, ['referrer_host', 'referrer_path']) && $data->referrer_type == 'search_engines' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&referrer_type=search_engines&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-search mr-2"></i>
                        <?= l('link_statistics.referrers_search_engines') ?>
                    </a>
                    <a class="dropdown-item <?= in_array($data->type, ['referrer_host', 'referrer_path']) && $data->referrer_type == 'other_websites' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&referrer_type=other_websites&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <div class="dropdown w-100">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item <?= $data->type == 'crawler' && $data->crawler_type == 'all' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=crawler&crawler_type=all&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-robot mr-2"></i>
                        <?= l('link_statistics.crawlers_all') ?>
                    </a>
                    <a class="dropdown-item <?= $data->type == 'crawler' && $data->crawler_type == 'ai' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=crawler&crawler_type=ai&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-brain mr-2"></i>
                        <?= l('link_statistics.crawlers_ai') ?>
                    </a>
                    <a class="dropdown-item <?= $data->type == 'crawler' && $data->crawler_type == 'search_engines' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=crawler&crawler_type=search_engines&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
                        <i class="fas fa-fw fa-sm fa-search mr-2"></i>
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate <?= $data->type == 'timezone' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=timezone&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate <?= $data->type == 'weekday' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=weekday&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
        ...
        <div class="p-1 p-lg-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate <?= $data->type == 'visitor_type' ? 'active' : null ?>" href="<?= url('link-statistics/' . $data->link->link_id . '?type=visitor_type&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>">
...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/statistics_reset_modal.php', ['modal_id' => 'link_statistics_reset_modal', 'resource_id' => 'link_id', 'path' => 'link-statistics/reset']), 'modals'); ?>
