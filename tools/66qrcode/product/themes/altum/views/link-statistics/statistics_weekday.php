    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= l('link_statistics.weekday') ?></h3>

                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('link_statistics.weekday_help') ?>">
        ...
        <?php else: ?>
            ...
            <?php foreach($data->rows as $row): ?>
                <?php
                /* Get the translated weekday */
                $label = l('global.date.long_days.' . $row->weekday);
