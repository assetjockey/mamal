                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_path&referrer_type=' . $data->referrer_type . '&referrer_host=' . $row->referrer_host . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->referrer_host ?>" class=""><?= $referrer_display_name ?></a>
