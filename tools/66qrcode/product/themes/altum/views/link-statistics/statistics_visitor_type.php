    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= l('link_statistics.visitor_type') ?></h3>

                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('link_statistics.visitor_type_help') ?>">
        ...
        <?php else: ?>
            ...
            <?php foreach($data->rows as $row): ?>
                ...
                if($row->visitor_type == 'crawler') {
                    $visitor_type_icon = 'fa-robot';
                    $visitor_type_label = l('link_statistics.visitor_type_crawler');
                } else {
                    $visitor_type_icon = 'fa-user';
                    $visitor_type_label = l('link_statistics.visitor_type_human');
                }
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <i class="fas fa-fw fa-sm <?= $visitor_type_icon ?> text-muted mr-1"></i>
                            <span><?= $visitor_type_label ?></span>
                        </div>
