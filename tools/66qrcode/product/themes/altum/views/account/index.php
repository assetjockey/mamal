        ...
        <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if(settings()->content->broadcasts_display_account_checkbox): ?>
                        <div class="form-group custom-control custom-switch">
                            <input id="is_broadcast_subscribed" name="is_broadcast_subscribed" type="checkbox" class="custom-control-input" <?= $this->user->is_broadcast_subscribed ? 'checked="checked"' : null ?>>
                            <label class="custom-control-label" for="is_broadcast_subscribed"><?= l('account.settings.is_broadcast_subscribed') ?></label>
                            <small class="form-text text-muted"><?= l('account.settings.is_broadcast_subscribed_help') ?></small>
                        </div>
                    <?php endif ?>
                </div>
            </div>
