    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="content-wrapper">
                <p class="content-description"><?= $data->page->description ?></p>

                <?php if(isset($data->page->table_of_contents) && count($data->page->table_of_contents)): ?>
                    <div class="my-4 p-4 border rounded-2x bg-gray-100 border-0">
                        <h2 class="h6 mb-3"><?= l('page.table_of_contents') ?></h2>

                        <ul class="list-style-none m-0">
                            <?php foreach($data->page->table_of_contents as $table_of_contents_item): ?>
                ...
                <div class="content-body <?= $data->page->editor == 'wysiwyg' ? 'ql-content' : null ?>">
                    <?= $data->page->content ?>
                </div>
            </div>
        </div>
