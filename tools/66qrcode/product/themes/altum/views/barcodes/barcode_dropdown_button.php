...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'barcode_duplicate_modal', 'resource_id' => 'barcode_id', 'path' => 'barcodes/duplicate']), 'modals', 'barcode_duplicate_modal'); ?>
