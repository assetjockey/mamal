...
<div>
    ...
    <div class="form-group" data-type="email">
        ...
        <input type="text" id="email_subject" name="email_subject" class="form-control" value="" maxlength="<?= $data->available_qr_codes['email']['subject']['max_length'] ?>" data-reload-qr-code />
    </div>
