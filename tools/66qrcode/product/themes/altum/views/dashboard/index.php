    ...
    <div class="my-4">
        <div class="row m-n2">
            <?php if(settings()->codes->ai_qr_codes_is_enabled): ?>
                <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                    <div id="total_ai_qr_codes_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                        <div class="pl-3 d-flex flex-column justify-content-center">
                            <a href="<?= url('ai-qr-codes') ?>" class="stretched-link">
                                <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                    <i class="fas fa-fw fa-sm fa-robot text-gray-900"></i>
                                </div>
                            </a>
                        </div>
            ...
            <?php if(settings()->codes->qr_codes_is_enabled): ?>
                <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                    <div id="total_qr_codes_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                        <div class="pl-3 d-flex flex-column justify-content-center">
                            <a href="<?= url('qr-codes') ?>" class="stretched-link">
                                <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                    <i class="fas fa-fw fa-sm fa-qrcode text-gray-900"></i>
                                </div>
                            </a>
                        </div>
                        <div class="card-body text-truncate">
            ...
            <?php if(settings()->codes->barcodes_is_enabled): ?>
                <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                    <div id="total_barcodes_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                        <div class="pl-3 d-flex flex-column justify-content-center">
                            <a href="<?= url('barcodes') ?>" class="stretched-link">
                                <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                    <i class="fas fa-fw fa-sm fa-barcode text-gray-900"></i>
                                </div>
                            </a>
                        </div>
                        <div class="card-body text-truncate">
            ...
            <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                <div id="total_links_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <a href="<?= url('links') ?>" class="stretched-link">
                            <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                <i class="fas fa-fw fa-sm fa-link text-gray-900"></i>
                            </div>
                        </a>
                    </div>
                    <div class="card-body text-truncate">
            ...
            <?php if(settings()->links->domains_is_enabled): ?>
                <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                    <div id="total_domains_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                        <div class="pl-3 d-flex flex-column justify-content-center">
                            <a href="<?= url('domains') ?>" class="stretched-link">
                                <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                    <i class="fas fa-fw fa-sm fa-globe text-gray-900"></i>
                                </div>
                            </a>
                        </div>
                        <div class="card-body text-truncate">
            ...
            <?php if(settings()->links->projects_is_enabled): ?>
                <div class="col-12 col-sm-6 col-xl-4 p-2 position-relative text-truncate">
                    <div id="total_projects_wrapper" class="card d-flex flex-row h-100 overflow-hidden" style="background: var(--body-bg)" data-toggle="tooltip" data-html="true">
                        <div class="pl-3 d-flex flex-column justify-content-center">
                            <a href="<?= url('projects') ?>" class="stretched-link">
                                <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center bg-gray-100">
                                    <i class="fas fa-fw fa-sm fa-diagram-project text-gray-900"></i>
                                </div>
                            </a>
                        </div>
                        <div class="card-body text-truncate">
        ...
        <?php if($is_enabled && $feature == 'ai_qr_codes' && settings()->codes->ai_qr_codes_is_enabled): ?>
            <div class="mt-5 mb-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-3">
                        <a href="<?= url('ai-qr-code-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" title="<?= l('ai_qr_codes.create') ?>"><i class="fas fa-fw fa-plus-circle fa-sm"></i></a>
                        <a href="<?= url('ai-qr-codes') ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="<?= l('global.view_all') ?>"><i class="fas fa-fw fa-robot fa-sm"></i></a>
                    </div>
                </div>

                <?php if (!empty($data->ai_qr_codes)): ?>
        ...
        <?php if($is_enabled && $feature == 'links'): ?>
            <div class="mt-5 mb-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-3">
                        <a href="<?= url('link-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" title="<?= l('links.create') ?>"><i class="fas fa-fw fa-plus-circle fa-sm"></i></a>
                        ...
                        <table class="table table-custom">
                            ...
                            <?php foreach($data->links as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex flex-column">
                                            <div><a href="<?= url($row->type == 'file' && $row->qr_code_id ? 'qr-code-update/' . $row->qr_code_id : 'link-update/' . $row->link_id) ?>"><?= $row->url ?></a></div>

                                            <div class="small text-muted">
                                                <?php if($row->type == 'file'): ?>
                                                    <i class="fas fa-fw fa-sm fa-file mr-1"></i>
                                                    <span title="<?= $row->file_name ?>"><?= string_truncate($row->file_name, 32) ?></span>
                                                    <span>(<?= get_formatted_bytes($row->file_size) ?>)</span>
                                                <?php else: ?>
        ...
        <?php if($is_enabled && $feature == 'qr_codes' && settings()->codes->qr_codes_is_enabled): ?>
            <div class="mt-5 mb-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-3">
                        <a href="<?= url('qr-code-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" title="<?= l('qr_codes.create') ?>"><i class="fas fa-fw fa-plus-circle fa-sm"></i></a>
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column ">
                                                ...
                                                <?php elseif($row->type == 'file' && $row->link_id): ?>
                                                    <div>
                                                        <a href="<?= url('link-statistics/' . $row->link_id) ?>" class="btn btn-sm btn-link" data-toggle="tooltip" title="<?= l('link_statistics.pageviews') ?>"><i class="fas fa-fw fa-chart-bar"></i></a>
                                                    </div>
                                                <?php endif ?>
                                ...
                                <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('global.datetime_tooltip'), '<br />' . \Altum\Date::get($row->datetime, 2) . '<br /><small>' . \Altum\Date::get($row->datetime, 3) . '</small>' . '<br /><small>(' . \Altum\Date::get_timeago($row->datetime) . ')</small>') ?>">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <?= include_view(THEME_PATH . 'views/qr-codes/qr_code_dropdown_button.php', ['id' => $row->qr_code_id, 'resource_name' => $row->name, 'type' => $row->type]) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach ?>
        ...
        <?php if($is_enabled && $feature == 'barcodes' && settings()->codes->barcodes_is_enabled): ?>
            <div class="mt-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-3">
                        <a href="<?= url('barcode-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" title="<?= l('barcodes.create') ?>"><i class="fas fa-fw fa-plus-circle fa-sm"></i></a>
    ...
    (async function fetch_statistics() {
        ...
        if(data.status == 'error') {
            ...
            if (total_ai_qr_codes_element) {
                ...
                document.querySelector('#total_ai_qr_codes_wrapper').setAttribute('title', get_plan_feature_limit_info(total_ai_qr_codes, ai_qr_codes_plan_limit, true, <?= json_encode(l('global.info_message.plan_feature_limit_month_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
            ...
            if (total_links_element) {
                ...
                document.querySelector('#total_links_wrapper').setAttribute('title', get_plan_feature_limit_info(total_links, <?= $this->user->plan_settings->links_limit ?>, true, <?= json_encode(l('global.info_message.plan_feature_limit_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
            ...
            if (total_domains_element) {
                ...
                document.querySelector('#total_domains_wrapper').setAttribute('title', get_plan_feature_limit_info(total_domains, domains_plan_limit, true, <?= json_encode(l('global.info_message.plan_feature_limit_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
            ...
            if (total_qr_codes_element) {
                ...
                document.querySelector('#total_qr_codes_wrapper').setAttribute('title', get_plan_feature_limit_info(total_qr_codes, qr_codes_plan_limit, true, <?= json_encode(l('global.info_message.plan_feature_limit_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
            ...
            if (total_barcodes_element) {
                ...
                document.querySelector('#total_barcodes_wrapper').setAttribute('title', get_plan_feature_limit_info(total_barcodes, barcodes_plan_limit, true, <?= json_encode(l('global.info_message.plan_feature_limit_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
            ...
            if (total_projects_element) {
                ...
                document.querySelector('#total_projects_wrapper').setAttribute('title', get_plan_feature_limit_info(total_projects, barcodes_plan_limit, true, <?= json_encode(l('global.info_message.plan_feature_limit_info')) ?>, <?= json_encode(l('global.unlimited')) ?>));
