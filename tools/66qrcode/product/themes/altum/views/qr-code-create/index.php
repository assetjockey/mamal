...
<div class="container">
    ...
    <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <input type="hidden" name="file_url" value="<?= SITE_URL ?>" />
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="url" data-url-dynamic-existing-link>
                                <div class="custom-control custom-checkbox">
                                    <input id="url_dynamic_existing_link" name="url_dynamic_existing_link" type="checkbox" class="custom-control-input" <?= ($data->values['url_dynamic_existing_link'] ?? null) ? 'checked="checked"' : null ?> data-reload-qr-code />
                        ...
                        <div>
                            <div class="form-group" data-type="facetime_audio">
                                ...
                                <input type="text" id="facetime_audio" name="facetime_audio" class="form-control <?= \Altum\Alerts::has_field_errors('facetime_audio') ? 'is-invalid' : null ?>" value="<?= isset($data->values['settings']['facetime_audio']) ? $data->values['settings']['facetime_audio'] : null ?>" maxlength="<?= $data->available_qr_codes['facetime_audio']['max_length'] ?>" required="required" data-reload-qr-code />
                        ...
                        <div class="collapse" id="colors_container" data-parent="#form">
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle m-n2" data-toggle="buttons">
                                    <div class="p-2 col-6">
                                        <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $data->values['settings']['foreground_type'] == 'color' ? 'active"' : null?>">
                                    ...
                                    <div class="p-2 col-6">
                                        <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $data->values['settings']['foreground_type'] == 'gradient' ? 'active' : null?>">
                                ...
                                <div class="row btn-group-toggle m-n2" data-toggle="buttons">
                                    <?php foreach($data->frames_fonts as $font_key => $font): ?>
                                        <div class="p-2 col-12 col-lg-4 p-2 h-100">
                                            <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $data->values['settings']['frame_text_font'] == $font_key ? 'active"' : null?>" style="font-family: <?= $font['font-family'] ?> !important;">
