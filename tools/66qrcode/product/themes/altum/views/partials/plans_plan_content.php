...
<ul class="pricing-features">
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php if($feature == 'ai_qr_codes_per_month_limit' && settings()->codes->ai_qr_codes_is_enabled): ?>
            <li>
                <div>
        ...
        <?php if($feature == 'enabled_qr_codes' && settings()->codes->qr_codes_is_enabled): ?>
        ...
        <?php if($feature == 'enabled_barcodes' && settings()->codes->barcodes_is_enabled): ?>
        ...
        <?php if($feature == 'barcodes_limit' && settings()->codes->barcodes_is_enabled): ?>
            <li>
                <div>
        ...
        <?php if($feature == 'barcodes_bulk_limit' && settings()->codes->barcodes_is_enabled): ?>
            <li>
                <div>
        ...
        <?php if($feature == 'links_bulk_limit'): ?>
            <li>
                <div>
        ...
        <?php if($feature == 'additional_domains' && settings()->links->additional_domains_is_enabled): ?>
            ...
            <li class="<?= count($data->plan_settings->additional_domains ?? []) ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'analytics_is_enabled'): ?>
            <li class="<?= $data->plan_settings->analytics_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'email_reports_is_enabled'): ?>
            <li class="<?= $data->plan_settings->email_reports_is_enabled ? null : 'text-muted' ?>">
                <div>
                    <?= l('global.plan_settings.email_reports_is_enabled_' . settings()->links->email_reports_is_enabled) ?>
                </div>
        ...
        <?php if($feature == 'password_protection_is_enabled'): ?>
            <li class="<?= $data->plan_settings->password_protection_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'sensitive_content_is_enabled'): ?>
            <li class="<?= $data->plan_settings->sensitive_content_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'cloaking_is_enabled'): ?>
            <li class="<?= $data->plan_settings->cloaking_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'app_linking_is_enabled'): ?>
            <li class="<?= $data->plan_settings->app_linking_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'targeting_is_enabled'): ?>
            <li class="<?= $data->plan_settings->targeting_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'custom_url_is_enabled'): ?>
            <li class="<?= $data->plan_settings->custom_url_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'search_engine_visibility_is_enabled'): ?>
            <li class="<?= $data->plan_settings->search_engine_visibility_is_enabled ? null : 'text-muted' ?>">
                <div>
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->search_engine_visibility_is_enabled ? 'fa-check text-success' : 'fa-times' ?>"></i>
            </li>
        <?php endif ?>

        <?php if($feature == 'utm_parameters_is_enabled'): ?>
            <li class="<?= $data->plan_settings->utm_parameters_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'qr_reader_is_enabled' && settings()->codes->qr_reader_is_enabled): ?>
            <li class="<?= $data->plan_settings->qr_reader_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'barcode_reader_is_enabled' && settings()->codes->barcode_reader_is_enabled): ?>
            <li class="<?= $data->plan_settings->barcode_reader_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'api_is_enabled' && settings()->main->api_is_enabled): ?>
            <li class="<?= $data->plan_settings->api_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'white_labeling_is_enabled' && settings()->main->white_labeling_is_enabled): ?>
            <li class="<?= $data->plan_settings->white_labeling_is_enabled ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == sprintf(l('global.plan_settings.export'), '')): ?>
            ...
            <li class="<?= $enabled_exports_count ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'no_ads'): ?>
            <li class="<?= $data->plan_settings->no_ads ? null : 'text-muted' ?>">
                <div>
        ...
        <?php if($feature == 'removable_branding'): ?>
            <li class="<?= $data->plan_settings->removable_branding ? null : 'text-muted' ?>">
                <div>
