...
<ul class="list-style-none m-0">
	<?php foreach($features as $feature => $is_enabled): ?>
		...
		<?php if($feature == 'enabled_qr_codes' && settings()->codes->qr_codes_is_enabled): ?>
			...
			<?php $enabled_qr_codes_string = implode(', ', array_map(function($key) {
		...
		<?php if($feature == 'enabled_barcodes' && settings()->codes->barcodes_is_enabled): ?>
			...
			<?php $enabled_barcodes_string = implode(', ', array_map(function($key) {
				return $key;
		...
		<?php if(settings()->codes->qr_reader_is_enabled && $feature == 'qr_reader_is_enabled'): ?>
            <li class="d-flex align-items-baseline mb-2">
