    ...
    <div class="card-body">
        ...
        <?php else: ?>
            ...
            <?php foreach($data->rows as $row): ?>
                ...
                <?php $referrer_display_name = get_referrer_display_name($row->referrer_host) ?>
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?= url('links-statistics?' . $data->filters->get_get() . '&type=referrer_path&referrer_type=' . $data->referrer_type . '&referrer_host=' . $row->referrer_host . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->referrer_host ?>" class=""><?= $referrer_display_name ?></a>
