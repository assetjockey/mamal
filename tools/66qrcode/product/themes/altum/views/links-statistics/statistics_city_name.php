    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= $data->region_name ? sprintf(l('link_statistics.city_name_from_region'), $data->region_name) : ($data->country_code ? sprintf(l('link_statistics.city_name_from_country'), get_country_from_country_code($data->country_code)) : l('global.cities')) ?></h3>
        ...
        <?php else: ?>
            ...
            <?php foreach($data->rows as $row): ?>
                ...
                $country_code = $data->country_code ? $data->country_code : (isset($row->country_code) ? $row->country_code : null);
                ?>
