...
<div class="container">
    ...
    <h1 class="h4 text-truncate mb-4"><i class="fas fa-fw fa-xs fa-link mr-1"></i> <?= l('link_create.header') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input id="name" type="text"  name="name" class="form-control" value="<?= $data->values['name'] ?? '' ?>" maxlength="64" />
                </div>
                ...
                <div class="collapse" id="protection_container">
                    <div <?= $this->user->plan_settings->password_protection_is_enabled ? null : get_plan_feature_disabled_info() ?>>
                        <div class="form-group <?= $this->user->plan_settings->password_protection_is_enabled ? null : 'container-disabled' ?>" data-password-toggle-view data-password-toggle-view-show="<?= l('global.show') ?>" data-password-toggle-view-hide="<?= l('global.hide') ?>">
                            ...
                            <input type="password" id="password" name="password" maxlength="64" class="form-control" value="<?= $data->values['password'] ?>" autocomplete="new-password" />
                        </div>
                    </div>
                ...
                <button class="btn btn-block btn-gray-200 font-size-little-small font-weight-450 font-size-small font-weight-500 my-4" type="button" data-toggle="collapse" data-target="#seo_container" aria-expanded="false" aria-controls="seo_container">
                    <i class="fas fa-fw fa-search-plus fa-sm mr-1"></i> <?= l('links.input.seo') ?>
                </button>
                ...
                <div class="collapse" id="seo_container">
                    <div <?= $this->user->plan_settings->search_engine_visibility_is_enabled ? null : get_plan_feature_disabled_info() ?>>
                        <div class="form-group custom-control custom-switch <?= $this->user->plan_settings->search_engine_visibility_is_enabled ? null : 'container-disabled' ?>">
                            <input id="is_se_visible" name="is_se_visible" type="checkbox" class="custom-control-input" <?= $data->values['is_se_visible'] ? 'checked="checked"' : null?> <?= $this->user->plan_settings->search_engine_visibility_is_enabled ? null : 'disabled="disabled"' ?>>
                            <label class="custom-control-label" for="is_se_visible"><?= l('links.input.is_se_visible') ?></label>
                            <small class="form-text text-muted"><?= l('links.input.is_se_visible_help') ?></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse" id="advanced_container">
                    ...
                    <?php if(settings()->links->email_reports_is_enabled): ?>
                        <div id="email_reports_is_enabled_wrapper" class="form-group">
                            <div <?= $this->user->plan_settings->email_reports_is_enabled ? null : get_plan_feature_disabled_info() ?>>
                                <div class="<?= $this->user->plan_settings->email_reports_is_enabled ? null : 'container-disabled' ?>">
                                    <div class="custom-control custom-switch">
                                        <input id="email_reports_is_enabled" name="email_reports_is_enabled" type="checkbox" class="custom-control-input" <?= $data->values['email_reports_is_enabled'] ? 'checked="checked"' : null ?> <?= $this->user->plan_settings->email_reports_is_enabled ? null : 'disabled="disabled"' ?>>
                                        <label class="custom-control-label" for="email_reports_is_enabled"><i class="fas fa-fw fa-envelope-open-text fa-sm text-muted mr-1"></i> <?= l('global.plan_settings.email_reports_is_enabled_' . settings()->links->email_reports_is_enabled) ?></label>
                                        <small class="form-text text-muted"><?= l('links.input.email_reports_is_enabled_help') ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
...
/* Bulk processing */
    let process_bulk = () => {
        ...
        let email_reports_is_enabled_wrapper = document.querySelector('#email_reports_is_enabled_wrapper');
        ...
        if(is_bulk) {
            ...
            if(email_reports_is_enabled_wrapper) email_reports_is_enabled_wrapper.classList.add('d-none');
        } else {
            ...
            if(email_reports_is_enabled_wrapper) email_reports_is_enabled_wrapper.classList.remove('d-none');
        }
    }
