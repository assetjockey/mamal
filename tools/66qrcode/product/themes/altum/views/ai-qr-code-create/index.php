                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group" data-url-dynamic-existing-link>
                            <div class="custom-control custom-checkbox">
                                <input id="url_dynamic_existing_link" name="url_dynamic_existing_link" type="checkbox" class="custom-control-input" <?= ($data->values['url_dynamic_existing_link'] ?? null) ? 'checked="checked"' : null ?> />
