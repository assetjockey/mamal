    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <?php if(in_array($data->plan_id, ['guest', 'free', 'custom'])): ?>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-gray-200" type="button" data-toggle="collapse" data-target="#price_translate_container" aria-expanded="false" aria-controls="price_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div class="form-group">
                    <label for="qr_code_file_size_limit"><?= l('admin_plans.plan.qr_code_file_size_limit') ?></label>
                    <div class="input-group">
                        <input type="number" id="qr_code_file_size_limit" name="qr_code_file_size_limit" min="-1" step="0.01" class="form-control" value="<?= $data->plan->settings->qr_code_file_size_limit ?? 0 ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
                        <div class="input-group-append">
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="email_reports_is_enabled" name="email_reports_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->email_reports_is_enabled ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="search_engine_visibility_is_enabled" name="search_engine_visibility_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->search_engine_visibility_is_enabled ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    <label class="custom-control-label" for="search_engine_visibility_is_enabled"><?= l('admin_plans.plan.search_engine_visibility_is_enabled') ?></label>
                    <div><small class="form-text text-muted"><?= l('admin_plans.plan.search_engine_visibility_is_enabled_help') ?></small></div>
                </div>

                <div class="form-group custom-control custom-switch">
                    <input id="search_engine_visibility_is_enabled" name="sensitive_content_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->sensitive_content_is_enabled ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    ...
                    <?php foreach(array_keys((require APP_PATH . 'includes/qr_codes.php')) as $key): ?>
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="enabled_qr_codes_<?= $key ?>" name="enabled_qr_codes[]" value="<?= $key ?>" type="checkbox" class="custom-control-input" <?= ($data->plan->settings->enabled_qr_codes->{$key} ?? false) ? 'checked="checked"' : null ?>>
