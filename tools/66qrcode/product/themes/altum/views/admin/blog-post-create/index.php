...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        <form id="blog_post_create_form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="author_id" name="author_id" class="custom-select">
                        <?php foreach($data->blog_authors as $blog_author): ?>
                            <option value="<?= $blog_author->id ?>" <?= $data->values['author_id'] == $blog_author->id ? 'selected="selected"' : null ?>><?= $blog_author->name ?></option>
                        <?php endforeach ?>

                        <option value="" <?= $data->values['author_id'] == '' ? 'selected="selected"' : null ?>><?= l('global.none') ?></option>
                    </select>
                </div>
            <?php endif ?>
            ...
            <?php /* Featured post */ ?>
            <div class="form-group custom-control custom-switch">
                <input id="is_featured" name="is_featured" type="checkbox" class="custom-control-input" <?= $data->values['is_featured'] ? 'checked="checked"' : null ?>>
