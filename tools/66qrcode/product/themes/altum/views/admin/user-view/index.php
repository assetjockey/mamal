    ...
    <div id="preferences" class="collapse show">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        <label for="is_broadcast_subscribed" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-mail-bulk text-muted mr-1"></i> <?= l('admin_users.is_broadcast_subscribed') ?></label>
                        <input id="is_broadcast_subscribed" type="text" class="form-control-plaintext" value="<?= $data->user->is_broadcast_subscribed ? l('global.yes') : l('global.no') ?>" readonly />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="payment" class="collapse">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label for="plan_renewal_reminder" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-business-time text-muted mr-1"></i> <?= l('admin_users.plan_renewal_reminder') ?></label>
                            <input id="plan_renewal_reminder" type="text" class="form-control-plaintext" value="<?= $data->user->plan_renewal_reminder ? l('global.yes') : l('global.no') ?>" readonly />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/ai-qr-codes?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/barcodes?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/links?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
