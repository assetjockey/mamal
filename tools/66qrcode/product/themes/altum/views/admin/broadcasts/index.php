...
<?php if(!empty($data->broadcasts) || $data->filters->has_applied_filters): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
        ...
        <div class="d-flex position-relative">
            ...
            <div class="ml-3">
                <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->broadcasts) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('admin_broadcasts.last_sent_email_datetime'), ($row->last_sent_email_datetime ? '<br />' . \Altum\Date::get($row->last_sent_email_datetime, 2) . '<br /><small>' . \Altum\Date::get($row->last_sent_email_datetime, 3) . '</small>' . '<br /><small>(' . \Altum\Date::get_timeago($row->last_sent_email_datetime) . ')</small>' : '<br />' . l('global.na'))) ?>">
