...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_is_broadcast_subscribed" class="small"><?= l('admin_users.is_broadcast_subscribed') ?></label>
                            <select name="is_broadcast_subscribed" id="filters_is_broadcast_subscribed" class="custom-select custom-select-sm">
                                <option value=""><?= l('global.all') ?></option>
                                <option value="1" <?= isset($data->filters->filters['is_broadcast_subscribed']) && $data->filters->filters['is_broadcast_subscribed'] == 1 ? 'selected="selected"' : null ?>><?= l('global.yes') ?></option>
                                <option value="0" <?= isset($data->filters->filters['is_broadcast_subscribed']) && $data->filters->filters['is_broadcast_subscribed'] == 0 ? 'selected="selected"' : null ?>><?= l('global.no') ?></option>
                            </select>
                        </div>
        ...
        <div class="ml-3">
            <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->users) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
