...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="instructions"><i class="fas fa-fw fa-sm fa-align-left text-muted mr-1"></i> <?= l('admin_settings.offline_payment.instructions') ?></label>
        ...
        <div class="form-group">
            <label for="proof_size_limit"><i class="fas fa-fw fa-sm fa-file text-muted mr-1"></i> <?= l('admin_settings.offline_payment.proof_size_limit') ?></label>
