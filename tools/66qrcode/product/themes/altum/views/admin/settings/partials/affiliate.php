        ...
        <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) || !\Altum\Plugin::is_active('affiliate') ? 'container-disabled' : null ?>">
            ...
            <div class="form-group">
                <label for="withdrawal_notes" class="d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-sm btn-gray-200" type="button" data-toggle="collapse" data-target="#withdrawal_notes_translate_container" aria-expanded="false" aria-controls="withdrawal_notes_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
                </label>
