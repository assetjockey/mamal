    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="pills-light" role="tabpanel" aria-labelledby="pills-light-tab">
            ...
            <div class="form-group">
                <label><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('admin_settings.theme.primary_theme') ?></label>
            ...
            <div class="form-group">
                <label><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('admin_settings.theme.gray_theme') ?></label>
                <div class="row m-n2 d-flex align-items-stretch form-group">
            ...
            <div class="collapse" data-parent="#theme" id="<?= $mode . '_advanced_container' ?>">
                ...
                <div id="<?= $mode . '_primary_advanced_container' ?>">
                    <?php foreach(['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'] as $key): ?>
                        <div class="form-group">
                            <label for="<?= $mode . '_primary_' . $key ?>"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> Primary <?= $key ?></label>
                ...
                <div id="<?= $mode . '_gray_advanced_container' ?>">
                    <?php foreach(['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'] as $key): ?>
                        <div class="form-group">
                            <label for="<?= $mode . '_gray_' . $key ?>"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> Gray <?= $key ?></label>
            ...
            <div class="form-group">
                <label><i class="fas fa-fw fa-sm fa-font text-muted mr-1"></i> <?= l('admin_settings.theme.font_family') ?></label>
                <div class="row m-n2 d-flex align-items-stretch form-group">
                    <label class="col-4 p-2 custom-radio-box m-0">
                        <input
                                type="radio"
            ...
            <div class="form-group" id="<?= $mode . '_font_family_container' ?>">
                <label for="<?= $mode . '_font_family_custom' ?>"><i class="fas fa-fw fa-sm fa-font text-muted mr-1"></i> <?= l('admin_settings.theme.font_family') ?></label>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="rem">
                <label for="<?= $mode . '_border_radius' ?>"><i class="fas fa-fw fa-sm fa-border-all text-muted mr-1"></i> <?= l('admin_settings.theme.border_radius') ?></label>
