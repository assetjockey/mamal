...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.api_key') ?></label>
            <input id="api_key" type="text" name="api_key" class="form-control" value="<?= settings()->lemonsqueezy->api_key ?>" />
        </div>

        <div class="form-group">
            <label for="signing_secret"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.signing_secret') ?></label>
            <input id="signing_secret" type="text" name="signing_secret" class="form-control" value="<?= settings()->lemonsqueezy->signing_secret ?>" />
        </div>

        <div class="form-group">
            <label for="store_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.store_id') ?></label>
            <input id="store_id" type="text" name="store_id" class="form-control" value="<?= settings()->lemonsqueezy->store_id ?>" />
        </div>

        <div class="form-group">
            <label for="one_time_monthly_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.one_time_monthly_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="one_time_quarterly_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.one_time_quarterly_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="one_time_biannual_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.one_time_biannual_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="one_time_annual_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.one_time_annual_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="one_time_lifetime_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.one_time_lifetime_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="recurring_monthly_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.recurring_monthly_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="recurring_quarterly_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.recurring_quarterly_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="recurring_biannual_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.recurring_biannual_variant_id') ?></label>
        ...
        <div class="form-group">
            <label for="recurring_annual_variant_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.lemonsqueezy.recurring_annual_variant_id') ?></label>
