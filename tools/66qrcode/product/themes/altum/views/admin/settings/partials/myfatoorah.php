...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="api_endpoint"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.myfatoorah.api_endpoint') ?></label>
        ...
        <div class="form-group">
            <label for="api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.myfatoorah.api_key') ?></label>
            <input id="api_key" type="text" name="api_key" class="form-control" value="<?= settings()->myfatoorah->api_key ?>" />
        </div>

        <div class="form-group">
            <label for="secret_key"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.myfatoorah.secret_key') ?></label>
