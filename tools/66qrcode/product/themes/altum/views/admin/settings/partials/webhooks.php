...
<div id="webhooks">
    ...
    <div class="collapse" data-parent="#webhooks" id="users_container">
        <div class="form-group">
            <label for="user_new"><i class="fas fa-fw fa-sm fa-user text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_new') ?></label>
            ...
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['user_id', 'email', 'name', 'source', 'is_broadcast_subscribed', 'datetime']) . '</code>') ?></small>
        </div>

        <div class="form-group">
            <label for="user_update"><i class="fas fa-fw fa-sm fa-user text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_update') ?></label>
        ...
        <div class="form-group">
            <label for="user_delete"><i class="fas fa-fw fa-sm fa-user text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_delete') ?></label>
    ...
    <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#broadcast_subscribers_container" aria-expanded="false" aria-controls="broadcast_subscribers_container">
        <i class="fas fa-fw fa-newspaper fa-sm mr-1"></i> <?= l('admin_settings.webhooks.broadcast_subscribers') ?>
    </button>

    <div class="collapse" data-parent="#webhooks" id="broadcast_subscribers_container">
        <div class="form-group">
            <label for="broadcast_subscriber_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.broadcast_subscriber_new') ?></label>
            <input id="broadcast_subscriber_new" type="url" name="broadcast_subscriber_new" class="form-control" value="<?= settings()->webhooks->broadcast_subscriber_new ?>" placeholder="<?= l('global.url_placeholder') ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['broadcast_subscriber_id', 'user_id', 'email', 'name', 'source', 'status', 'language', 'ip', 'country_code', 'city_name', 'unsubscribed_datetime', 'last_datetime', 'datetime']) . '</code>') ?></small>
        </div>

        <div class="form-group">
            <label for="broadcast_subscriber_unsubscribe"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.broadcast_subscriber_unsubscribe') ?></label>
            <input id="broadcast_subscriber_unsubscribe" type="url" name="broadcast_subscriber_unsubscribe" class="form-control" value="<?= settings()->webhooks->broadcast_subscriber_unsubscribe ?>" placeholder="<?= l('global.url_placeholder') ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['broadcast_subscriber_id', 'user_id', 'email', 'name', 'source', 'status', 'language', 'ip', 'country_code', 'city_name', 'unsubscribed_datetime', 'last_datetime']) . '</code>') ?></small>
        </div>

        <div class="form-group">
            <label for="broadcast_subscriber_delete"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.broadcast_subscriber_delete') ?></label>
            <input id="broadcast_subscriber_delete" type="url" name="broadcast_subscriber_delete" class="form-control" value="<?= settings()->webhooks->broadcast_subscriber_delete ?>" placeholder="<?= l('global.url_placeholder') ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['broadcast_subscriber_id', 'user_id', 'email', 'name', 'source', 'status', 'language', 'ip', 'country_code', 'city_name', 'unsubscribed_datetime', 'last_datetime', 'datetime', 'deleted_datetime']) . '</code>') ?></small>
        </div>
    </div>
    ...
    <div class="collapse" data-parent="#webhooks" id="payments_container">
        <div class="form-group">
            <label for="payment_new"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('admin_settings.webhooks.payment_new') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="codes_container">
        <div class="form-group">
            <label for="code_redeemed"><i class="fas fa-fw fa-sm fa-code text-muted mr-1"></i> <?= l('admin_settings.webhooks.code_redeemed') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="contact_form_container">
        <div class="form-group">
            <label for="contact"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('admin_settings.webhooks.contact') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="cron_container">
        <div class="form-group">
            <label for="cron_start"><i class="fas fa-fw fa-sm fa-clock text-muted mr-1"></i> <?= l('admin_settings.webhooks.cron_start') ?></label>
        ...
        <div class="form-group">
            <label for="cron_end"><i class="fas fa-fw fa-sm fa-clock text-muted mr-1"></i> <?= l('admin_settings.webhooks.cron_end') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="domains_container">
        <div class="form-group">
            <label for="domain_new"><i class="fas fa-fw fa-sm fa-globe text-muted mr-1"></i> <?= l('admin_settings.webhooks.domain_new') ?></label>
        ...
        <div class="form-group">
            <label for="domain_update"><i class="fas fa-fw fa-sm fa-globe text-muted mr-1"></i> <?= l('admin_settings.webhooks.domain_update') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="links_container">
        <div class="form-group">
            <label for="link_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.link_new') ?></label>
            ...
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['user_id', 'link_id', 'domain_id', 'full_url', 'url', 'location_url', 'datetime']) . '</code>') ?></small>
        </div>

        <div class="form-group">
            <label for="link_update"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.link_update') ?></label>
