...
<div>
            ...
            <?php foreach($available_qr_codes as $key => $value): ?>
                <div class="col-12 col-lg-6">
                    <div class="custom-control custom-checkbox my-2">
                        <input id="<?= 'qr_code_' . $key ?>" name="available_qr_codes[]" value="<?= $key ?>" type="checkbox" class="custom-control-input" <?= (settings()->codes->available_qr_codes->{$key} ?? false) ? 'checked="checked"' : null ?>>
    ...
    <?php foreach(['logo', 'background'] as $key): ?>
        <div class="form-group">
            <label for="<?= $key . '_size_limit' ?>"><i class="fas fa-fw fa-sm fa-file text-muted mr-1"></i> <?= l('admin_settings.codes.' . $key . '_size_limit') ?></label>
    ...
    <div class="form-group">
        <label for="ai_qr_codes_replicate_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.codes.ai_qr_codes_replicate_api_key') ?></label>
