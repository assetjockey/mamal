...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="user_plan_renewal_reminder"><i class="fas fa-fw fa-sm fa-envelope-open-text text-muted mr-1"></i> <?= l('admin_settings.payment.user_plan_renewal_reminder') ?></label>
            <div class="input-group">
                <input id="user_plan_renewal_reminder" type="number" min="0" name="user_plan_renewal_reminder" class="form-control" value="<?= settings()->payment->user_plan_renewal_reminder ?>" />
                <div class="input-group-append">
                    <span class="input-group-text"><?= l('global.date.days') ?></span>
                </div>
            </div>
            <small class="form-text text-muted"><?= l('admin_settings.payment.user_plan_renewal_reminder_help') ?></small>
        </div>
