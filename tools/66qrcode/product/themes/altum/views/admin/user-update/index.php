            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="qr_code_file_size_limit" name="qr_code_file_size_limit" min="-1" step="0.01" class="form-control" value="<?= $data->user->plan_settings->qr_code_file_size_limit ?? 0 ?>" />
                    ...
                    <?php foreach(array_keys((require APP_PATH . 'includes/qr_codes.php')) as $key): ?>
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="enabled_qr_codes_<?= $key ?>" name="enabled_qr_codes[]" value="<?= $key ?>" type="checkbox" class="custom-control-input" <?= ($data->user->plan_settings->enabled_qr_codes->{$key} ?? false) ? 'checked="checked"' : null ?>>
