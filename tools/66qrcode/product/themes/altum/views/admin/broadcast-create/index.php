    ...
    <div class="card-body">
        ...
        <form id="broadcast_create_form" action="" method="post" role="form">
            ...
            <div class="form-group custom-control custom-switch" data-type="external">
                <input id="is_system_email" name="is_system_email" type="checkbox" value="system" class="custom-control-input" <?= $data->values['is_system_email'] ? 'checked="checked"' : null ?>>
            ...
            <div class="form-group" data-segment="custom" data-broadcast-audience="">
                ...
                <input type="text" id="broadcast_subscribers_ids" name="broadcast_subscribers_ids" value="<?= $data->values['broadcast_subscribers_ids'] ?? '' ?>" class="form-control <?= \Altum\Alerts::has_field_errors('broadcast_subscribers_ids') ? 'is-invalid' : null ?>" placeholder="<?= l('admin_broadcasts.broadcast_subscribers_ids_placeholder') ?>" required="required" />
                        ...
                        <?php foreach(['registered', 'guest'] as $subscriber_type): ?>
                            <div class="col-6 mb-3">
                                <div class="custom-control custom-checkbox">
                                    <input id="<?= 'filters_subscriber_type###' . $subscriber_type ?>" name="filters_subscriber_type[]" value="<?= $subscriber_type ?>" type="checkbox" class="custom-control-input" <?= isset($data->values['filters_subscriber_type'][$subscriber_type]) ? 'checked="checked"' : null ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <?php foreach(['register', 'account', 'index'] as $source): ?>
                            <div class="col-6 mb-3">
                                <div class="custom-control custom-checkbox">
                                    <input id="<?= 'filters_broadcast_subscribers_source###' . $source ?>" name="filters_broadcast_subscribers_source[]" value="<?= $source ?>" type="checkbox" class="custom-control-input" <?= isset($data->values['filters_broadcast_subscribers_source'][$source]) ? 'checked="checked"' : null ?>>
