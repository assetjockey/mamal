...
<div class="container">
    ...
    <div class="row m-n2 justify-content-between">
        <div class="col-12 col-lg-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" title="<?= l('referrals.statistics.referrals_help') ?>">
                ...
                <div class="card-body text-truncate d-flex align-items-center">
                    <div class="text-truncate">
                        <span class="font-weight-bold mr-1"><?= nr($data->referrals_statistics->referrals) ?></span>
                        <span class="text-muted"><?= mb_strtolower(l('referrals.statistics.referrals')) ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" title="<?= l('referrals.statistics.converted_referrals_help') ?>">
                <div class="pl-3 d-flex flex-column justify-content-center">
                ...
                <div class="card-body text-truncate d-flex align-items-center">
                    <div class="text-truncate">
                        <span class="font-weight-bold mr-1"><?= nr($data->referrals_statistics->converted_referrals) ?></span>
                        <span class="text-muted"><?= mb_strtolower(l('referrals.statistics.converted_referrals')) ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" title="<?= l('referrals.statistics.pending_affiliate_commissions_help') ?>">
                <div class="pl-3 d-flex flex-column justify-content-center">
                    <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center" style="background: #fffbeb; color: #f59e0b;">
                        <i class="fas fa-fw fa-sm fa-clock"></i>
                    </div>
                </div>
                <div class="card-body text-truncate d-flex align-items-center">
                    <div class="text-truncate">
                        <span class="font-weight-bold mr-1"><?= nr($data->pending_affiliate_commissions, 2) . ' ' . settings()->payment->default_currency ?></span>
                        <span class="text-muted"><?= mb_strtolower(l('referrals.statistics.pending_affiliate_commissions')) ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden" data-toggle="tooltip" title="<?= l('referrals.statistics.approved_affiliate_commissions_help') ?>">
                <div class="pl-3 d-flex flex-column justify-content-center">
                    <div class="p-2 rounded-2x index-widget-icon d-flex align-items-center justify-content-center" style="background: #f0fdf4; color: #22c55e;">
                        <i class="fas fa-fw fa-sm fa-check"></i>
                    </div>
                </div>
                <div class="card-body text-truncate d-flex align-items-center">
                    <div class="text-truncate">
                        <span class="font-weight-bold mr-1"><?= nr($data->approved_affiliate_commissions, 2) . ' ' . settings()->payment->default_currency ?></span>
                        <span class="text-muted"><?= mb_strtolower(l('referrals.statistics.approved_affiliate_commissions')) ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-2">
        <h1 class="h4 mb-3 mb-md-0"><?= l('referrals.invite.header') ?></h1>

        <a href="<?= url('referrals-users') ?>" class="btn btn-light" data-toggle="tooltip" title="<?= l('referrals_users.menu') ?>">
            <i class="fas fa-fw fa-sm fa-users"></i>
        </a>
    </div>
