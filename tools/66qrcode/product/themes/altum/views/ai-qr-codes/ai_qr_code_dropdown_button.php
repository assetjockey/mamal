...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'ai_qr_code_duplicate_modal', 'resource_id' => 'ai_qr_code_id', 'path' => 'ai-qr-codes/duplicate']), 'modals', 'ai_qr_code_duplicate_modal'); ?>
