        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center flex-column flex-lg-row">
                ...
                <div class="text-center text-lg-left">
                    ...
                    <?php elseif(isset($_GET['payment_processor']) && in_array($_GET['payment_processor'], ['paypal', 'stripe', 'payu', 'paystack', 'razorpay', 'mollie', 'yookassa', 'crypto_com', 'paddle', 'paddle_billing', 'midtrans', 'flutterwave', 'lemonsqueezy', 'myfatoorah', 'klarna', 'plisio', 'onepay'])): ?>
