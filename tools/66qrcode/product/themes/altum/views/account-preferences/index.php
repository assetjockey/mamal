        ...
        <div class="card-body">
            ...
            <form id="account_preferences" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="collapse" data-parent="#account_preferences" id="default_settings_container">
                    ...
                    <div class="form-group">
                        ...
                        <select id="links_default_order_by" name="links_default_order_by" class="custom-select <?= \Altum\Alerts::has_field_errors('links_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <option value="name" <?= $this->user->preferences->links_default_order_by == 'name' ? 'selected="selected"' : null ?>><?= l('global.name') ?></option>
                        </select>
                ...
                <div class="collapse" data-parent="#account_preferences" id="tracking_settings_container">
                    <div class="form-group custom-control custom-switch">
                        <input id="track_crawlers" name="track_crawlers" type="checkbox" class="custom-control-input" <?= (isset($this->user->preferences->track_crawlers) && $this->user->preferences->track_crawlers) ? 'checked="checked"' : null ?>>
                        <label class="custom-control-label" for="track_crawlers"><?= l('account_preferences.track_crawlers') ?></label>
                        <small class="form-text text-muted"><?= l('account_preferences.track_crawlers_help') ?></small>
                        <?= \Altum\Alerts::output_field_error('track_crawlers') ?>
                    </div>
