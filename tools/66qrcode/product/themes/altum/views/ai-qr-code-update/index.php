            ...
            <div class="col-12 col-xl-6 d-print-none mb-5 mb-xl-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group" data-url-dynamic-existing-link>
                            <div class="custom-control custom-checkbox">
                                <input id="url_dynamic_existing_link" name="url_dynamic_existing_link" type="checkbox" class="custom-control-input" <?= ($data->ai_qr_code->link_id ?? null) && (!isset($data->ai_qr_code->settings->url_dynamic_existing_link) || $data->ai_qr_code->settings->url_dynamic_existing_link) ? 'checked="checked"' : null ?> />
                        ...
                        <button id="generate" type="submit" name="generate" class="btn btn-block btn-outline-primary mt-4" data-is-ajax><?= l('ai_qr_code_create.generate') ?></button>
