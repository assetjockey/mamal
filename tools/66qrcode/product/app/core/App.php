    ...
    public function __construct() {
        ...
        if(is_logged_in()) {
            ...
            if(Teams::delegate_access()) {
                \Altum\Authentication::$user_id = Teams::$team_user->user_id; 
        ...
        /* Give the guest settings for his plan */
            ...
            \Altum\Authentication::$user->preferences = \Altum\CustomHooks::return_default_user_preferences();
