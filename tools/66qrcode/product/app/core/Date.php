...
class Date {
    ...
    public static function get_start_end_dates_new($start_date = null, $end_date = null, $current_timezone = null, $wanted_timezone = null) {
        ...
        /* Convert the selected local range to the wanted timezone */
        $return['query_start_date'] = (clone $start_date)->setTimezone($wanted_timezone)->format('Y-m-d H:i:s');
        $return['query_end_date'] = (clone $end_date)->modify('+1 day')->setTimezone($wanted_timezone)->format('Y-m-d H:i:s');
