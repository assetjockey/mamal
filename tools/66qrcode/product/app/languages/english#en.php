...
return [
    ...
    'global.plan_settings.search_engine_visibility_is_enabled' => 'Search engine indexing',
    'global.plan_settings.search_engine_visibility_is_enabled_help' => 'You will be able to toggle search engines (like Google) indexing of your short URLs.',
	...
	'ai_qr_codes.ai_qr_code' => 'AI QR code',
    ...
    'qr_codes.error_message.rate_limit' => 'You are generating QR codes too quickly. Please wait a few seconds.',
    ...
    'qr_codes.type.file' => 'File',
    'qr_codes.type.file_description' => 'Upload a file and share it through a dynamic QR code.',
    'qr_codes.type.file_extra_content' => '',
    'qr_codes.type.file_meta_keywords' => '',
    ...
    'qr_codes.type.whatsapp_description' => 'Get custom WhatsApp messages from people through QR code.',
    ...
    'qr_codes.type.facetime_audio' => 'FaceTime Audio',
    'qr_codes.type.facetime_audio_description' => 'Get FaceTime Audio calls from people by scanning the QR code.',
    'qr_codes.type.facetime_audio_extra_content' => '',
    'qr_codes.type.facetime_audio_meta_keywords' => '',
    ...
    'qr_codes.type.paypal_description' => 'Create direct payment links and get paid via a QR code.',
    ...
    'qr_codes.input.file' => 'File',
    'qr_codes.input.file_help' => 'The file is delivered through a tracked short URL. PDFs open in the browser and other file types download.',
    'qr_codes.error_message.file_api_not_available' => 'File QR codes can only be created and updated from the QR code dashboard.',
    'qr_codes.error_message.file_duplicate_not_available' => 'File QR codes cannot be duplicated. Create a new File QR code instead.',
    ...
    'qr_codes.input.facetime_audio' => 'Phone number or email address',
    'qr_codes.error_message.invalid_facetime' => 'Enter a valid email address or an international phone number starting with +.',
    ...
    'qr_codes.theme_apply' => 'Apply theme',
    ...
    'barcodes.error_message.invalid_request' => 'The barcode generation request is invalid.',
    'barcodes.error_message.rate_limit' => 'You are generating barcodes too quickly. Please wait a few seconds.',
    ...
    'links.input.email_reports_is_enabled' => 'Email reports',
    'links.input.email_reports_is_enabled_help' => 'Receive simple and easy to understand analytics for your link via your account email.',
    ...
    'links.input.seo' => 'SEO',
    'links.input.is_se_visible' => 'Search engine visibility',
    'links.input.is_se_visible_help' => 'If disabled, the link will not be indexed by search engines, such as Google or Bing.',
    ...
    'links.input.forward_query_parameters_is_enabled_help' => 'If your short URL is accessed with query parameters (e.g. ?name=sample), append that to the destination URL automatically.',
    ...
    'links.input.utm_medium_placeholder' => 'e.g. link, banner, email, social',
    'links.input.utm_campaign' => 'Campaign',
    'links.input.utm_campaign_placeholder' => 'e.g. spring_sale_2024, black_friday',
    'links.input.utm_source' => 'Source',
    'links.input.utm_source_placeholder' => 'e.g. newsletter, bing, google, youtube',
    ...
    'link_statistics.region_name_help' => 'Discover the regions that your visitors are from.',
    'link_statistics.region_name_from_country' => 'Regions of %s',
    'link_statistics.city_name_from_country' => 'Cities of %s',
    'link_statistics.city_name_from_region' => 'Cities of %s',
    'link_statistics.city_name_help' => 'Discover the cities that your visitors are from.',
    'link_statistics.timezone' => 'Timezones',
    'link_statistics.timezone_help' => 'Discover the timezones that your visitors are from.',
    ...
    'link_statistics.referrers_all' => 'All',
    'link_statistics.referrers_ai' => 'AI',
    'link_statistics.referrers_social_media' => 'Social media',
    'link_statistics.referrers_search_engines' => 'Search engines',
    'link_statistics.referrers_other_websites' => 'Other websites',
    'link_statistics.crawlers' => 'Crawlers',
    'link_statistics.crawlers_help' => 'Discover which crawlers are visiting your links.',
    'link_statistics.crawlers_all' => 'All crawlers',
    'link_statistics.crawlers_ai' => 'AI crawlers',
    'link_statistics.crawlers_search_engines' => 'Search engines',
    'link_statistics.crawler_category.search_engine' => 'Search engine',
    'link_statistics.crawler_category.ai_search' => 'AI search',
    'link_statistics.crawler_category.ai_training' => 'AI training',
    'link_statistics.crawler_category.ai_agent' => 'AI agent',
    'link_statistics.crawler_category.other' => 'Other',
    ...
    'link_statistics.weekday' => 'Weekdays',
    'link_statistics.weekday_help' => 'Discover what days of the week your visitors are most active.',
    'link_statistics.visitor_type' => 'Human vs crawlers',
    'link_statistics.visitor_type_help' => 'Discover how much of your traffic comes from humans compared to crawlers.',
    'link_statistics.visitor_type_human' => 'Humans',
    'link_statistics.visitor_type_crawler' => 'Crawlers',
    'link_statistics.acquisition_channel' => 'Acquisition channels',
    'link_statistics.acquisition_channel_help' => 'Discover where your visitors are coming from based on direct, social media, search engines, AI, referring websites, and UTM campaigns.',
    'link_statistics.acquisition_channel.direct' => 'Direct',
    'link_statistics.acquisition_channel.social_media' => 'Social media',
    'link_statistics.acquisition_channel.search_engines' => 'Search engines',
    'link_statistics.acquisition_channel.ai' => 'AI',
    'link_statistics.acquisition_channel.referring_websites' => 'Referring websites',
    'link_statistics.acquisition_channel.utm_campaigns' => 'UTM campaigns',
    ...
    'account_preferences.track_crawlers' => 'Track crawlers',
    'account_preferences.track_crawlers_help' => 'Track detected crawlers and separate them in your links statistics.',
    ...
    'index.subheader' => 'Create powerful QR codes in seconds. Customizable, trackable, and easy to use.',
    'index.qr' => 'QR codes',
    'index.barcode' => 'Barcodes',
    ...
    'index.shortener_app_linking.header' => 'Force open mobile apps',
