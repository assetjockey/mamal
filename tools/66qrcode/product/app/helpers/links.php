...
function get_domain_from_host($host){
    ...
    if(!$myhost) return $myhost;
    if(filter_var($myhost, FILTER_VALIDATE_IP)) return $myhost;

    $parts = explode('.', $myhost);
    $count = count($parts);

    if($count <= 2) return $myhost;
    ...
    $two_part_tlds = [
        ...
        'com.mx', 'com.tr', 'com.cn', 'com.sg', 'com.my', 'com.hk', 'com.tw',
        'com.ar', 'com.pl', 'com.sa', 'com.ua', 'com.ph',
