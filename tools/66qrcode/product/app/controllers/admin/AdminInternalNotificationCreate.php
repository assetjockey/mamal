...
class AdminInternalNotificationCreate extends Controller {
    ...
    public function index() {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                switch($_POST['segment']) {
                    ...
                    case 'filter':
                        ...
                        /* Is subscribed */
                        $_POST['filters_is_broadcast_subscribed'] = isset($_POST['filters_is_broadcast_subscribed']) ? (bool) $_POST['filters_is_broadcast_subscribed'] : 0;

                        if($_POST['filters_is_broadcast_subscribed']) {
                            $has_filters = true;
                ...
                /* Insert data */
                db()->insertBulkInChunks('internal_notifications', $users_batch);
        ...
        $values = [
            ...
            'filters_is_broadcast_subscribed' => $_POST['filters_is_broadcast_subscribed'] ?? [],
