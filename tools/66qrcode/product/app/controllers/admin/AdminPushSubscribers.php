...
class AdminPushSubscribers extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['push_subscriber_id', 'user_id', 'device_type', 'country_code', 'continent_code'], ['ip', 'city_name', 'os_name', 'browser_name', 'browser_language'], ['push_subscriber_id', 'datetime'], allowed_datetime_fields: ['datetime']));
