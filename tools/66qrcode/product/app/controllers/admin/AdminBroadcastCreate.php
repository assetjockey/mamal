...
class AdminBroadcastCreate extends Controller {
    ...
    public function index() {
        ...
        $values = [
            ...
            'broadcast_subscribers_ids' => implode(',', $_POST['broadcast_subscribers_ids'] ?? []),
            ...
            'filters_subscriber_type' => $_POST['filters_subscriber_type'] ?? [],
            'filters_broadcast_subscribers_source' => $_POST['filters_broadcast_subscribers_source'] ?? [],
            ...
            'filters_cities' => isset($_POST['filters_cities']) ? (is_array($_POST['filters_cities']) ? implode(',', $_POST['filters_cities']) : $_POST['filters_cities']) : null,
