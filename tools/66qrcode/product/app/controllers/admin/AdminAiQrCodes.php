...
class AdminAiQrCodes extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['ai_qr_code_id', 'user_id', 'project_id'], ['name'], ['ai_qr_code_id', 'last_datetime', 'name', 'datetime'], allowed_datetime_fields: ['datetime', 'last_datetime']));
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            switch($_POST['type']) {
                case 'delete':
                    ...
                    (new AiQrCode())->bulk_delete($_POST['selected'], null, true);
