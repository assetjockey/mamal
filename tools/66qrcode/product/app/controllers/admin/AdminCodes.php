...
class AdminCodes extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['code_id', 'type'], ['name', 'code'], ['code_id', 'name', 'days', 'quantity', 'datetime', 'last_datetime', 'code', 'redeemed', 'start_datetime', 'end_datetime'], allowed_datetime_fields: ['datetime', 'last_datetime', 'start_datetime', 'end_datetime']));
