...
class AdminApiUsers extends Controller {
    ...
    private function get_all() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'status', 'source', 'plan_id', 'device_type', 'country', 'continent_code', 'type', 'referred_by', 'is_broadcast_subscribed', 'language'], ['name', 'email', 'city_name', 'os_name', 'browser_name', 'browser_language'], ['user_id', 'email', 'datetime', 'last_activity', 'name', 'total_logins', 'plan_expiration_date'], allowed_datetime_fields: ['datetime', 'last_activity']));
        ...
        while($row = $data_result->fetch_object()) {
            ...
            $row = [
                ...
                'is_broadcast_subscribed' => (bool) $row->is_broadcast_subscribed,
                ...
                'plan_renewal_reminder' => (bool) $row->plan_renewal_reminder,
    ...
    private function get() {
        ...
        $data = [
            ...
            'is_broadcast_subscribed' => (bool) $user->is_broadcast_subscribed,
            ...
            'plan_renewal_reminder' => (bool) $user->plan_renewal_reminder,
    ...
    private function patch() {
        ...
        db()->where('user_id', $user->user_id)->update('users', [
            ...
            'plan_renewal_reminder' => $user->plan_expiration_date != $plan_expiration_date ? 0 : $user->plan_renewal_reminder,
