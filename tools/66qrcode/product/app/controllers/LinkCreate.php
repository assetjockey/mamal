...
class LinkCreate extends Controller {
    ...
    public function index() {
        ...
        $values = [
            ...
            'email_reports_is_enabled' => isset($_POST['email_reports_is_enabled']) ? $_POST['email_reports_is_enabled'] : false,
            ...
            'is_se_visible' => $_POST['is_se_visible'] ?? (int) $this->user->plan_settings->search_engine_visibility_is_enabled,
            'password' => $_POST['password'] ?? '',
            'sensitive_content' => $_POST['sensitive_content'] ?? '',
