...
class Pwas extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id',], ['name'], ['pwa_id', 'name', 'last_datetime', 'datetime'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('pwas?' . $filters->get_get() . '&page={{PAGE}}')));
