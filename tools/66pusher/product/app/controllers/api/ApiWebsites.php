...
class ApiWebsites extends Controller {
    ...
    private function get_all() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'domain_id', 'is_enabled'], ['host', 'path', 'name'], ['website_id', 'name', 'last_datetime','datetime', 'host', 'path', 'total_sent_campaigns', 'total_subscribers', 'total_sent_push_notifications', 'total_displayed_push_notifications', 'total_clicked_push_notifications', 'total_closed_push_notifications'], allowed_datetime_fields: ['last_datetime', 'datetime']));
