...
class AdminRssAutomations extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'website_id', 'segment'], ['name', 'title', 'description', 'url', 'rss_url'], ['rss_automation_id', 'name', 'title', 'last_check_datetime', 'next_check_datetime', 'datetime', 'last_datetime', 'total_push_notifications', 'total_sent_push_notifications', 'total_displayed_push_notifications', 'total_clicked_push_notifications', 'total_closed_push_notifications', 'total_campaigns'], allowed_datetime_fields: ['last_check_datetime', 'next_check_datetime', 'datetime', 'last_datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/rss_automations?' . $filters->get_get() . '&page={{PAGE}}')));
