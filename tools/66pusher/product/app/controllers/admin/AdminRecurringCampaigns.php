...
class AdminRecurringCampaigns extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'website_id', 'segment'], ['name', 'title', 'description', 'url'], ['recurring_campaign_id', 'name', 'title', 'last_run_datetime', 'next_run_datetime', 'datetime', 'last_datetime', 'total_push_notifications', 'total_sent_push_notifications', 'total_displayed_push_notifications', 'total_clicked_push_notifications', 'total_closed_push_notifications', 'total_campaigns'], allowed_datetime_fields: ['last_run_datetime', 'next_run_datetime', 'datetime', 'last_datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/recurring_campaigns?' . $filters->get_get() . '&page={{PAGE}}')));
