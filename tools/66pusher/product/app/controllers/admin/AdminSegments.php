...
class AdminSegments extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['website_id', 'type', 'segment_id'], ['name',], ['segment_id', 'name', 'datetime', 'last_datetime', 'total_subscribers'], allowed_datetime_fields: ['datetime', 'last_datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/segments?' . $filters->get_get() . '&page={{PAGE}}')));
