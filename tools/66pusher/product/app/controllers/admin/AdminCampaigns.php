...
class AdminCampaigns extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['website_id', 'status', 'segment', 'user_id', 'rss_automation_id'], ['name', 'title', 'description', 'url',], ['campaign_id', 'name', 'title', 'datetime', 'last_sent_datetime', 'scheduled_datetime', 'last_datetime', 'total_push_notifications', 'total_sent_push_notifications', 'total_displayed_push_notifications', 'total_clicked_push_notifications', 'total_closed_push_notifications'], allowed_datetime_fields: ['datetime', 'last_sent_datetime', 'scheduled_datetime', 'last_datetime']));
