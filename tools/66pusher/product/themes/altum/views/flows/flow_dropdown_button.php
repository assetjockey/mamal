...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'flow_duplicate_modal', 'resource_id' => 'flow_id', 'path' => 'flows/duplicate']), 'modals', 'flow_duplicate_modal'); ?>
