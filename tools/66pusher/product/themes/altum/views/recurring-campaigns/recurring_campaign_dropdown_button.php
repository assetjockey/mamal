...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'recurring_campaign_duplicate_modal', 'resource_id' => 'recurring_campaign_id', 'path' => 'recurring-campaigns/duplicate']), 'modals', 'recurring_campaign_duplicate_modal'); ?>
