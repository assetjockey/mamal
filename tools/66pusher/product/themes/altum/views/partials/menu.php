...
<nav class="navbar navbar-main navbar-expand-lg navbar-light bg-white border border-gray-100 mt-4 rounded-2x <?= \Altum\Router::$controller_key == 'index' ? null : 'mb-6' ?>">
    <div class="container">
        <a
                href="<?= url() ?>"
