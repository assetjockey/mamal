                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/subscribers-logs/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.search_by'), '<code>' . implode('</code>, <code>', ['ip']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', ['clicked_notification','closed_notification','displayed_notification','expired_deleted','manually_deleted','permission_denied','push_notification_sent','subscribed','unsubscribed']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['subscriber_log_id','datetime']) . '</code>') ?></td>
                            </tr>
