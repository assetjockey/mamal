                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/flows/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', ['last_sent_datetime', 'datetime', 'last_datetime']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['flow_id', 'datetime', 'last_datetime', 'last_sent_datetime', 'name', 'title', 'total_push_notifications', 'total_sent_push_notifications', 'total_displayed_push_notifications', 'total_clicked_push_notifications', 'total_closed_push_notifications']) . '</code>') ?></td>
                            </tr>
            ...
            <div id="read" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/flows/</span><span class="text-primary">{flow_id}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#flows_create" aria-expanded="true" aria-controls="flows_create">
            ...
            <div id="flows_create" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/flows</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#flows_update" aria-expanded="true" aria-controls="flows_update">
            ...
            <div id="flows_update" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/flows/</span><span class="text-primary">{flow_id}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#flows_delete" aria-expanded="true" aria-controls="flows_delete">
            ...
            <div id="flows_delete" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-danger user-select-none mr-3">DELETE</span> <span class="text-muted"><?= SITE_URL ?>api/flows/</span><span class="text-primary">{flow_id}</span>
                            </div>
                        </div>
                    </div>
