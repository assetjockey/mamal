        ...
        <div class="card-body">
            ...
            <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group" data-type="filter">
                    ...
                    <input type="text" id="filters_subscribed_on_url" name="filters_subscribed_on_url" value="<?= $data->segment->settings->filters_subscribed_on_url ?? '' ?>" maxlength="2048" class="form-control" placeholder="<?= l('global.url_placeholder') ?>" />
                    <?= \Altum\Alerts::output_field_error('filters_subscribed_on_url') ?>
                </div>

                <div class="form-group" data-type="filter">
                    <label for="filters_datetime_condition"><i class="fas fa-fw fa-sm fa-calendar-plus text-muted mr-1"></i> <?= l('global.datetime') ?></label>

                    <div class="form-row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <select id="filters_datetime_condition" name="filters_datetime_condition" class="form-control">
                                <option value=" "><?= l('global.none') ?></option>
                                <option value="within_last" <?= (($data->segment->settings->filters_datetime_condition ?? '') == 'within_last') ? 'selected="selected"' : null ?>><?= l('segments.within_last') ?></option>
                                <option value="older_than" <?= (($data->segment->settings->filters_datetime_condition ?? '') == 'older_than') ? 'selected="selected"' : null ?>><?= l('segments.older_than') ?></option>
                            </select>
                        </div>

                        <div class="col-lg-6">
                            <div class="input-group">
                                <input type="number" min="0" id="filters_datetime_value" name="filters_datetime_value" value="<?= $data->segment->settings->filters_datetime_value ?? '' ?>" class="form-control" placeholder="30" />
                ...
                <div class="form-group" data-type="filter">
                    <label for="filters_last_datetime_condition"><i class="fas fa-fw fa-sm fa-edit text-muted mr-1"></i> <?= l('global.last_datetime') ?></label>

                    <div class="form-row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <select id="filters_last_datetime_condition" name="filters_last_datetime_condition" class="form-control">
                                <option value=" "><?= l('global.none') ?></option>
                                <option value="within_last" <?= (($data->segment->settings->filters_last_datetime_condition ?? '') == 'within_last') ? 'selected="selected"' : null ?>><?= l('segments.within_last') ?></option>
                                <option value="older_than" <?= (($data->segment->settings->filters_last_datetime_condition ?? '') == 'older_than') ? 'selected="selected"' : null ?>><?= l('segments.older_than') ?></option>
                            </select>
                        </div>

                        <div class="col-lg-6">
                            <div class="input-group">
                                <input type="number" min="0" id="filters_last_datetime_value" name="filters_last_datetime_value" value="<?= $data->segment->settings->filters_last_datetime_value ?? '' ?>" class="form-control" placeholder="30" />
                                <div class="input-group-append">
                                    <span class="input-group-text"><?= l('global.date.days') ?></span>
                                </div>
                            </div>
                ...
                <div class="form-group" data-type="filter">
                    <label for="filters_last_seen_online_datetime_condition"><i class="fas fa-fw fa-sm fa-eye text-muted mr-1"></i> <?= l('subscribers.last_seen_online_datetime') ?></label>

                    <div class="form-row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <select id="filters_last_seen_online_datetime_condition" name="filters_last_seen_online_datetime_condition" class="form-control">
                                <option value=" "><?= l('global.none') ?></option>
                                <option value="within_last" <?= (($data->segment->settings->filters_last_seen_online_datetime_condition ?? '') == 'within_last') ? 'selected="selected"' : null ?>><?= l('segments.within_last') ?></option>
                                <option value="older_than" <?= (($data->segment->settings->filters_last_seen_online_datetime_condition ?? '') == 'older_than') ? 'selected="selected"' : null ?>><?= l('segments.older_than') ?></option>
                            </select>
                        </div>

                        <div class="col-lg-6">
                            <div class="input-group">
                                <input type="number" min="0" id="filters_last_seen_online_datetime_value" name="filters_last_seen_online_datetime_value" value="<?= $data->segment->settings->filters_last_seen_online_datetime_value ?? '' ?>" class="form-control" placeholder="30" />
                                <div class="input-group-append">
                                    <span class="input-group-text"><?= l('global.date.days') ?></span>
                                </div>
                            </div>
                ...
                <div class="form-group" data-type="filter">
                    <label for="filters_last_sent_datetime_condition"><i class="fas fa-fw fa-sm fa-rocket text-muted mr-1"></i> <?= l('campaigns.last_sent_datetime') ?></label>

                    <div class="form-row">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <select id="filters_last_sent_datetime_condition" name="filters_last_sent_datetime_condition" class="form-control">
                                <option value=" "><?= l('global.none') ?></option>
                                <option value="within_last" <?= (($data->segment->settings->filters_last_sent_datetime_condition ?? '') == 'within_last') ? 'selected="selected"' : null ?>><?= l('segments.within_last') ?></option>
                                <option value="older_than" <?= (($data->segment->settings->filters_last_sent_datetime_condition ?? '') == 'older_than') ? 'selected="selected"' : null ?>><?= l('segments.older_than') ?></option>
                            </select>
                        </div>

                        <div class="col-lg-6">
                            <div class="input-group">
                                <input type="number" min="0" id="filters_last_sent_datetime_value" name="filters_last_sent_datetime_value" value="<?= $data->segment->settings->filters_last_sent_datetime_value ?? '' ?>" class="form-control" placeholder="30" />
                                <div class="input-group-append">
                                    <span class="input-group-text"><?= l('global.date.days') ?></span>
                                </div>
                            </div>
