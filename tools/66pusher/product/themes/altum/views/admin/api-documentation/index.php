                        ...
                        <table class="table table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', [0, 1, 2]) . '</code>') ?></td>
                                </tr>
                                <tr>
                                    <td>source</td>
                                    <td>
                                    ...
                                    <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', ['direct', 'admin_create', 'admin_api_create', 'facebook', 'twitter', 'discord', 'google', 'linkedin', 'microsoft']) . '</code>') ?></td>
                                </tr>
                                <tr>
                                    <td>plan_id</td>
                                    <td>
                                ...
                                <tr>
                                    <td>is_newsletter_subscribed</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                        ...
                        <table class="table table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">payments.taxes_ids contains the given tax id</span>') ?></td>
                                </tr>
                                <tr>
                                    <td>datetime_field</td>
                                    <td>
...
<div class="mb-5">
    <div class="mb-3">
        <h2 class="h4"><?= l('admin_api_documentation.sso.header') ?></h2>
    </div>
    ...
    <div class="accordion">
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#sso_login" aria-expanded="true" aria-controls="sso_login">
                        <span class="badge badge-info user-select-none mr-3"><i class="fas fa-fw fa-sm fa-sign-in-alt"></i></span> <?= l('admin_api_documentation.sso.login_header') ?>
                    </a>
                </h3>
            </div>

            <div id="sso_login" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>admin-api/sso/login</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">email does not already exist</span>') ?></td>
                                </tr>
                                <tr>
                                    <td>password</td>
                                    <td>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request POST \<br />
                                --url '<?= SITE_URL ?>admin-api/sso/login' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \<br />
                                --header 'Content-Type: multipart/form-data' \<br />
                                --form 'email=<span class="text-primary">john@example.com</span>' \<br />
                                --form 'redirect=<span class="text-primary">dashboard</span>'
                            </div>
                        </div>
                    </div>
    ...
    "data": {
        "one_time_login_code": "7be875f9f1e3e73e1c7a09f186f6b69c",
        "url": "<?= SITE_URL ?>login/one-time-login-code/7be875f9f1e3e73e1c7a09f186f6b69c?redirect=dashboard",
        "id": 1
    }
}</pre>
                    </div>
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#sso_update" aria-expanded="true" aria-controls="sso_update">
                        <span class="badge badge-info user-select-none mr-3"><i class="fas fa-fw fa-sm fa-pencil"></i></span> <?= l('admin_api_documentation.sso.update_header') ?>
                    </a>
                </h3>
            </div>

            <div id="sso_update" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>admin-api/sso/update</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request POST \<br />
                                --url '<?= SITE_URL ?>admin-api/sso/update' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \<br />
                                --header 'Content-Type: multipart/form-data' \<br />
                                --form 'email=<span class="text-primary">john@example.com</span>' \<br />
                                --form 'name=<span class="text-primary">John Doe</span>'
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#sso_delete" aria-expanded="true" aria-controls="sso_delete">
                        <span class="badge badge-danger user-select-none mr-3"><i class="fas fa-fw fa-sm fa-trash-alt"></i></span> <?= l('admin_api_documentation.sso.delete_header') ?>
                    </a>
                </h3>
            </div>

            <div id="sso_delete" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-danger user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>admin-api/sso/delete</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request POST \<br />
                                --url '<?= SITE_URL ?>admin-api/sso/delete' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \<br />
                                --header 'Content-Type: multipart/form-data' \<br />
...
<div class="mb-5">
    <div class="mb-3">
        <h2 class="h4"><?= l('admin_api_documentation.dynamic_og_images.header') ?></h2>
    </div>

    <div class="accordion">

        <!-- dynamic_og_images_create -->
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#dynamic_og_images_create" aria-expanded="true" aria-controls="dynamic_og_images_create">
                        <span class="badge badge-info user-select-none mr-3"><i class="fas fa-fw fa-sm fa-upload"></i></span> <?= l('api_documentation.create') ?>
                    </a>
                </h3>
            </div>

            <div id="dynamic_og_images_create" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info user-select-none mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>admin-api/dynamic-og-images</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request POST \<br />
                                --url '<?= SITE_URL ?>admin-api/dynamic-og-images' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \<br />
                                --header 'Content-Type: multipart/form-data' \<br />
                                --form 'image_name=<span class="text-primary">og-example.webp</span>' \<br />
                                --form 'image=@<span class="text-primary">/path/to/image.webp</span>'
                            </div>
                        </div>
                    </div>
