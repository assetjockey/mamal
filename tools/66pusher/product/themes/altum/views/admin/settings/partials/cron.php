...
<?php foreach(['reset', 'broadcasts', 'campaigns', 'flows', 'flows_notifications', 'personal_notifications', 'rss_automations', 'recurring_campaigns'] as $cron): ?>
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <?php if(in_array($cron, ['campaigns', 'flows', 'flows_notifications', 'personal_notifications', 'rss_automations', 'recurring_campaigns'])): ?>
            <div class="input-group-append">
                <a
                        href="<?= url('admin/settings/websites') ?>"
                        class="btn btn-light"
                        data-toggle="tooltip"
