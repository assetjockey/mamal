...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'rss_automation_duplicate_modal', 'resource_id' => 'rss_automation_id', 'path' => 'rss-automations/duplicate']), 'modals', 'rss_automation_duplicate_modal'); ?>
