...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/statistics_reset_modal.php', ['modal_id' => 'notification_statistics_reset_modal', 'resource_id' => 'notification_id', 'path' => 'notification/' . $data->notification->notification_id . '/statistics/reset']), 'modals'); ?>
