...
<div class="collapse" id="agent_name_translate_container" data-translation-container="agent_name">
    <?= htmlspecialchars(json_encode(isset($data->notification->settings->translations->agent_name) ? $data->notification->settings->translations->agent_name : ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<div class="collapse" id="agent_description_translate_container" data-translation-container="agent_description">
    <?= htmlspecialchars(json_encode(isset($data->notification->settings->translations->agent_description) ? $data->notification->settings->translations->agent_description : ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<div class="collapse" id="agent_message_translate_container" data-translation-container="agent_message">
    <?= htmlspecialchars(json_encode(isset($data->notification->settings->translations->agent_message) ? $data->notification->settings->translations->agent_message : ''), ENT_QUOTES, 'UTF-8') ?>
</div>

<div class="form-group">
    <label for="settings_agent_facebook_messenger"><i class="fab fa-fw fa-sm fa-facebook-messenger text-muted mr-1"></i> <?= l('notification.settings.agent_facebook_messenger') ?></label>
    <div class="input-group">
        <input type="text" id="settings_agent_facebook_messenger" name="agent_facebook_messenger" class="form-control" value="<?= $data->notification->settings->agent_facebook_messenger ?>" maxlength="64" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#agent_facebook_messenger_translate_container" aria-expanded="false" aria-controls="agent_facebook_messenger_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="agent_facebook_messenger_translate_container" data-translation-container="agent_facebook_messenger">
    <?= htmlspecialchars(json_encode(isset($data->notification->settings->translations->agent_facebook_messenger) ? $data->notification->settings->translations->agent_facebook_messenger : ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-title').text($(event.currentTarget).val());
    });

    $('#settings_agent_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-window-header-image').attr('src', $(event.currentTarget).val());
    });

    $('#settings_agent_name').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-window-header-title').text($(event.currentTarget).val());
        $('#notification_preview .altumcode-facebook-messenger-chat-window-content-reply-author').text($(event.currentTarget).val());
    });

    $('#settings_agent_description').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-window-header-description').text($(event.currentTarget).val());
    });

    $('#settings_agent_message').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-window-content-reply-text').text($(event.currentTarget).val());
    });

    $('#settings_button_text').on('change paste keyup', event => {
        $('#notification_preview .altumcode-facebook-messenger-chat-window-footer-button').text($(event.currentTarget).val());
    });

    /* Light mode */
    init_color_pickr('#settings_header_agent_name_color', '#settings_header_agent_name_color_pickr', '.altumcode-facebook-messenger-chat-window-header-title', 'color', 'light', 'header_agent_name');
    init_color_pickr('#settings_header_agent_description_color', '#settings_header_agent_description_color_pickr', '.altumcode-facebook-messenger-chat-window-header-description', 'color', 'light', 'header_agent_description');
    init_color_pickr('#settings_header_background_color', '#settings_header_background_color_pickr', '.altumcode-facebook-messenger-chat-window-header', 'background-color', 'light', 'header_background');

    init_color_pickr('#settings_content_agent_name_color', '#settings_content_agent_name_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply-author', 'color', 'light', 'content_agent_name');
    init_color_pickr('#settings_content_agent_message_color', '#settings_content_agent_message_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply-text', 'color', 'light', 'content_agent_message');
    init_color_pickr('#settings_content_agent_message_background_color', '#settings_content_agent_message_background_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply', 'background-color', 'light', 'content_agent_message_background');
    init_color_pickr('#settings_content_background_color', '#settings_content_background_color_pickr', '.altumcode-facebook-messenger-chat-window-content', 'background-color', 'light', 'content_background');

    init_color_pickr('#settings_footer_button_color', '#settings_footer_button_color_pickr', '.altumcode-facebook-messenger-chat-window-footer-button', 'color', 'light', 'footer_button');
    init_color_pickr('#settings_footer_button_background_color', '#settings_footer_button_background_color_pickr', '.altumcode-facebook-messenger-chat-window-footer-button', 'background-color', 'light', 'footer_button_background');
    init_color_pickr('#settings_footer_background_color', '#settings_footer_background_color_pickr', '.altumcode-facebook-messenger-chat-window-footer', 'background-color', 'light', 'footer_background');

    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-facebook-messenger-chat-title', 'color', 'light', 'title');
    ...
    /* Dark mode  */
    init_color_pickr('#dark_mode_header_agent_name_color', '#dark_mode_header_agent_name_color_pickr', '.altumcode-facebook-messenger-chat-window-header-title', 'color', 'dark', 'header_agent_name');
    init_color_pickr('#dark_mode_header_agent_description_color', '#dark_mode_header_agent_description_color_pickr', '.altumcode-facebook-messenger-chat-window-header-description', 'color', 'dark', 'header_agent_description');
    init_color_pickr('#dark_mode_header_background_color', '#dark_mode_header_background_color_pickr', '.altumcode-facebook-messenger-chat-window-header', 'background-color', 'dark', 'header_background');

    init_color_pickr('#dark_mode_content_agent_name_color', '#dark_mode_content_agent_name_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply-author', 'color', 'dark', 'content_agent_name');
    init_color_pickr('#dark_mode_content_agent_message_color', '#dark_mode_content_agent_message_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply-text', 'color', 'dark', 'content_agent_message');
    init_color_pickr('#dark_mode_content_agent_message_background_color', '#dark_mode_content_agent_message_background_color_pickr', '.altumcode-facebook-messenger-chat-window-content-reply', 'background-color', 'dark', 'content_agent_message_background');
    init_color_pickr('#dark_mode_content_background_color', '#dark_mode_content_background_color_pickr', '.altumcode-facebook-messenger-chat-window-content', 'background-color', 'dark', 'content_background');

    init_color_pickr('#dark_mode_footer_button_color', '#dark_mode_footer_button_color_pickr', '.altumcode-facebook-messenger-chat-window-footer-button', 'color', 'dark', 'footer_button');
    init_color_pickr('#dark_mode_footer_button_background_color', '#dark_mode_footer_button_background_color_pickr', '.altumcode-facebook-messenger-chat-window-footer-button', 'background-color', 'dark', 'footer_button_background');
    init_color_pickr('#dark_mode_footer_background_color', '#dark_mode_footer_background_color_pickr', '.altumcode-facebook-messenger-chat-window-footer', 'background-color', 'dark', 'footer_background');

    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-facebook-messenger-chat-title', 'color', 'dark', 'title');
