...
<div class="form-group">
    <label for="settings_activity_type"><i class="fas fa-fw fa-th fa-sm text-muted mr-1"></i> <?= l('notification.settings.activity_type') ?></label>
    <div class="row btn-group-toggle m-n2" data-toggle="buttons">
        <div class="col-12 col-lg-6 p-2">
            <label class="btn btn-light btn-block font-size-small text-truncate mb-0 <?= $data->notification->settings->activity_type == 'all' ? 'active"' : null?>">
                <input type="radio" name="activity_type" value="all" class="custom-control-input" <?= $data->notification->settings->activity_type == 'all' ? 'checked="checked"' : null?> />
                <i class="fas fa-fw fa-globe fa-sm mr-1"></i> <?= l('notification.settings.activity_type.all') ?>
            </label>
        </div>

        <div class="col-12 col-lg-6 p-2">
            <label class="btn btn-light btn-block font-size-small text-truncate mb-0 <?= $data->notification->settings->activity_type == 'page' ? 'active"' : null?>">
                <input type="radio" name="activity_type" value="page" class="custom-control-input" <?= $data->notification->settings->activity_type == 'page' ? 'checked="checked"' : null?> />
                <i class="fas fa-fw fa-pager fa-sm mr-1"></i> <?= l('notification.settings.activity_type.page') ?>
            </label>
        </div>
    </div>
</div>
