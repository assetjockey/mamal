...
<div class="form-group">
    <label for="settings_selector"><i class="fas fa-fw fa-crosshairs fa-sm text-muted mr-1"></i> <?= l('notification.inline_informational.selector') ?></label>
    ...
    <small class="form-text text-muted"><?= l('notification.inline_informational.selector_help') ?></small>
</div>

<div class="form-group">
    <label for="settings_inline_placement"><i class="fas fa-fw fa-arrows-alt-v fa-sm text-muted mr-1"></i> <?= l('notification.inline_informational.placement') ?></label>
    <select id="settings_inline_placement" name="inline_placement" class="custom-select">
        <option value="append" <?= $data->notification->settings->inline_placement == 'append' ? 'selected="selected"' : null ?>><?= l('notification.inline_informational.placement_append') ?></option>
        <option value="prepend" <?= $data->notification->settings->inline_placement == 'prepend' ? 'selected="selected"' : null ?>><?= l('notification.inline_informational.placement_prepend') ?></option>
        <option value="before" <?= $data->notification->settings->inline_placement == 'before' ? 'selected="selected"' : null ?>><?= l('notification.inline_informational.placement_before') ?></option>
        <option value="after" <?= $data->notification->settings->inline_placement == 'after' ? 'selected="selected"' : null ?>><?= l('notification.inline_informational.placement_after') ?></option>
    </select>
</div>
...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-informational-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-informational-description').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-informational-image').attr('src', $(event.currentTarget).val());
    });
    ...
    /* Light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-inline-informational-title, #notification_preview .altumcode-inline-informational-arrow', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-inline-informational-description', 'color', 'light', 'description');
    ...
    /* Dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-inline-informational-title, #notification_preview .altumcode-inline-informational-arrow', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-inline-informational-description', 'color', 'dark', 'description');
