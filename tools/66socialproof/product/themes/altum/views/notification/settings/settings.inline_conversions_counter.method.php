...
<div class="form-group">
    <label for="settings_last_activity"><i class="fas fa-fw fa-sm fa-user-clock text-muted mr-1"></i> <?= l('notification.settings.last_activity') ?></label>
    <div class="input-group">
...
<div class="form-group">
    <label for="settings_selector"><i class="fas fa-fw fa-crosshairs fa-sm text-muted mr-1"></i> <?= l('notification.inline_conversions_counter.selector') ?></label>
    ...
    <small class="form-text text-muted"><?= l('notification.inline_conversions_counter.selector_help') ?></small>
</div>

<div class="form-group">
    <label for="settings_inline_placement"><i class="fas fa-fw fa-arrows-alt-v fa-sm text-muted mr-1"></i> <?= l('notification.inline_conversions_counter.placement') ?></label>
    <select id="settings_inline_placement" name="inline_placement" class="custom-select">
        <option value="append" <?= $data->notification->settings->inline_placement == 'append' ? 'selected="selected"' : null ?>><?= l('notification.inline_conversions_counter.placement_append') ?></option>
        <option value="prepend" <?= $data->notification->settings->inline_placement == 'prepend' ? 'selected="selected"' : null ?>><?= l('notification.inline_conversions_counter.placement_prepend') ?></option>
        <option value="before" <?= $data->notification->settings->inline_placement == 'before' ? 'selected="selected"' : null ?>><?= l('notification.inline_conversions_counter.placement_before') ?></option>
        <option value="after" <?= $data->notification->settings->inline_placement == 'after' ? 'selected="selected"' : null ?>><?= l('notification.inline_conversions_counter.placement_after') ?></option>
    </select>
</div>
...
<div class="form-group">
    <label for="settings_display_minimum_activity"><i class="fas fa-fw fa-sm fa-users text-muted mr-1"></i> <?= l('notification.settings.display_minimum_activity') ?></label>
    <div class="input-group">
        ...
        <div class="input-group-append">
            <span class="input-group-text"><?= l('notification.settings.display_minimum_activity_visitors') ?></span>
        </div>
    </div>
...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-conversions-counter-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-conversions-counter-description').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-inline-conversions-counter-image').attr('src', $(event.currentTarget).val());
    });
    ...
    /* Light mode */
    init_color_pickr('#settings_number_color', '#settings_number_color_pickr', '.altumcode-inline-conversions-counter-number', 'color', 'light', 'number');
    init_color_pickr('#settings_number_background_color', '#settings_number_background_color_pickr', '.altumcode-inline-conversions-counter-number', 'background-color', 'light', 'number_background');
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-inline-conversions-counter-title, #notification_preview .altumcode-inline-conversions-counter-arrow', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-inline-conversions-counter-description', 'color', 'light', 'title');
    ...
    /* Dark mode */
    init_color_pickr('#dark_mode_number_color', '#dark_mode_number_color_pickr', '.altumcode-inline-conversions-counter-number', 'color', 'dark', 'number');
    init_color_pickr('#dark_mode_number_background_color', '#dark_mode_number_background_color_pickr', '.altumcode-inline-conversions-counter-number', 'background-color', 'dark', 'number_background');
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-inline-conversions-counter-title, #notification_preview .altumcode-inline-conversions-counter-arrow', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-inline-conversions-counter-description', 'color', 'dark', 'description');
