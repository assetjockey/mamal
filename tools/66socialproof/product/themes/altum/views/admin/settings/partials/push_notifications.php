    ...
    <div <?= !\Altum\Plugin::is_active('push-notifications') ? 'data-toggle="tooltip" title="' . sprintf(l('admin_plugins.no_access'), \Altum\Plugin::get('push-notifications')->name ?? 'push-notifications') . '"' : null ?>>
        <div class="<?= !\Altum\Plugin::is_active('push-notifications') ? 'container-disabled' : null ?>">
            ...
            <div class="form-group">
                <label for="ask_to_subscribe_delay"><i class="fas fa-fw fa-sm fa-clock text-muted mr-1"></i> <?= l('admin_settings.push_notifications.ask_to_subscribe_delay') ?></label>
            ...
            <div class="form-group">
                <label for="ask_to_subscribe_delay_minimum_pageviews_count"><i class="fas fa-fw fa-sm fa-eye text-muted mr-1"></i> <?= l('admin_settings.push_notifications.ask_to_subscribe_delay_minimum_pageviews_count') ?></label>
                <div class="input-group">
            ...
            <div class="collapse" id="cron_settings_container">
                ...
                <div class="form-group">
                    <label for="notifications_per_cron"><i class="fas fa-fw fa-sm fa-bell text-muted mr-1"></i> <?= l('admin_settings.push_notifications.notifications_per_cron') ?></label>
                ...
                <div class="form-group">
                    <label for="notifications_per_cron_batch"><i class="fas fa-fw fa-sm fa-bell text-muted mr-1"></i> <?= l('admin_settings.push_notifications.notifications_per_cron_batch') ?></label>
                ...
                <div class="form-group">
                    <label for="notifications_per_cron_batch_concurrently"><i class="fas fa-fw fa-sm fa-bell text-muted mr-1"></i> <?= l('admin_settings.push_notifications.notifications_per_cron_batch_concurrently') ?></label>
