        ...
        <div class="<?= !\Altum\Plugin::is_active('offload') ? 'container-disabled' : null ?>">
            ...
            <div class="collapse" data-parent="#offload" id="offload_container">
                <div class="form-group">
                    <label for="uploads_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.uploads_url') ?></label>
                ...
                <div class="form-group">
                    <label for="assets_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.assets_url') ?></label>
                ...
                <div class="form-group">
                    <label for="provider"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.offload.provider') ?></label>
                ...
                <div id="provider_others" class="form-group">
                    <label for="endpoint_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.endpoint_url') ?></label>
                ...
                <div class="form-group">
                    <label for="access_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.offload.access_key') ?></label>
                ...
                <div class="form-group">
                    <label for="secret_access_key"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.offload.secret_access_key') ?></label>
                ...
                <div class="form-group">
                    <label for="storage_name"><i class="fas fa-fw fa-sm fa-database text-muted mr-1"></i> <?= l('admin_settings.offload.storage_name') ?></label>
                ...
                <div class="form-group">
                    <label for="region"><i class="fas fa-fw fa-sm fa-globe text-muted mr-1"></i> <?= l('admin_settings.offload.region') ?></label>
            ...
            <div class="collapse" data-parent="#offload" id="cdn_container">
                <div class="form-group">
                    <label for="cdn_uploads_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.cdn_uploads_url') ?></label>
                ...
                <div class="form-group">
                    <label for="cdn_assets_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.cdn_assets_url') ?></label>
                ...
                <div class="form-group">
                    <label for="cdn_origin_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.offload.cdn_origin_url') ?></label>
