...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="username"><i class="fas fa-fw fa-sm fa-user text-muted mr-1"></i> <?= l('admin_settings.klarna.username') ?></label>
            <input id="username" type="text" name="username" class="form-control" value="<?= settings()->klarna->username ?>" />
        </div>

        <div class="form-group">
            <label for="password"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.klarna.password') ?></label>
