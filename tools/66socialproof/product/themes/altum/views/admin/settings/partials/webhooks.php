...
<div id="webhooks">
    ...
    <div class="collapse" data-parent="#webhooks" id="users_container">
        <div class="form-group">
            <label for="user_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_new') ?></label>
        ...
        <div class="form-group">
            <label for="user_update"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_update') ?></label>
        ...
        <div class="form-group">
            <label for="user_delete"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.user_delete') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="payments_container">
        <div class="form-group">
            <label for="payment_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.payment_new') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="codes_container">
        <div class="form-group">
            <label for="code_redeemed"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.code_redeemed') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="contact_form_container">
        <div class="form-group">
            <label for="contact"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.contact') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="cron_container">
        <div class="form-group">
            <label for="cron_start"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.cron_start') ?></label>
        ...
        <div class="form-group">
            <label for="cron_end"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.cron_end') ?></label>
    ...
    <div class="collapse" data-parent="#webhooks" id="domains_container">
        <div class="form-group">
            <label for="domain_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.domain_new') ?></label>
        ...
        <div class="form-group">
            <label for="domain_update"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.domain_update') ?></label>
    ...
    <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#campaigns_container" aria-expanded="false" aria-controls="campaigns_container">
        <i class="fas fa-fw fa-pager fa-sm mr-1"></i> <?= l('admin_campaigns.title') ?>
    </button>

    <div class="collapse" data-parent="#webhooks" id="campaigns_container">
        <div class="form-group">
            <label for="campaign_new"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.campaign_new') ?></label>
            <input id="campaign_new" type="url" name="campaign_new" class="form-control" value="<?= settings()->webhooks->campaign_new ?>" placeholder="<?= l('global.url_placeholder') ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['user_id', 'campaign_id', 'domain_id', 'domain', 'datetime']) . '</code>') ?></small>
        </div>

        <div class="form-group">
            <label for="campaign_update"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.webhooks.campaign_update') ?></label>
            <input id="campaign_update" type="url" name="campaign_update" class="form-control" value="<?= settings()->webhooks->campaign_update ?>" placeholder="<?= l('global.url_placeholder') ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.webhooks.help'), '<code>' . implode('</code>, <code>', ['user_id', 'campaign_id', 'domain_id', 'domain', 'datetime']) . '</code>') ?></small>
        </div>
    </div>
</div>
