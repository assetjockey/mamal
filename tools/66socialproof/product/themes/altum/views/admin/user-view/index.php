        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/campaigns?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notifications?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_notification_handlers.menu') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notification-handlers?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="notification_handlers">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>
                </div>
