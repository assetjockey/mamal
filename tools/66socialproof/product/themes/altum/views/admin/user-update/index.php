                    ...
                    <?php foreach(require APP_PATH . 'includes/enabled_notifications.php' as $notification_type => $notification_config): ?>
                        ...
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="enabled_notifications_<?= $notification_type ?>" name="enabled_notifications[]" value="<?= $notification_type ?>" type="checkbox" class="custom-control-input" <?= $notification_is_enabled ? 'checked="checked"' : null ?>>
