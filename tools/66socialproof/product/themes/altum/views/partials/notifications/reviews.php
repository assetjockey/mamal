...
new AltumCodeManager({
    ...
    infinite_rotation: <?= json_encode($notification->settings->infinite_rotation ?? false) ?>,
    infinite_rotation_interval: <?= (int) (($notification->settings->infinite_rotation_count ?? 0) * (($notification->settings->display_duration == -1 ? 0 : $notification->settings->display_duration) + ($notification->settings->in_between_delay ?? 0)) * 1000) ?>,
