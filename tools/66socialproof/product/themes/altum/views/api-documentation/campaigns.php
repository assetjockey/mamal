                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.search_by'), '<code>' . implode('</code>, <code>', ['name', 'domain']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['campaign_id', 'datetime', 'last_datetime', 'name', 'domain']) . '</code>') ?></td>
                            </tr>
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#create" aria-expanded="true" aria-controls="create">
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#update" aria-expanded="true" aria-controls="update">
