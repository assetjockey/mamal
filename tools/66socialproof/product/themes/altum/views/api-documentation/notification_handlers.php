                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <?php if(settings()->notification_handlers->ntfy_is_enabled): ?>
                                <tr>
                                    <td>ntfy</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                    ...
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = ntfy</span>') ?> <?= l('notification_handlers.ntfy') ?></td>
                                </tr>
                            <?php endif ?>
                            ...
                            <?php if(settings()->notification_handlers->sixsixtext_send_sms_is_enabled): ?>
                                <tr>
                                    <td>sixsixtext_send_sms_api_key</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-signature mr-1"></i> <?= l('api_documentation.string') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_send_sms</span>') ?> <?= sprintf(l('notification_handlers.sixsixtext_api_key'), settings()->notification_handlers->sixsixtext_name) ?></td>
                                </tr>
                                <tr>
                                    <td>sixsixtext_send_sms_device_id</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-hashtag mr-1"></i> <?= l('api_documentation.int') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_send_sms</span>') ?> <?= l('notification_handlers.sixsixtext_device_id') ?></td>
                                </tr>
                                <tr>
                                    <td>sixsixtext_send_sms_device_sim_subscription_id</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-hashtag mr-1"></i> <?= l('api_documentation.int') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_send_sms</span>') ?> <?= l('notification_handlers.sixsixtext_device_sim_subscription_id') ?></td>
                                </tr>
                                <tr>
                                    <td>sixsixtext_send_sms_phone_number</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-signature mr-1"></i> <?= l('api_documentation.string') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_send_sms</span>') ?> <?= l('notification_handlers.sixsixtext_phone_number') ?></td>
                                </tr>
                            <?php endif ?>

                            <?php if(settings()->notification_handlers->sixsixtext_save_contact_is_enabled): ?>
                                <tr>
                                    <td>sixsixtext_save_contact_api_key</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-signature mr-1"></i> <?= l('api_documentation.string') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_save_contact</span>') ?> <?= sprintf(l('notification_handlers.sixsixtext_api_key'), settings()->notification_handlers->sixsixtext_name) ?></td>
                                </tr>
                                <tr>
                                    <td>sixsixtext_save_contact_phone_number</td>
                                    <td>
                                        <span class="badge badge-info"><i class="fas fa-fw fa-sm fa-circle-notch mr-1"></i> <?= l('api_documentation.optional') ?></span>
                                        <span class="badge badge-secondary"><i class="fas fa-fw fa-sm fa-signature mr-1"></i> <?= l('api_documentation.string') ?></span>
                                    </td>
                                    <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = sixsixtext_save_contact</span>') ?> <?= l('notification_handlers.sixsixtext_test_phone_number') ?></td>
                                </tr>
                            <?php endif ?>
                            </tbody>
                        </table>
