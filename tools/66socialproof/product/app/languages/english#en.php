...
return [
	...
	'global.emails.user_data_send.subject' => 'New data for \'{{NOTIFICATION_NAME}}\' in \'{{CAMPAIGN_NAME}}\' - {{WEBSITE_TITLE}}',
	'global.emails.user_data_send.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />New data was collected from your <strong>{{NOTIFICATION_NAME}}</strong> notification in the <strong>{{CAMPAIGN_NAME}}</strong> campaign.{{DATA}}<a href="{{DATA_LINK}}" class="cta">View collected data</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
    ...
    'global.plan_settings.notification_handlers_ntfy_limit' => '%s ntfy handlers',
    ...
    'campaigns.email_reports_is_enabled_help' => 'Receive campaign analytics reports via email.',
    ...
    'notification.settings.tab_themes' => 'Themes',
    'notification.settings.tab_data' => 'Data',
    'notification.settings.themes' => 'Themes',
    'notification.settings.themes_choose' => 'Choose a theme',
    'notification.settings.theme_apply' => 'Apply theme',
    ...
    'notification.settings.activity_type' => 'Count data from',
    'notification.settings.activity_type.all' => 'All pages',
    'notification.settings.activity_type.page' => 'Current page only',
    ...
    'notification.settings.infinite_rotation' => 'Infinite rotation',
    'notification.settings.infinite_rotation_help' => 'Automatically restart the sequence after the last item finishes displaying.',
    'notification.settings.reviews_count' => 'How many reviews to show?',
    'notification.settings.average_rating' => 'Average rating',
    'notification.settings.fallback_average_rating' => 'Fallback average rating',
    'notification.settings.fallback_reviews_count' => 'Fallback reviews count',
    'notification.settings.rating_summary_description_help' => 'Available variables: <code>{average_rating}</code>, <code>{count}</code>.',
    'notification.settings.display_minimum_reviews' => 'Minimum reviews to display',
    'notification.settings.display_minimum_reviews_help' => 'The widget will only display when it has at least this many reviews.',
    'notification.settings.rating_color' => 'Rating color',
    'notification.settings.rating_background_color' => 'Rating background color',
    'notification.settings.stars_color' => 'Stars color',
    ...
    'notification.settings.html_help2' => 'Use <code>data-track-click</code> parameter on button or link elements to allow for tracking clicks.',
    ...
    'notification.settings.agent_telegram' => 'Agent Telegram username',
    'notification.settings.agent_facebook_messenger' => 'Agent Messenger username / page ID',
    ...
    'notification.settings.display_trigger_target_visible' => 'Target element visible',
    'notification.settings.display_trigger_target_visible_selector' => 'Target CSS selector',
    'notification.settings.display_trigger_target_visible_delay' => 'Delay after visibility',
    'notification.settings.display_trigger_target_visible_help' => 'CSS selector: #id or .class of the element that must become visible in the viewport.',
    ...
    'notification.settings.display_minimum_activity_visitors' => 'visitors',
    ...
    'notification.settings.margins' => 'Margins',
    'notification.settings.margin_top' => 'Top margin',
    'notification.settings.margin_right' => 'Right margin',
    'notification.settings.margin_bottom' => 'Bottom margin',
    'notification.settings.margin_left' => 'Left margin',
    'notification.settings.margins_help' => 'Use a CSS length such as 12px, 1rem, 2em, 5%, 0, or auto. Negative values are supported.',
    ...
    'notification.settings.image_size' => 'Image size',
    ...
    'notification.settings.help_center_items' => 'FAQ items',
    'notification.settings.question' => 'Question',
    'notification.settings.answer' => 'Answer',
    'notification.settings.url_text' => 'URL text',
    'notification.settings.badge_text' => 'Badge text',
    'notification.settings.hint_text' => 'Hint text',
    'notification.settings.badge_background_color' => 'Badge background color',
    'notification.settings.badge_color' => 'Badge color',
    'notification.settings.hint_background_color' => 'Hint background color',
    'notification.settings.hint_color' => 'Hint color',
    'notification.settings.item_question_color' => 'Item question color',
    'notification.settings.item_answer_color' => 'Item answer color',
    'notification.settings.item_background_color' => 'Item background color',
    'notification.settings.item_border_color' => 'Item border color',
    ...
    'notification.settings.data_info' => 'All caught data will be recorded in the Data section of this notification.',
    ...
    'notification.statistics.header_top_pages' => 'Page performance',
    'notification.statistics.subheader_top_pages' => 'Pages with the highest notification activity and conversion rates.',
    'notification.statistics.header_notifications_performance' => 'Notifications performance',
    'notification.statistics.subheader_notifications_performance' => 'Notifications ranked by submissions, clicks, and impressions for this date range.',
	...
	'notification.simple_notification' => 'New data received from the \'%1$s\' notification in the \'%2$s\' campaign.%3$s🔗 View collected data: %4$s.',
	'notification.push_notification.title' => 'New notification data',
    ...
    'notification.inline_informational.name' => 'Inline informational',
    'notification.inline_informational.description' => 'Contextual social proof embedded next to existing website content.',
    'notification.inline_informational.icon' => 'fas fa-fw fa-code',
    'notification.inline_informational.title_default' => 'Trusted by 5,000+ businesses',
    'notification.inline_informational.description_default' => 'Join growing teams that already use our platform.',
    'notification.inline_informational.image_default' => '',
    'notification.inline_informational.selector' => 'Target CSS selector',
    'notification.inline_informational.selector_help' => 'The notification is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_informational.placement' => 'Placement',
    'notification.inline_informational.placement_append' => 'Inside, at the end',
    'notification.inline_informational.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_informational.placement_before' => 'Before the element',
    'notification.inline_informational.placement_after' => 'After the element',

    'notification.inline_reviews.name' => 'Inline reviews',
    'notification.inline_reviews.description' => 'Display rotating reviews embedded next to existing website content.',
    'notification.inline_reviews.icon' => 'fas fa-fw fa-quote-left',
    'notification.inline_reviews.selector' => 'Target CSS selector',
    'notification.inline_reviews.selector_help' => 'The review is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_reviews.placement' => 'Placement',
    'notification.inline_reviews.placement_append' => 'Inside, at the end',
    'notification.inline_reviews.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_reviews.placement_before' => 'Before the element',
    'notification.inline_reviews.placement_after' => 'After the element',

    'notification.inline_rating_summary.name' => 'Inline rating summary',
    'notification.inline_rating_summary.description' => 'Display an embedded average rating summary based on your review data.',
    'notification.inline_rating_summary.icon' => 'fas fa-fw fa-star-half-alt',
    'notification.inline_rating_summary.selector' => 'Target CSS selector',
    'notification.inline_rating_summary.selector_help' => 'The rating summary is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_rating_summary.placement' => 'Placement',
    'notification.inline_rating_summary.placement_append' => 'Inside, at the end',
    'notification.inline_rating_summary.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_rating_summary.placement_before' => 'Before the element',
    'notification.inline_rating_summary.placement_after' => 'After the element',
    ...
    'notification.live_counter_bar.name' => 'Live counter bar',
    'notification.live_counter_bar.description' => 'Display online visitors counter in a top or bottom bar.',
    'notification.live_counter_bar.icon' => 'fas fa-fw fa-globe',
    'notification.live_counter_bar.description_default' => '<span style="font-weight:700;">{COUNTER}</span> active visitors right now',
    'notification.live_counter_bar.number_default' => '15',

    'notification.inline_live_counter.name' => 'Inline live counter',
    'notification.inline_live_counter.description' => 'Display online visitors counter next to existing website content.',
    'notification.inline_live_counter.icon' => 'fas fa-fw fa-globe',
    'notification.inline_live_counter.description_default' => '<span style="font-weight:700;">{COUNTER}</span> active visitors',
    'notification.inline_live_counter.number_default' => '15',
    'notification.inline_live_counter.selector' => 'Target CSS selector',
    'notification.inline_live_counter.selector_help' => 'The live counter is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_live_counter.placement' => 'Placement',
    'notification.inline_live_counter.placement_append' => 'Inside, at the end',
    'notification.inline_live_counter.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_live_counter.placement_before' => 'Before the element',
    'notification.inline_live_counter.placement_after' => 'After the element',
    ...
    'notification.inline_conversions.name' => 'Inline conversions',
    'notification.inline_conversions.description' => 'Display recent conversions next to existing website content.',
    'notification.inline_conversions.icon' => 'fas fa-fw fa-funnel-dollar',
    'notification.inline_conversions.title_default' => 'Jane from England 🇬🇧',
    'notification.inline_conversions.description_default' => 'Just signed up for our newsletter 💌',
    'notification.inline_conversions.image_default' => ASSETS_FULL_URL . 'images/notifications/check-badge.svg',
    'notification.inline_conversions.time_ago_default' => '10 minutes ago',
    'notification.inline_conversions.selector' => 'Target CSS selector',
    'notification.inline_conversions.selector_help' => 'The notification is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_conversions.placement' => 'Placement',
    'notification.inline_conversions.placement_append' => 'Inside, at the end',
    'notification.inline_conversions.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_conversions.placement_before' => 'Before the element',
    'notification.inline_conversions.placement_after' => 'After the element',

    'notification.conversions_counter.name' => 'Conversions Counter',
    'notification.conversions_counter.description' => 'Display the number of your most recent conversions.',
    ...
    'notification.inline_conversions_counter.name' => 'Inline conversions counter',
    'notification.inline_conversions_counter.description' => 'Display a condensed conversions counter next to existing website content.',
    'notification.inline_conversions_counter.icon' => 'fas fa-fw fa-comment-dollar',
    'notification.inline_conversions_counter.title_default' => 'People bought the product',
    'notification.inline_conversions_counter.number_default' => '5',
    'notification.inline_conversions_counter.time_default' => 'In the last %s hours',
    'notification.inline_conversions_counter.selector' => 'Target CSS selector',
    'notification.inline_conversions_counter.selector_help' => 'The notification is inserted next to the first element matching this CSS selector. Dynamically loaded elements are detected for up to 10 seconds.',
    'notification.inline_conversions_counter.placement' => 'Placement',
    'notification.inline_conversions_counter.placement_append' => 'Inside, at the end',
    'notification.inline_conversions_counter.placement_prepend' => 'Inside, at the beginning',
    'notification.inline_conversions_counter.placement_before' => 'Before the element',
    'notification.inline_conversions_counter.placement_after' => 'After the element',
    ...
    'notification.rating_summary.name' => 'Rating summary',
    'notification.rating_summary.description' => 'Display an average rating summary based on your review data.',
    'notification.rating_summary.icon' => 'fas fa-fw fa-star-half-alt',
    'notification.rating_summary.title_default' => 'Excellent',
    'notification.rating_summary.description_default' => 'Based on {count} reviews',
    ...
    'notification.emoji_feedback.title_default' => 'Rate your experience with us',
    ...
    'notification.telegram_chat.name' => 'Telegram Chat',
    'notification.telegram_chat.description' => 'Display a chat widget that points to your Telegram username.',
    'notification.telegram_chat.icon' => 'fab fa-fw fa-telegram',
    'notification.telegram_chat.image_default' => ASSETS_FULL_URL . 'images/notifications/support-male-circle.svg',
    'notification.telegram_chat.agent_name_default' => 'John Doe',
    'notification.telegram_chat.agent_description_default' => 'Support at Example',
    'notification.telegram_chat.agent_message_default' => 'Hello, how can I help?',
    'notification.telegram_chat.button_text_default' => 'Message me',

    'notification.facebook_messenger_chat.name' => 'Messenger Chat',
    'notification.facebook_messenger_chat.description' => 'Display a chat widget that points to your Facebook Messenger profile or page.',
    'notification.facebook_messenger_chat.icon' => 'fab fa-fw fa-facebook-messenger',
    'notification.facebook_messenger_chat.image_default' => ASSETS_FULL_URL . 'images/notifications/support-male-circle.svg',
    'notification.facebook_messenger_chat.agent_name_default' => 'John Doe',
    'notification.facebook_messenger_chat.agent_description_default' => 'Support at Example',
    'notification.facebook_messenger_chat.agent_message_default' => 'Hello, how can I help?',
    'notification.facebook_messenger_chat.button_text_default' => 'Message me',

    'notification.help_center.name' => 'FAQ / Help Center',
    'notification.help_center.description' => 'Display a badge-style FAQ widget with quick answers for your visitors.',
    'notification.help_center.icon' => 'fas fa-fw fa-question-circle',
    'notification.help_center.title_default' => 'Need help?',
    'notification.help_center.description_default' => 'Find quick answers to common questions.',
    'notification.help_center.badge_text_default' => '',
    'notification.help_center.hint_text_default' => 'Click for quick answers',
    'notification.help_center.button_text_default' => 'Visit help center',
    'notification.help_center.question_1_default' => 'How do I get started?',
    'notification.help_center.answer_1_default' => 'Create an account, choose your setup, and follow the onboarding steps.',
    'notification.help_center.question_2_default' => 'Can I change my plan later?',
    'notification.help_center.answer_2_default' => 'Yes, you can upgrade or downgrade your plan from your account settings.',
    'notification.help_center.question_3_default' => 'Where can I get support?',
    'notification.help_center.answer_3_default' => 'You can contact us from the support page whenever you need help.',

    'notification.badge.name' => 'Badge',
    'notification.badge.description' => 'Display a simple & small badge with your custom icon.',
    'notification.badge.icon' => 'fas fa-fw fa-certificate',
    'notification.badge.image_default' => ASSETS_FULL_URL . 'images/notifications/whatsapp.png',
    ...
    'notification_handlers.type_ntfy' => 'ntfy',
    ...
    'notification_handlers.ntfy' => 'ntfy topic URL',
    'notification_handlers.ntfy_help' => 'Receive ntfy notifications for your specified topic URL.',
    ...
    'index.meta_keywords' => '',
    'index.header' => 'Increase Trust with <br /><span class="text-primary-600">Social Proof Popups</span>.',
    'index.subheader' => '<span class="font-weight-600">%s notifications created</span> by our users.',
    'index.subheader2' => '<span class="font-weight-600">%s displayed notifications</span> across the web.',
    'index.subheader3' => 'Trusted by <span class="font-weight-600">%s happy customers</span>.',
