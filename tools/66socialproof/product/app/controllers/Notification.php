...
class Notification extends Controller {
    ...
    public function index() {
        ...
        $this->notification_id = isset($this->params[0]) ? (int) $this->params[0] : null;
        ...
        $this->notification->settings->display_trigger_selector = $this->notification->settings->display_trigger_selector ?? (in_array($this->notification->type, ['inline_informational', 'inline_conversions', 'inline_reviews', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter']) ? ($this->notification->settings->selector ?? '') : '');

        if(in_array($this->notification->type, ['inline_informational', 'inline_conversions', 'inline_reviews', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter'])) {
            /* Set missing inline target */
            if(!isset($this->notification->settings->selector) || $this->notification->settings->selector == '') {
                $this->notification->settings->selector = 'body';
            }

            $this->notification->settings->inline_placement = $this->notification->settings->inline_placement ?? 'append';
            $this->notification->settings->margin_top = $this->notification->settings->margin_top ?? '0';
            $this->notification->settings->margin_right = $this->notification->settings->margin_right ?? '0';
            $this->notification->settings->margin_bottom = $this->notification->settings->margin_bottom ?? '0';
            $this->notification->settings->margin_left = $this->notification->settings->margin_left ?? '0';
        }
        ...
        switch($this->notification->type)  {
            ...
            case 'contact_us':
                ...
                $this->notification->settings->enabled_settings_tabs = ['basic', 'display', 'customize', 'themes', 'triggers'];
            ...
            case 'rating_summary':
                ...
                $this->notification->settings->enabled_settings_tabs = ['basic', 'display', 'customize', 'themes', 'triggers', 'data'];
        ...
        switch($method) {
            ...
            case 'data':
                ...
                $paginator = (new \Altum\Paginator($total_rows, 50, $_GET['page'] ?? 1, url('notification/' . $this->notification->notification_id . '/data?start_date=' . $datetime['start_date'] . '&end_date=' .$datetime['end_date'] . '&page={{PAGE}}')));
                ...
                $modal = in_array($this->notification->type, ['reviews', 'inline_reviews', 'rating_summary', 'inline_rating_summary']) ? 'data.create_review_data_modal.method' : 'data.create_data_modal.method';
    ...
    private function process_settings_post($notification_handlers = []) {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['display_trigger_selector'] = html_entity_decode(input_clean($_POST['display_trigger_selector'] ?? $this->notification->settings->display_trigger_selector, 256), ENT_QUOTES | ENT_HTML5, 'UTF-8');
            ...
            $_POST['display_duration'] = in_array($this->notification->type, ['inline_informational', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter']) ? -1 : (int) $_POST['display_duration'];
            $_POST['display_position'] = in_array($this->notification->type, ['inline_informational', 'inline_conversions', 'inline_reviews', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter']) ? 'inline' : (in_array($_POST['display_position'] ?? null, [
                'top_left',
                'top_center',
                'top_right',
                'middle_left',
            ...
            $_POST['display_close_button'] = in_array($this->notification->type, ['inline_informational', 'inline_conversions', 'inline_reviews', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter']) ? 0 : (int) isset($_POST['display_close_button']);
        ...
        $purifier_config->set('Cache.SerializerPath', UPLOADS_PATH . 'cache');
            ...
            if(in_array($this->notification->type, ['inline_informational', 'inline_conversions', 'inline_reviews', 'inline_rating_summary', 'inline_conversions_counter', 'inline_live_counter'])) {
                $_POST['selector'] = html_entity_decode(input_clean($_POST['selector'] ?? '', 256), ENT_QUOTES | ENT_HTML5, 'UTF-8');
                $_POST['inline_placement'] = in_array($_POST['inline_placement'] ?? null, ['append', 'prepend', 'before', 'after']) ? $_POST['inline_placement'] : 'append';

                foreach(['margin_top', 'margin_right', 'margin_bottom', 'margin_left'] as $margin) {
                    $_POST[$margin] = trim(mb_substr($_POST[$margin] ?? '0', 0, 32));
            ...
            switch($this->notification->type) {
                ...
                case 'inline_live_counter':
                    ...
                    $_POST['activity_type'] = in_array($_POST['activity_type'], ['all', 'page']) ? $_POST['activity_type'] : 'all';
                    $_POST['url'] = get_url($_POST['url']);
                    $_POST['url_new_tab'] = (int) isset($_POST['url_new_tab']);
                ...
                case 'conversions':
                    ...
                    $_POST['infinite_rotation'] = (int) isset($_POST['infinite_rotation']);
                ...
                case 'rating_summary':
                    ...
                    $_POST['average_rating'] = (float) $_POST['average_rating'];
                    $_POST['average_rating'] = $_POST['average_rating'] < 1 ? 1 : ($_POST['average_rating'] > 5 ? 5 : $_POST['average_rating']);
                    $_POST['reviews_count'] = (int) $_POST['reviews_count'] < 0 ? 0 : (int) $_POST['reviews_count'];
                    $_POST['display_minimum_reviews'] = (int) $_POST['display_minimum_reviews'] < 0 ? 0 : (int) $_POST['display_minimum_reviews'];
                    $_POST['url'] = get_url($_POST['url']);
                    $_POST['url_new_tab'] = (int) isset($_POST['url_new_tab']);
                    $_POST['border_radius'] = in_array($_POST['border_radius'], [
                        'straight',
                ...
                case 'engagement_links' :
                    ...
                    $_POST['categories'] = $_POST['categories'] ? array_map(function($category) use ($purifier) {
                        ...
                        $category['links'] = array_map(function($category_link) use ($purifier) {
                            ...
                            /* Keep hidden link colors */
                            if(!isset($category_link['background_color'])) {
                                $category_link['background_color'] = '';
                            }

                            if(!isset($category_link['border_color'])) {
                                $category_link['border_color'] = '';
                            }

                            $category_link['background_color'] = mb_substr(query_clean($category_link['background_color']), 0, 32);
                            $category_link['border_color'] = mb_substr(query_clean($category_link['border_color']), 0, 32);
                ...
                case 'help_center' :
                    ...
                    $_POST['badge_text'] = $purifier->purify(mb_substr($_POST['badge_text'], 0, 64));
                    ...
                    $_POST['hint_text'] = $purifier->purify(mb_substr($_POST['hint_text'], 0, 128));
                    ...
                    $_POST['items'] = isset($_POST['items']) && is_array($_POST['items']) ? array_map(function($item) use ($purifier) {
                ...
                case 'telegram_chat' :
                    ...
                    $_POST['agent_telegram'] = mb_substr(query_clean($_POST['agent_telegram']), 0, 32);
                ...
                case 'facebook_messenger_chat' :
                    ...
                    $_POST['agent_facebook_messenger'] = mb_substr(query_clean($_POST['agent_facebook_messenger']), 0, 64);
                ...
                case 'badge' :
                    ...
                    $_POST['image_size'] = (int) ($_POST['image_size'] >= 15 && $_POST['image_size'] <= 55 ? $_POST['image_size'] : 45);
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                switch($this->notification->type) {
                    ...
                    case 'informational' :
                        ...
                        if($this->notification->type == 'inline_informational') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                    ...
                    case 'inline_live_counter' :
                        ...
                        if($this->notification->type == 'inline_live_counter') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                                    'selector' => $_POST['selector'],
                    ...
                    case 'conversions' :
                        ...
                        if($this->notification->type == 'inline_conversions') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                                    'selector' => $_POST['selector'],
                    ...
                    case 'conversions_counter' :
                        ...
                        if($this->notification->type == 'inline_conversions_counter') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                                    'selector' => $_POST['selector'],
                    ...
                    case 'reviews' :
                        ...
                        if($this->notification->type == 'inline_reviews') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                                    'selector' => $_POST['selector'],
                    ...
                    case 'rating_summary' :
                        ...
                        $new_notification_settings = array_merge(
                            ...
                            [
                                ...
                                'rating_color' => $_POST['rating_color'],
                                'rating_background_color' => $_POST['rating_background_color'],
                                'stars_color' => $_POST['stars_color'],
                                'description_color' => $_POST['description_color'],
                                'background_color' => $_POST['background_color'],

                                /* Dark mode */
                                'dark_mode_rating_color' => $_POST['dark_mode_rating_color'],
                                'dark_mode_rating_background_color' => $_POST['dark_mode_rating_background_color'],
                                'dark_mode_stars_color' => $_POST['dark_mode_stars_color'],
                                'dark_mode_description_color' => $_POST['dark_mode_description_color'],
                                'dark_mode_background_color' => $_POST['dark_mode_background_color'],
                            ]
                        );

                        if($this->notification->type == 'inline_rating_summary') {
                            $new_notification_settings = array_merge(
                                $new_notification_settings,
                                [
                                    'selector' => $_POST['selector'],
                    ...
                    case 'help_center' :
                        ...
                        $new_notification_settings = array_merge(
                            ...
                            [
                                ...
                                'badge_background_color' => $_POST['badge_background_color'],
                                'badge_color' => $_POST['badge_color'],
                                'hint_background_color' => $_POST['hint_background_color'],
                                'hint_color' => $_POST['hint_color'],
                                'title_color' => $_POST['title_color'],
                                'description_color' => $_POST['description_color'],
                                'item_question_color' => $_POST['item_question_color'],
                                'item_answer_color' => $_POST['item_answer_color'],
                                'item_background_color' => $_POST['item_background_color'],
                                'item_border_color' => $_POST['item_border_color'],
                                'background_color' => $_POST['background_color'],
                                'button_background_color' => $_POST['button_background_color'],
                                'button_color' => $_POST['button_color'],

                                /* Dark mode */
                                'dark_mode_badge_background_color' => $_POST['dark_mode_badge_background_color'],
                                'dark_mode_badge_color' => $_POST['dark_mode_badge_color'],
                                'dark_mode_hint_background_color' => $_POST['dark_mode_hint_background_color'],
                                'dark_mode_hint_color' => $_POST['dark_mode_hint_color'],
                                'dark_mode_title_color' => $_POST['dark_mode_title_color'],
                                'dark_mode_description_color' => $_POST['dark_mode_description_color'],
                                'dark_mode_item_question_color' => $_POST['dark_mode_item_question_color'],
                                'dark_mode_item_answer_color' => $_POST['dark_mode_item_answer_color'],
                                'dark_mode_item_background_color' => $_POST['dark_mode_item_background_color'],
                                'dark_mode_item_border_color' => $_POST['dark_mode_item_border_color'],
                                'dark_mode_background_color' => $_POST['dark_mode_background_color'],
                                'dark_mode_button_background_color' => $_POST['dark_mode_button_background_color'],
                                'dark_mode_button_color' => $_POST['dark_mode_button_color'],
                            ]
                ...
                /* Clear the cache */
                cache()->deleteItemsByTag('campaign_id=' . $this->notification->campaign_id);
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            switch($_POST['type']) {
                case 'delete':
                    ...
                    (new \Altum\Models\Notification())->bulk_delete($_POST['selected'], $this->user->user_id, false);
