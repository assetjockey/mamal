...
class AdminNotificationHandlers extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['notification_handler_id', 'user_id', 'type'], ['name'], ['notification_handler_id', 'last_datetime', 'datetime', 'name'], allowed_datetime_fields: ['datetime', 'last_datetime']));
