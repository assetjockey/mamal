...
class ApiNotificationHandlers extends Controller {
    ...
    private function post() {
        ...
        switch($_POST['type']) {
            ...
            case 'sixsixtext_send_sms':
                $settings['sixsixtext_send_sms_api_key'] = input_clean($_POST['sixsixtext_send_sms_api_key'], 32);
                $settings['sixsixtext_send_sms_device_id'] = (int) $_POST['sixsixtext_send_sms_device_id'];
                $settings['sixsixtext_send_sms_device_sim_subscription_id'] = (int) $_POST['sixsixtext_send_sms_device_sim_subscription_id'];
                $settings['sixsixtext_send_sms_phone_number'] = get_phone_number($_POST['sixsixtext_send_sms_phone_number']);
                break;

            case 'sixsixtext_save_contact':
                $settings['sixsixtext_save_contact_api_key'] = input_clean($_POST['sixsixtext_save_contact_api_key'], 32);
                $settings['sixsixtext_save_contact_phone_number'] = get_phone_number($_POST['sixsixtext_save_contact_phone_number']);
                break;
    ...
    private function patch() {
        ...
        $_POST['type'] = array_key_exists($_POST['type'] ?? $notification_handler->type, require APP_PATH . 'includes/notification_handlers.php') ? input_clean($_POST['type'] ?? $notification_handler->type) : null;
        ...
        switch($_POST['type']) {
            ...
            case 'sixsixtext_send_sms':
                $settings['sixsixtext_send_sms_api_key'] = input_clean($_POST['sixsixtext_send_sms_api_key'] ?? $notification_handler->settings->sixsixtext_send_sms_api_key, 32);
                $settings['sixsixtext_send_sms_device_id'] = (int) ($_POST['sixsixtext_send_sms_device_id'] ?? $notification_handler->settings->sixsixtext_send_sms_device_id);
                $settings['sixsixtext_send_sms_device_sim_subscription_id'] = (int) ($_POST['sixsixtext_send_sms_device_sim_subscription_id'] ?? $notification_handler->settings->sixsixtext_send_sms_device_sim_subscription_id);
                $settings['sixsixtext_send_sms_phone_number'] = get_phone_number($_POST['sixsixtext_send_sms_phone_number'] ?? $notification_handler->settings->sixsixtext_send_sms_phone_number);
                break;

            case 'sixsixtext_save_contact':
                $settings['sixsixtext_save_contact_api_key'] = input_clean($_POST['sixsixtext_save_contact_api_key'] ?? $notification_handler->settings->sixsixtext_save_contact_api_key, 32);
                $settings['sixsixtext_save_contact_phone_number'] = get_phone_number($_POST['sixsixtext_save_contact_phone_number'] ?? $notification_handler->settings->sixsixtext_save_contact_phone_number);
                break;
