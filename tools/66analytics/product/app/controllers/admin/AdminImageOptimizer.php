...
class AdminImageOptimizer extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['image_optimization_id'], ['path', 'file'], ['image_optimization_id', 'original_size', 'new_size', 'percentage_difference', 'datetime'], allowed_datetime_fields: ['datetime']));
