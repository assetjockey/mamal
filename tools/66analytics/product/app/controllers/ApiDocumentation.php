    ...
    public function index() {
        ...
        if($endpoint) {
            ...
            $title = match($endpoint) {
                ...
                'pageviews_lightweight' => l('pageviews.title'),
                'pageviews_advanced' => l('pageviews.title'),
                'sessions' => l('analytics.sessions'),
                'events_children' => l('api_documentation.events_children'),
