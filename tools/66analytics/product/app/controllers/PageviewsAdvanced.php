...
class PageviewsAdvanced extends Controller {
    ...
    public function index() {
        ...
        $paginator = (new \Altum\Paginator($total_rows, settings()->main->default_results_per_page, $_GET['page'] ?? 1, url('pageviews-advanced?page={{PAGE}}')));
        ...
        $view = new \Altum\View('pageviews-advanced/index', (array) $this);
