    ...
    <div class="accordion">
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#pageviews_advanced_read_all" aria-expanded="true" aria-controls="pageviews_advanced_read_all">
                        <span class="badge badge-success user-select-none mr-3"><i class="fas fa-fw fa-sm fa-list"></i></span> <?= l('api_documentation.read_all') ?>
                    </a>
                </h3>
            </div>

            <div id="pageviews_advanced_read_all" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/pageviews-advanced/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/pageviews-advanced/?website_id=<span class="text-primary">1</span>' \<br />
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.search_by'), '<code>' . implode('</code>, <code>', ['path', 'title', 'referrer_host', 'referrer_path', 'utm_source', 'utm_medium', 'utm_campaign']) . '</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>date</code>') ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['event_id', 'session_id', 'visitor_id', 'path', 'title', 'has_bounced', 'expiration_date', 'date']) . '</code>') ?></td>
                            </tr>
                        ...
                        <pre data-shiki="json">
{
    ...
    "links": {
        "first": "<?= SITE_URL ?>api/pageviews-advanced?website_id=1&page=1",
        "last": "<?= SITE_URL ?>api/pageviews-advanced?website_id=1&page=1",
        "next": null,
        "prev": null,
        "self": "<?= SITE_URL ?>api/pageviews-advanced?website_id=1&page=1"
    }
}</pre>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#pageviews_advanced_read" aria-expanded="true" aria-controls="pageviews_advanced_read">
                        <span class="badge badge-success user-select-none mr-3"><i class="fas fa-fw fa-sm fa-eye"></i></span> <?= l('api_documentation.read') ?>
                    </a>
                </h3>
            </div>

            <div id="pageviews_advanced_read" class="collapse">
                <div class="card-body">
                    <div class="form-group mb-4">
                        <label><?= l('api_documentation.endpoint') ?></label>
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/pageviews-advanced/</span><span class="text-primary">{event_id}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/pageviews-advanced/<span class="text-primary">{event_id}</span>' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \
                            </div>
                        </div>
                    </div>
                        ...
                        <pre data-shiki="json">
{
    "data": {
        ...
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#pageviews_advanced_delete" aria-expanded="true" aria-controls="pageviews_advanced_delete">
            ...
            <div id="pageviews_advanced_delete" class="collapse">
                <div class="card-body">
                    <div class="form-group mb-4">
                        <label><?= l('api_documentation.endpoint') ?></label>
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-danger user-select-none mr-3">DELETE</span> <span class="text-muted"><?= SITE_URL ?>api/pageviews-advanced/</span><span class="text-primary">{event_id}</span>
                            </div>
                        </div>
                    </div>
