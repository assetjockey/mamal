    ...
    <div class="accordion">
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#domains_read_available" aria-expanded="true" aria-controls="domains_read_available">
                        <span class="badge badge-success user-select-none mr-3"><i class="fas fa-fw fa-sm fa-list"></i></span> <?= l('api_documentation.domains.read_available') ?>
                    </a>
                </h3>
            </div>

            <div id="domains_read_available" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/domains/available</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/domains/available' \<br />
                        ...
                        <pre data-shiki="json">
{
    ...
    "links": {
        "first": "<?= SITE_URL ?>api/domains/available?page=1",
        "last": "<?= SITE_URL ?>api/domains/available?page=1",
        "next": null,
        "prev": null,
        "self": "<?= SITE_URL ?>api/domains/available?page=1"
    }
}</pre>
                    </div>
                </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                ...
                                --form 'scheme=<span class="text-primary">https://</span>' \<br />
