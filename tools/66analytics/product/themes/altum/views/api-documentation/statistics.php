                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/statistics/</span><span class="text-primary">{website_id}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code>, <code>', ['overview', 'realtime', 'paths', 'landing_paths', 'referrers', 'referrer_paths', 'screen_resolutions', 'utms_source', 'utms_medium_campaign', 'operating_systems', 'device_types', 'continents', 'countries', 'regions', 'cities', 'browser_names', 'browser_languages', 'browser_timezones', 'themes', 'goals', 'hours', 'weekdays', 'outbound_clicks', 'outbound_clicks_paths']) . '</code>') ?></td>
                            </tr>
                            <tr>
                                <td>country_code</td>
                                <td>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = regions, cities</span>') ?></td>
                            </tr>
                            <tr>
                                <td>region_name</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = referrer_paths</span>') ?></td>
                            </tr>
                            <tr>
                                <td>utm_source</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.available_when'), '<span class="badge badge-light">type = outbound_clicks_paths</span>') ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/statistics/<span class="text-primary">{website_id}</span>?start_date=<span class="text-primary">2020-01-01</span>&end_date=<span class="text-primary">2021-01-01</span>&type=<span class="text-primary">paths</span>' \<br />
