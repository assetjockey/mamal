    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('referrals_users.title') ?></li>
            </ol>
        </nav>
    <?php endif ?>

    <h1 class="h4 mb-4"><?= l('referrals_users.title') ?></h1>

    <div class="accordion">
        <div class="card">
            <div class="card-header bg-white p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link text-decoration-none" data-toggle="collapse" data-target="#referrals_users_read_all" aria-expanded="true" aria-controls="referrals_users_read_all">
                        <span class="badge badge-success user-select-none mr-3"><i class="fas fa-fw fa-sm fa-list"></i></span> <?= l('api_documentation.read_all') ?>
                    </a>
                </h3>
            </div>

            <div id="referrals_users_read_all" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success user-select-none mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/referrals-users/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/referrals-users/' \<br />
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tbody>
                            <tr>
                                <td>referred_by_has_converted</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.filters.order_by'), '<code>' . implode('</code>, <code>', ['datetime', 'referred_by_has_converted']) . '</code>') ?></td>
                            </tr>
                        ...
                        <pre data-shiki="json">
{
    "data": [
        {
            ...
            "latest_affiliate_commission_datetime": "<?= get_date() ?>",
    ...
    "links": {
        "first": "<?= SITE_URL ?>api/referrals-users?page=1",
        "last": "<?= SITE_URL ?>api/referrals-users?page=1",
        "next": null,
        "prev": null,
        "self": "<?= SITE_URL ?>api/referrals-users?page=1"
    }
}</pre>
                    </div>
                </div>
