...
<form action="" method="post" class="mt-4" role="form">
    ...
    <?php if(!settings()->users->register_only_social_logins): ?>
        ...
        <?php if(settings()->content->broadcasts_display_register_checkbox): ?>
            <div class="mt-3 custom-control custom-checkbox">
                <input type="checkbox" name="is_broadcast_subscribed" class="custom-control-input" id="is_broadcast_subscribed">
                <label class="custom-control-label" for="is_broadcast_subscribed">
                    <small class="text-muted">
                        <?= l('register.is_broadcast_subscribed') ?>
                    </small>
                </label>
            </div>
        <?php endif ?>
    ...
    <?php if(settings()->facebook->is_enabled || settings()->google->is_enabled || settings()->twitter->is_enabled || settings()->discord->is_enabled || settings()->linkedin->is_enabled || settings()->microsoft->is_enabled || settings()->apple->is_enabled || settings()->github->is_enabled): ?>
