...
<div class="container">
    <nav class="navbar navbar-main navbar-expand-lg navbar-light border border-gray-100 mt-4 rounded-2x mb-5 mb-lg-6">
        <div class="container">
            <a
                    href="<?= url() ?>"
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    <div class="pr-lg-3">
                                        ...
                                        <?php if(settings()->analytics->annotations_is_enabled): ?>
                                            <a href="<?= url('annotations') ?>" class="dropdown-item"><i class="fas fa-fw fa-comments fa-sm mr-2"></i> <?= l('annotations.menu') ?></a>
                                        <?php endif ?>
