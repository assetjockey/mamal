...
<ul class="list-style-none m-0">
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php if($feature == 'sessions_events_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->sessions_events_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
        ...
        <?php if($feature == 'events_children_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->events_children_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
        ...
        <?php if($feature == 'sessions_replays_limit' && settings()->analytics->sessions_replays_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->sessions_replays_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
        ...
        <?php if($feature == 'sessions_replays_retention' && $data->plan_settings->sessions_replays_limit != 0): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 fa-check text-success"></i>
        ...
        <?php if($feature == 'websites_heatmaps_limit' && settings()->analytics->websites_heatmaps_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->websites_heatmaps_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
        ...
        <?php if($feature == 'websites_goals_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->websites_goals_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
        ...
        <?php if($feature == 'annotations_limit' && settings()->analytics->annotations_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->annotations_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
                <div class="<?= $data->plan_settings->annotations_limit ? null : 'text-muted' ?>">
        ...
        <?php if($feature == 'dashboard_views_limit' && settings()->analytics->dashboard_views_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->dashboard_views_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
                <div class="<?= $data->plan_settings->dashboard_views_limit ? null : 'text-muted' ?>">
        ...
        <?php if($feature == 'teams_is_enabled'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->teams_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
