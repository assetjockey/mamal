...
<div class="admin-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminBroadcastSubscribers']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/broadcast-subscribers') ?>">
                    <i class="fas fa-fw fa-sm fa-users mr-2"></i> <?= l('admin_broadcast_subscribers.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= \Altum\Router::$controller == 'AdminAnnotations' ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/annotations') ?>">
                    <i class="fas fa-fw fa-sm fa-comments mr-2"></i> <?= l('admin_annotations.menu') ?>
                </a>
            </li>
