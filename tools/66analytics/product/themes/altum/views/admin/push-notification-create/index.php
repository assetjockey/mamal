    ...
    <div class="card-body">
        ...
        <form id="form" action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted"><?= sprintf(l('global.variables'), '<code data-copy>' . implode('</code> , <code data-copy>', ['{{WEBSITE_TITLE}}', '{{SUBSCRIBER:COUNTRY_NAME}}']) . '</code> <a href="#" class="text-decoration-none font-weight-500 text-muted" data-show-more>' . l('global.show_more') . '</a><span hidden> , <code data-copy>' . implode('</code> , <code data-copy>', ['{{SUBSCRIBER:CONTINENT_NAME}}', '{{SUBSCRIBER:CITY_NAME}}', '{{SUBSCRIBER:DEVICE_TYPE}}', '{{SUBSCRIBER:OS_NAME}}', '{{SUBSCRIBER:BROWSER_NAME}}', '{{SUBSCRIBER:BROWSER_LANGUAGE}}']) . '</code></span>') ?></small>
            ...
            <div class="form-group" data-segment="filter">
                ...
                <div class="row">
                    <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="<?= 'filters_languages###' . $language_code ?>" name="filters_languages[]" value="<?= $language_code ?>" type="checkbox" class="custom-control-input" <?= isset($data->values['filters_languages'][$language_name]) ? 'checked="checked"' : null ?>>
