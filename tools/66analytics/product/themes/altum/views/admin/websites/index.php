...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
        ...
        <div class="ml-3">
            <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->websites) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mx-1">
                                <?php if($row->tracking_type == 'advanced'): ?>
                                    <span class="badge badge-info" data-toggle="tooltip" title="<?= l('websites.tracking_type_advanced') ?>"><i class="fas fa-fw fa-sm fa-brain"></i></span>
                                <?php endif ?>
                    ...
                    <td class="text-nowrap">
                        ...
                        <a href="<?= url('admin/annotations?website_id=' . $row->website_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_annotations.menu') ?>">
                            <i class="fas fa-fw fa-comments text-muted"></i>
                        </a>
                    </td>
