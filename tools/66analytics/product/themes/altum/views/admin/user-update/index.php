        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="sessions_replays_retention" name="sessions_replays_retention" min="-1" max="10000" class="form-control" value="<?= $data->user->plan_settings->sessions_replays_retention ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.date.days') ?></span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="annotations_limit" name="annotations_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->annotations_limit ?>" />
                </div>

                <div class="form-group">
                    <label for="dashboard_views_limit"><?= l('admin_plans.plan.dashboard_views_limit') ?></label>
                    <input type="number" id="dashboard_views_limit" name="dashboard_views_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->dashboard_views_limit ?>" />
