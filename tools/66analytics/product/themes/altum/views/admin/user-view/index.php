        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/websites?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/heatmaps?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/replays?user_id=' . $data->user->user_id) ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_user_view.teams') ?></small>
                    </div>

                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
                            <i class="fas fa-fw fa-sm fa-user-shield text-primary"></i>
                        </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <span class="h4" id="teams">
                        <span class="spinner-border spinner-border-sm" role="status"></span>
                    </span>
                </div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_user_view.teams_associations') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <span class="h4" id="teams_associations">
                        <span class="spinner-border spinner-border-sm" role="status"></span>
                    </span>
                </div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_user_view.email_reports') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <span class="h4" id="email_reports">
                        <span class="spinner-border spinner-border-sm" role="status"></span>
                    </span>
                </div>
            </div>
