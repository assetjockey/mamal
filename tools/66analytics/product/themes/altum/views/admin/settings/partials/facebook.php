...
<div>
    ...
    <div class="form-group">
        <label for="app_id"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_settings.facebook.app_id') ?></label>
        <input id="app_id" type="text" name="app_id" class="form-control" value="<?= settings()->facebook->app_id ?>" />
    </div>

    <div class="form-group">
        <label for="app_secret"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.facebook.app_secret') ?></label>
