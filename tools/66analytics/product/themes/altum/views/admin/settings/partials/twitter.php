...
<div>
    ...
    <div class="form-group">
        <label for="consumer_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.twitter.consumer_api_key') ?></label>
        <input id="consumer_api_key" type="text" name="consumer_api_key" class="form-control" value="<?= settings()->twitter->consumer_api_key ?>" />
    </div>

    <div class="form-group">
        <label for="consumer_api_secret"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.twitter.consumer_api_secret') ?></label>
