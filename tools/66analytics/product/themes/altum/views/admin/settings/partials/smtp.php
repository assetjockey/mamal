...
<div>
    ...
    <div class="collapse" id="theme_container">
        <div class="form-group">
            <label for="links_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('admin_settings.smtp.links_color') ?></label>
        ...
        <div class="form-group">
            <label for="button_background_color"><i class="fas fa-fw fa-sm fa-fill text-muted mr-1"></i> <?= l('admin_settings.smtp.button_background_color') ?></label>
        ...
        <div class="form-group">
            <label for="button_text_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('admin_settings.smtp.button_text_color') ?></label>
        ...
        <div class="form-group" data-range-counter data-range-counter-suffix="px">
            <label for="button_border_radius"><i class="fas fa-fw fa-sm fa-border-all text-muted mr-1"></i> <?= l('admin_settings.smtp.button_border_radius') ?></label>
        ...
        <div class="form-group" data-range-counter data-range-counter-suffix="px">
            <label for="main_container_border_radius"><i class="fas fa-fw fa-sm fa-border-all text-muted mr-1"></i> <?= l('admin_settings.smtp.main_container_border_radius') ?></label>
