...
<div>
    ...
    <div class="form-group">
        <label for="layout"><i class="fas fa-fw fa-sm fa-sliders-h text-muted mr-1"></i> <?= l('admin_settings.cookie_consent.layout') ?></label>
    ...
    <div class="form-group">
        <label for="position_y"><i class="fas fa-fw fa-sm fa-sliders-h text-muted mr-1"></i> <?= l('admin_settings.cookie_consent.position_y') ?></label>
    ...
    <div class="form-group">
        <label for="position_x"><i class="fas fa-fw fa-sm fa-sliders-h text-muted mr-1"></i> <?= l('admin_settings.cookie_consent.position_x') ?></label>
