...
<div class="form-group">
    ...
    <?php if(isset(settings()->cron->cron_datetime)): ?>
        <small class="form-text text-muted"><?= sprintf(l('admin_settings.cron.last_processing_time'), isset(settings()->cron->cron_datetime_processing) ? nr(settings()->cron->cron_datetime_processing, 2) . ' ' . l('global.date.seconds') : l('global.na')) ?></small>
    <?php endif ?>
</div>
...
<div class="form-group">
    ...
    <?php if(isset(settings()->cron->email_reports_datetime)): ?>
        <small class="form-text text-muted"><?= sprintf(l('admin_settings.cron.last_processing_time'), isset(settings()->cron->email_reports_datetime_processing) ? nr(settings()->cron->email_reports_datetime_processing, 2) . ' ' . l('global.date.seconds') : l('global.na')) ?></small>
    <?php endif ?>
</div>
...
<div class="form-group">
    ...
    <?php if(isset(settings()->cron->broadcasts_datetime)): ?>
        <small class="form-text text-muted"><?= sprintf(l('admin_settings.cron.last_processing_time'), isset(settings()->cron->broadcasts_datetime_processing) ? nr(settings()->cron->broadcasts_datetime_processing, 2) . ' ' . l('global.date.seconds') : l('global.na')) ?></small>
    <?php endif ?>
</div>
    ...
    <div class="<?= !\Altum\Plugin::is_active('push-notifications') ? 'container-disabled' : null ?>">
        <div class="form-group">
            ...
            <?php if(isset(settings()->cron->push_notifications_datetime)): ?>
                <small class="form-text text-muted"><?= sprintf(l('admin_settings.cron.last_processing_time'), isset(settings()->cron->push_notifications_datetime_processing) ? nr(settings()->cron->push_notifications_datetime_processing, 2) . ' ' . l('global.date.seconds') : l('global.na')) ?></small>
            <?php endif ?>
        </div>
    </div>
</div>
