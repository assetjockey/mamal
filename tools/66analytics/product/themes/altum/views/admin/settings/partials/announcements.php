        ...
        <div class="tab-pane fade show active" id="pills-guests" role="tabpanel" aria-labelledby="pills-guests-tab">
            ...
            <div class="form-group">
                <label for="guests_content" class="d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-sm btn-gray-200" type="button" data-toggle="collapse" data-target="#guests_content_translate_container" aria-expanded="false" aria-controls="guests_content_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
                </label>
        ...
        <div class="tab-pane fade" id="pills-users" role="tabpanel" aria-labelledby="pills-users-tab">
            ...
            <div class="form-group">
                <label for="users_content" class="d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-fw fa-sm fa-bullhorn text-muted mr-1"></i> <?= l('admin_settings.announcements.content') ?></span>
                    <button class="btn btn-sm btn-gray-200" type="button" data-toggle="collapse" data-target="#users_content_translate_container" aria-expanded="false" aria-controls="users_content_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
                </label>
