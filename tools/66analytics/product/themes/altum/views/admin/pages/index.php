...
<?php if(!empty($data->pages) || $data->filters->has_applied_filters): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
        ...
        <div class="d-flex position-relative">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                <label for="filters_is_published" class="small"><?= l('admin_resources.is_published') ?></label>
            ...
            <div class="ml-3">
                <button id="bulk_enable" type="button" class="btn btn-gray-300 <?= !empty($data->pages) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
        ...
        <div class="table-responsive table-custom-container">
            <table class="table table-custom">
                ...
                <tr>
                    ...
                    <th><?= l('global.type') ?></th>
                    <th><?= l('admin_resources.is_published') ?></th>
                    ...
                    <tr>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="small text-muted">
                                        ...
                                        <a href="<?= $row->type == 'internal' && !$row->is_published ? url('admin/page-preview/' . $row->page_id) : ($row->type == 'internal' ? SITE_URL . ($row->language ? \Altum\Language::$active_languages[$row->language] . '/' : null) . 'page/' . $row->url : $row->url) ?>" target="_blank" rel="noreferrer">
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <?= include_view(THEME_PATH . 'views/admin/pages/admin_page_dropdown_button.php', ['id' => $row->page_id, 'resource_name' => $row->title, 'url' => $row->url, 'language' => $row->language, 'type' => $row->type, 'is_published' => $row->is_published]) ?>
                            </div>
                        </td>
                    </tr>
                <?php endforeach ?>
