                                                ...
                                                <div class="card-body d-flex <?= $enabled_payment_processors <= 4 ? null : 'flex-column justify-content-between' ?> align-items-center">
                                                    <div class="<?= $enabled_payment_processors <= 4 ? 'mr-3' : 'mb-3' ?>">
                                                        <span class="custom-radio-box-main-icon">
                                                            <?php /* Display custom payment image */ ?>
                                                            <?php if(isset($value['image']) && $value['image']): ?>
                                                                <img src="<?= ASSETS_FULL_URL . 'images/payment-processors/' . $value['image'] ?>" alt="<?= l('pay.custom_plan.' . $key) ?>" style="width: 2rem; height: 2rem; object-fit: contain;" />
                                                            <?php else: ?>
