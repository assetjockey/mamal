...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex flex-wrap gap-3 d-print-none">
            ...
            <div>
                <div class="dropdown">
                    <button type="button" class="btn btn-light dropdown-toggle-simple <?= !empty($data->heatmaps) ? null : 'disabled' ?>" data-toggle="dropdown" data-boundary="viewport" data-tooltip title="<?= l('global.export') ?>" data-tooltip-hide-on-click>
            ...
            <div>
                <div class="dropdown">
                    <button type="button" class="btn <?= $data->filters->has_applied_filters ? 'btn-dark' : 'btn-light' ?> filters-button dropdown-toggle-simple <?= !empty($data->heatmaps) || $data->filters->has_applied_filters ? null : 'disabled' ?>" data-toggle="dropdown" data-boundary="viewport" data-tooltip data-html="true" title="<?= l('global.filters.tooltip') ?>" data-tooltip-hide-on-click>
            ...
            <div>
                <button id="bulk_enable" type="button" class="btn btn-light <?= !empty($data->heatmaps) ? null : 'disabled' ?>" data-toggle="tooltip" title="<?= l('global.bulk_actions') ?>"><i class="fas fa-fw fa-sm fa-list"></i></button>
                ...
                <table class="table table-custom">
                    ...
                    <?php foreach($data->heatmaps as $row): ?>
                        <tr data-heatmap-id="<?= $row->heatmap_id ?>">
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex">
                                    <a href="<?= url('heatmap/' . $row->heatmap_id . '/desktop') ?>" class="mr-2 badge <?= ($row->snapshot_id_desktop ? 'badge-primary' : 'badge-light') ?>" data-toggle="tooltip" title="<?= ($row->snapshot_id_desktop ? l('heatmaps.snapshot_id_desktop') : l('heatmaps.snapshot_id_desktop_null')) ?>"><i class="fas fa-fw fa-desktop"></i></a>
                                    <a href="<?= url('heatmap/' . $row->heatmap_id . '/tablet') ?>" class="mr-2 badge <?= ($row->snapshot_id_tablet ? 'badge-primary' : 'badge-light') ?>" data-toggle="tooltip" title="<?= ($row->snapshot_id_tablet ? l('heatmaps.snapshot_id_tablet') : l('heatmaps.snapshot_id_tablet_null')) ?>"><i class="fas fa-fw fa-tablet"></i></a>
                                    <a href="<?= url('heatmap/' . $row->heatmap_id . '/mobile') ?>" class="mr-2 badge <?= ($row->snapshot_id_mobile ? 'badge-primary' : 'badge-light') ?>" data-toggle="tooltip" title="<?= ($row->snapshot_id_mobile ? l('heatmaps.snapshot_id_mobile') : l('heatmaps.snapshot_id_mobile_null')) ?>"><i class="fas fa-fw fa-mobile"></i></a>
                                </div>
                            </td>
