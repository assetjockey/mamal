        ...
        <div class="d-flex justify-content-center">
            <div class="d-flex flex-column flex-lg-row mt-4 mb-4">
                <?php if(settings()->users->register_is_enabled): ?>
                    <a href="<?= url('register') ?>" class="btn btn-primary px-5 py-3 mb-3 mb-lg-0 mr-lg-3 rounded-2x">
                ...
                <?php if(settings()->analytics->example_url && settings()->analytics->example_url): ?>
                    <a href="<?= settings()->analytics->example_url ?>" target="_blank" class="btn btn-gray-100 px-5 py-3 mb-2 mb-lg-0 rounded-2x" data-toggle="tooltip" title="<?= l('index.example_help') ?>">
...
<div class="container" data-aos="fade-up" data-aos-delay="300">
    <div class="row justify-content-center mt-8">
        <div class="col-11 col-md-10">
            <img src="<?= get_custom_image_if_any('index/hero.webp') ?>" class="img-fluid shadow-lg rounded zoom-animation-subtle inverse-colors-animation" alt="<?= l('index.hero_image_alt') ?>" />
        </div>
    </div>
</div>
...
<div class="container mt-10">
    ...
    <div class="row">
        <div class="col-12 col-lg-4 p-3">
            <div class="card border border-gray-100 mb-md-0 h-100" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-12 col-lg-4 p-3">
            <div class="card border border-gray-100 mb-md-0 h-100" data-aos="fade-up" data-aos-delay="200">
                <div class="card-body icon-zoom-animation">
                    <div class="d-flex align-items-center">
                        <div class="index-icon-container mr-3">
        ...
        <div class="col-12 col-lg-4 p-3">
            <div class="card border border-gray-100 mb-md-0 h-100" data-aos="fade-up" data-aos-delay="300">
                <div class="card-body icon-zoom-animation">
                    <div class="d-flex align-items-center">
                        <div class="index-icon-container mr-3">
        ...
        <div class="row justify-content-between mt-9" data-aos="fade-up">
            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                ...
                <div>
                    ...
                    <div class="small mb-2"><i class="fas fa-fw fa-mouse-pointer text-primary mr-1"></i> <?= l('index.heatmaps.clicks') ?></div>
                    <div class="small mb-2"><i class="fas fa-fw fa-mouse text-primary mr-1"></i> <?= l('index.heatmaps.scroll') ?></div>
...
<div class="container mt-9">
    <div class="card index-highly-rounded bg-gray-900">
        <div class="card-body py-5 py-lg-6 text-center">
            <span class="h3 text-gray-100"><?= sprintf(l('index.stats'), $data->total_websites, nr($data->total_websites, 0, true, true), $data->total_pageviews, nr($data->total_pageviews, 0, true, true)) ?></span>
        </div>
    </div>
</div>
                    ...
                    <div class="position-relative">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="small mb-2"><i class="fas fa-fw fa-check-circle text-success mr-1"></i> <?= l('goals_conversions.title') ?></div>
                            </div>

                            <div class="col">
                                <div class="small mb-2"><i class="fas fa-fw fa-check-circle text-success mr-1"></i> <?= l('pageviews.title') ?></div>
                                <div class="small mb-2"><i class="fas fa-fw fa-check-circle text-success mr-1"></i> <?= l('goals.title') ?></div>
                                <div class="small mb-2"><i class="fas fa-fw fa-check-circle text-success mr-1"></i> <?= l('visitors.title') ?></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-6" data-aos="fade-up" data-aos-delay="300">
                <div class="card rounded-2x bg-dark text-white">
                    <div class="card-body p-4 text-monospace reveal-effect text-break font-size-small" style="line-height: 1.75">
                        ...
                        --url '<?= SITE_URL ?>api/statistics/1' \<br />
                        ...
                        --form 'start_date=<span class="text-primary"><?= date('Y-m-d', strtotime('-1 month')) ?></span>' \<br />
                        --form 'end_date=<span class="text-primary"><?= date('Y-m-d') ?></span>' \<br />
                        --form 'type=<span class="text-primary">overview</span>' \<br />
                    </div>
                </div>
            </div>
        </div>
