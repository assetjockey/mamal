                ...
                <form name="goal_create" method="post" role="form">
                    ...
                    <div class="form-group">
                        <select name="type" class="custom-select form-control-lg">
                            ...
                            <option value="scroll"><?= l('goal_create_modal.type_scroll') ?></option>
                        </select>
                    </div>
                    ...
                    <div class="d-none" id="goal_create_type_scroll">

                        <div class="form-group">
                            <label for="goal_create_scroll_percentage"><i class="fas fa-fw fa-sm fa-arrows-alt-v text-gray-700 mr-1"></i> <?= l('goal_create_modal.scroll_percentage') ?></label>
                            <div class="input-group">
                                <input id="goal_create_scroll_percentage" type="number" name="scroll_percentage" class="form-control" min="1" max="100" value="50" />
    ...
    let goal_create_input_type_handler = () => {
        ...
        switch(type) {
            case 'pageview':
                ...
                document.querySelector('#goal_create_type_scroll').classList.add('d-none');
            ...
            case 'scroll':
                ...
                document.querySelector('#goal_create_type_pageview').classList.remove('d-none');
                document.querySelector('#goal_create_type_custom').classList.add('d-none');
                document.querySelector('#goal_create_type_scroll').classList.remove('d-none');
