            ...
            <div class="row-fade-show-icon position-relative">
                ...
                <div class="d-flex justify-content-between mb-1 row-fade-show-icon-content">
                    <div class="d-flex align-items-center" style="min-width:0;">
                        <span class="text-truncate" style="min-width:0;"><?= $row->theme ? l('dashboard.themes.' . $row->theme) : l('global.unknown') ?></span>

                        <?php if($row->theme): ?>
                            <a href="#" data-add-filter data-filter-by="theme" data-filter-rule="is" data-filter-value="<?= e($row->theme) ?>" class="text-muted ml-1 flex-shrink-0" data-toggle="tooltip" title="<?= l('analytics.filters.create') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-xs fa-filter"></i></a>
                        <?php endif ?>
                    </div>
