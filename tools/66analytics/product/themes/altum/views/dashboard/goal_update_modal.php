                ...
                <form name="goal_update" method="post" role="form">
                    ...
                    <div class="d-none" id="goal_update_type_pageview">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted"><?= l('goal_create_modal.path_help') ?></small>
                        </div>
                    ...
                    <div class="d-none" id="goal_update_type_scroll">

                        <div class="form-group">
                            <label><i class="fas fa-fw fa-sm fa-arrows-alt-v text-gray-700 mr-1"></i> <?= l('goal_create_modal.scroll_percentage') ?></label>
                            <div class="input-group">
                                <input type="number" name="scroll_percentage" class="form-control" min="1" max="100" value="50" />
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                            <small class="form-text text-muted"><?= l('goal_create_modal.scroll_percentage_help') ?></small>
                        </div>
...
let goal_update_update_code = () => {
    ...
    $('#goal_update_modal').on('show.bs.modal', event => {
        ...
        let scroll_percentage = $(event.relatedTarget).data('scroll-percentage');
        ...
        $(event.currentTarget).find('input[name="scroll_percentage"]').val(scroll_percentage);
        ...
        switch(type) {
            case 'pageview':
                ...
                document.querySelector('#goal_update_type_scroll').classList.add('d-none');
            ...
            case 'scroll':
                ...
                document.querySelector('#goal_update_type_pageview').classList.remove('d-none');
                document.querySelector('#goal_update_type_custom').classList.add('d-none');
                document.querySelector('#goal_update_type_scroll').classList.remove('d-none');
