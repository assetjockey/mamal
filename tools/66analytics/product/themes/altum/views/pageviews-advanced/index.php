...
<div class="container">
            ...
            <div>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right d-print-none">
                        <a href="<?= url('pageviews-advanced?export=csv')  ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->csv ? null : get_plan_feature_disabled_info() ?>>
                            <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                        </a>
                        <a href="<?= url('pageviews-advanced?export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->json ? null : get_plan_feature_disabled_info() ?>>
    ...
    <?php else: ?>
        ...
        <form id="table" action="<?= SITE_URL . 'pageviews-advanced/bulk' ?>" method="post" role="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end">
                                    <?= include_view(THEME_PATH . 'views/pageviews-advanced/pageview_dropdown_button.php', ['id' => $row->event_id]) ?>
                                </div>
                            </td>
                        </tr>
