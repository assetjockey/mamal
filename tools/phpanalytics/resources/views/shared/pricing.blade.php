                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="row m-n2">
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->pageviews == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                @if($plan->features->pageviews < 0)
                        ...
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->websites == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                @if($plan->features->websites < 0)
                        ...
                        <div class="col-12 p-2 d-flex">
                            ...
                            <div class="{{ ($plan->features->email_reports == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}">
                                {{ __('Email reports') }}
                            </div>

                            <div class="d-flex align-content-center mt-1 {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2') }}" data-tooltip="true" title="{{ __('Periodic email reports.') }}">@include('icons.info', ['class' => 'text-muted width-4 height-4 fill-current'])</div>
                        </div>
