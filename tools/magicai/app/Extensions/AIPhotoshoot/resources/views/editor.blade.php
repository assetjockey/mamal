...
@section('title', __('AI Photoshoot Editor'))
    ...
    <script>
        (() => {
            document.addEventListener('alpine:init', () => {
                Alpine.data('aiPhotoshootEditor', () => ({
                    currentImage: null,
                    imageHistory: [],
                    historyPage: 0,
                    historyHasMore: true,
                    ...
                    init() {
                        ...
                        const saved = localStorage.getItem('aiPhotoshootEditorModel');
                    ...
                    async loadImageHistory() {
                        ...
                        try {
                            ...
                            const url = `{{ route('dashboard.user.ai-photoshoot.editor.completed-images') }}?page=${nextPage}&per_page=10`;
                    ...
                    async generate() {
                        ...
                        try {
                            ...
                            formData.append('source', 'ai-photoshoot');
                        ...
                        const checkStatus = async () => {
                            ...
                            try {
                                ...
                                if (data.status === 'completed' && data.paths?.length > 0) {
                                    ...
                                    // Drop the AI Chat Pro Image Chat tracking record now that
                                    // the AI Photoshoot UserOpenai record holds the result.
                                    fetch('{{ route('dashboard.user.ai-photoshoot.editor.delete-edit-record') }}', {
                                        method: 'POST',
                                        headers: {
