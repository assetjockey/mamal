<div
    ...
    :class="{ 'hidden': activeGenerator !== 'nano-banana-pro' }"
>

    <form
        class="lqd-image-generator-flux-pro-form flex flex-col items-start gap-4"
        id="openai_generator_form_nano_banana_pro"
        onsubmit="return sendNanoBananaProGeneratorForm();"
    ...
    >
        ...
        <div class="lqd-image-generator-inputs-wrap relative w-full">
            <x-forms.input
                ...
                id="description_nano_banana_pro"
                type="textarea"
                name="description"
                x-data="{}"
                ::value="prompt"
            ...
            <x-button
                ...
                id="nano_banana_pro_generator_button"
                tag="button"
                type="submit"
            >
                {{ __('Generate') }}
