@if(setting('enabled_flux_2_flex', 1) == '1')
	<div
		class="lqd-image-generator-tabs-content lqd-image-generator-flux-two-flex hidden"
		x-data="{
		...
		:class="{ 'hidden': activeGenerator !== 'flux-2-flex' }"
	>

		<form
			class="lqd-image-generator-flux-two-flex-form flex flex-col items-start gap-4"
			id="flux_two_flex_generator_form"
			onsubmit="return sendFluxTwoFlexGeneratorForm();"
		...
		>
			...
			<div class="lqd-image-generator-inputs-wrap relative w-full">
				...
				<x-button
					...
					id="flux_two_flex_generator_button"
					tag="button"
					type="submit"
				>
					{{ __('Generate') }}
