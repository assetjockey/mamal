                        ...
                        >
                            ...
                            <div class="mx-auto flex w-[min(100%,400px)] flex-col items-center justify-center gap-4 text-center">
                                ...
                                <input
                                    ...
                                    id="image_src"
                                    :name="generator === 'gpt-image-1' || generator === 'gpt-image-1-5' || generator === 'gpt-image-2' || generator === 'flux-pro-kontext' ? 'image_src[]' :
                                        'image_src'"
                                    type="file"
                                    accept="image/*"
                                    x-ref="formFileInput"
                                    @input="handleFileChange"
                                    :multiple="generator === 'gpt-image-1' || generator === 'gpt-image-1-5' || generator === 'gpt-image-2' || generator === 'flux-pro-kontext'"
                                >
                            </div>
                        </div>
                    </div>
...
@push('script')
    <script>
        ...
        $('#submitForm').on('submit', function(e) {
            ...
            const supportImageModels = ['stable_diffusion', 'gpt-image-1', 'gpt-image-1-5', 'gpt-image-2', 'flux-pro-kontext', 'nano-banana', 'xai/grok-imagine-image'];
