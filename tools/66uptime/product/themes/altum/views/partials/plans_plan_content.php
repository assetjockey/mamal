    ...
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php if($feature == 'monitors_limit' && settings()->monitors_heartbeats->monitors_is_enabled): ?>
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->monitors_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center my-3 <?= count($data->plan_settings->monitors_ping_servers ?? []) ? null : 'text-muted' ?>">
                ...
                <i class="fas fa-fw fa-sm <?= count($data->plan_settings->monitors_ping_servers ?? []) ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'heartbeats_limit' && settings()->monitors_heartbeats->heartbeats_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->heartbeats_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'domain_names_limit' && settings()->monitors_heartbeats->domain_names_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->domain_names_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'dns_monitors_limit' && settings()->monitors_heartbeats->dns_monitors_is_enabled): ?>
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->dns_monitors_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'server_monitors_limit' && settings()->monitors_heartbeats->server_monitors_is_enabled): ?>
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->server_monitors_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
		...
		<?php if($feature == 'game_servers_limit' && settings()->monitors_heartbeats->game_servers_is_enabled): ?>
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
                    ...
                    <span class="mr-1" data-toggle="tooltip" title="<?= sprintf(l('global.plan_settings.game_servers_check_intervals'), implode(', ', array_values(array_intersect_key($game_server_check_intervals, array_flip($data->plan_settings->game_servers_check_intervals ?? []))))) ?>"><i class="fas fa-fw fa-xs fa-circle-question text-gray-500"></i></span>
                </div>

                <i class="fas fa-fw fa-sm <?= $data->plan_settings->game_servers_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
		<?php endif ?>
        ...
        <?php if($feature == 'status_pages_limit' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->status_pages_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'logs_retention'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->logs_retention ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($feature == 'qr_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'password_protection_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'removable_branding_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'custom_url_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'search_engine_visibility_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->search_engine_visibility_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>

        <?php if($feature == 'custom_css_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'custom_js_is_enabled' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
        ...
        <?php if($feature == 'no_ads' && settings()->status_pages->status_pages_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
