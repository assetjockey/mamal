...
<div class="row justify-content-center">
    <?php if(settings()->plan_free->status == 1): ?>
        ...
        <div class="col-12 col-lg-6 col-xl-4 mb-4">
            <div class="card pricing-card position-relative h-100" style="<?= settings()->plan_free->color ? 'border-top-color: ' . settings()->plan_free->color : null ?>">
...
/* savings (never negative, and not shown for the base itself) */
        ...
        >
            <div class="card pricing-card position-relative h-100" style="<?= $plan->color ? 'border-top-color: ' . $plan->color : null ?>">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <div class="h1 d-none" data-plan-payment-frequency="monthly"><?= nr($monthly_price, ($selected_currency->currency_decimals ?? 2), false) ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="quarterly"><?= nr($quarterly_price, ($selected_currency->currency_decimals ?? 2), false) ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="biannual"><?= nr($biannual_price, ($selected_currency->currency_decimals ?? 2), false) ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="annual"><?= nr($annual_price, ($selected_currency->currency_decimals ?? 2), false) ?></div>
                        <div class="h1 d-none" data-plan-payment-frequency="lifetime"><?= nr($plan->prices->lifetime->{currency()}, ($selected_currency->currency_decimals ?? 2), false) ?></div>
    ...
    <?php if(settings()->plan_custom->status == 1): ?>
        ...
        <div class="col-12 col-lg-6 col-xl-4 mb-4">
            <div class="card pricing-card position-relative h-100" style="<?= settings()->plan_custom->color ? 'border-top-color: ' . settings()->plan_custom->color : null ?>">
