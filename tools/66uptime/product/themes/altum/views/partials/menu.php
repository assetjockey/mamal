                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    <div class="pr-lg-3">
                                        ...
                                        <?php if(settings()->monitors_heartbeats->game_servers_is_enabled): ?>
                                            <a href="<?= url('game-servers') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-gamepad mr-2"></i> <?= l('game_servers.menu') ?></a>
                                        <?php endif ?>
                                        ...
                                        <?php if(settings()->monitors_heartbeats->monitors_is_enabled || settings()->monitors_heartbeats->heartbeats_is_enabled): ?>
                                            <a href="<?= url('incidents') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-exclamation-circle mr-2"></i> <?= l('incidents.menu') ?></a>
                                        <?php endif ?>
