...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0 text-truncate"><i class="fas fa-fw fa-xs fa-gamepad text-primary-900 mr-2"></i> <?= l('admin_game_servers.header') ?></h1>

    <div class="d-flex position-relative d-print-none">
        <div class="ml-3">
            <a href="<?= url('admin/statistics/game_servers') ?>" class="btn btn-gray-300" data-tooltip title="<?= l('global.statistics') ?>">
        ...
        <div class="ml-3">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/game-servers?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->csv ? null : get_plan_feature_disabled_info() ?>>
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/game-servers?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->json ? null : get_plan_feature_disabled_info() ?>>
...
<form id="table" action="<?= SITE_URL . 'admin/game-servers/bulk' ?>" method="post" role="form">
                ...
                <tr>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <small class="text-muted d-inline-flex align-items-center">
                                <?php if($row->is_enabled): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?= url('incident/' . $row->incident_id) ?>" class="text-decoration-none mr-2" data-toggle="tooltip" title="<?= l('game_servers.is_not_ok') ?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/game-servers/admin_game_server_dropdown_button.php', ['id' => $row->game_server_id, 'resource_name' => $row->name]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/universal_delete_modal_url.php', [
        ...
        'path' => 'admin/game-servers/delete/'
]), 'modals'); ?>
