    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    <label for="game_servers_limit"><?= l('admin_plans.plan.game_servers_limit') ?></label>
                    <input type="number" id="game_servers_limit" name="game_servers_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->game_servers_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="game_servers_check_intervals"><?= l('admin_plans.plan.game_servers_check_intervals') ?></label>
                    <select id="game_servers_check_intervals" name="game_servers_check_intervals[]" class="custom-select" multiple="multiple">
						<?php foreach($data->game_server_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->user->plan_settings->game_servers_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
								<?= $value ?>
                            </option>
						<?php endforeach ?>
                    </select>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="search_engine_visibility_is_enabled" name="search_engine_visibility_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->search_engine_visibility_is_enabled ? 'checked="checked"' : null ?>>
