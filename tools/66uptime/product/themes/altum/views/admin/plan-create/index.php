        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="game_servers_limit" name="game_servers_limit" min="-1" class="form-control" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="search_engine_visibility_is_enabled" name="search_engine_visibility_is_enabled" type="checkbox" class="custom-control-input">
