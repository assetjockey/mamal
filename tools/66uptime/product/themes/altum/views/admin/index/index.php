            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/monitors') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="monitors">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="monitors_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/heartbeats') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="heartbeats">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="heartbeats_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/server-monitors') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="server_monitors">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="server_monitors_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/status-pages') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="status_pages">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="status_pages_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
...
<script>
    ...
    (async function fetch_statistics() {
        ...
        if(data.status == 'error') {
            ...
            document.querySelector('#monitors').innerHTML = data.details.monitors ? nr(data.details.monitors) : 0;
            document.querySelector('#monitors_current_month').innerHTML = data.details.monitors_current_month ? nr(data.details.monitors_current_month) : 0;

            document.querySelector('#heartbeats').innerHTML = data.details.heartbeats ? nr(data.details.heartbeats) : 0;
            document.querySelector('#heartbeats_current_month').innerHTML = data.details.heartbeats_current_month ? nr(data.details.heartbeats_current_month) : 0;

            document.querySelector('#status_pages').innerHTML = data.details.status_pages ? nr(data.details.status_pages) : 0;
            document.querySelector('#status_pages_current_month').innerHTML = data.details.status_pages_current_month ? nr(data.details.status_pages_current_month) : 0;

            document.querySelector('#server_monitors').innerHTML = data.details.server_monitors ? nr(data.details.server_monitors) : 0;
            document.querySelector('#server_monitors_current_month').innerHTML = data.details.server_monitors_current_month ? nr(data.details.server_monitors_current_month) : 0;
