...
<div class="admin-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminGameServers']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/game-servers') ?>">
                    <i class="fas fa-fw fa-sm fa-gamepad mr-2"></i> <?= l('admin_game_servers.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminIncidents']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/incidents') ?>">
                    <i class="fas fa-fw fa-sm fa-exclamation-circle mr-2"></i> <?= l('admin_incidents.menu') ?>
                </a>
            </li>
