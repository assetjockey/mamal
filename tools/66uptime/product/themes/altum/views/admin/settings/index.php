        ...
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <optgroup label="<?= l('admin_settings.general') ?>">
                    ...
                    <option value="<?= url('admin/settings/status_pages') ?>" <?= $data->method == 'status_pages' ? 'selected="selected"' : null ?>>📶 <?= l('admin_settings.status_pages.tab') ?></option>
                    <option value="<?= url('admin/settings/monitors_heartbeats') ?>" <?= $data->method == 'monitors_heartbeats' ? 'selected="selected"' : null ?>>❤️‍🔥 <?= l('admin_settings.monitors_heartbeats.tab') ?></option>
