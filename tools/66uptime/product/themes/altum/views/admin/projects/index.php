                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            <a href="<?= url('admin/monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('monitors.title') ?>">
                                <i class="fas fa-fw fa-server text-muted"></i>
                            </a>

                            <a href="<?= url('admin/heartbeats?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('heartbeats.title') ?>">
                                <i class="fas fa-fw fa-heartbeat text-muted"></i>
                            </a>

                            <a href="<?= url('admin/domain-names?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('domain_names.title') ?>">
                                <i class="fas fa-fw fa-network-wired text-muted"></i>
                            </a>

                            <a href="<?= url('admin/dns-monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('dns_monitors.title') ?>">
                                <i class="fas fa-fw fa-plug text-muted"></i>
                            </a>

                            <a href="<?= url('admin/server-monitors?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('server_monitors.title') ?>">
                                <i class="fas fa-fw fa-microchip text-muted"></i>
                            </a>

                            <a href="<?= url('admin/game-servers?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('game_servers.title') ?>">
                                <i class="fas fa-fw fa-gamepad text-muted"></i>
                            </a>

                            <a href="<?= url('admin/status-pages?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('status_pages.title') ?>">
