    ...
    <div class="mb-3 mb-xl-0 col-12 col-xl-4 order-xl-1">
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <optgroup label="<?= l('admin_statistics.monitors') ?>">
                    <option value="<?= url('admin/statistics/monitors?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'monitors' ? 'selected' : null ?>>🖥️ <?= l('admin_monitors.menu') ?></option>
                    <option value="<?= url('admin/statistics/monitors_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'monitors_logs' ? 'selected' : null ?>>🔁 <?= l('admin_statistics.monitors_logs.menu') ?></option>
                    <option value="<?= url('admin/statistics/dns_monitors?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'dns_monitors' ? 'selected' : null ?>>🔌 <?= l('admin_dns_monitors.menu') ?></option>
                    <option value="<?= url('admin/statistics/dns_monitors_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'dns_monitors_logs' ? 'selected' : null ?>>🔁 <?= l('admin_statistics.dns_monitors_logs.menu') ?></option>
                    <option value="<?= url('admin/statistics/game_servers?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'game_servers' ? 'selected' : null ?>>🎮 <?= l('admin_game_servers.menu') ?></option>
                    <option value="<?= url('admin/statistics/game_servers_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'game_servers_logs' ? 'selected' : null ?>>🔁 <?= l('admin_statistics.game_servers_logs.menu') ?></option>
                    <option value="<?= url('admin/statistics/server_monitors?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'server_monitors' ? 'selected' : null ?>>🧠 <?= l('admin_server_monitors.menu') ?></option>
                    <option value="<?= url('admin/statistics/server_monitors_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'server_monitors_logs' ? 'selected' : null ?>>🔁 <?= l('admin_statistics.server_monitors_logs.menu') ?></option>
                    <option value="<?= url('admin/statistics/heartbeats?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'heartbeats' ? 'selected' : null ?>>💓 <?= l('admin_heartbeats.menu') ?></option>
                    <option value="<?= url('admin/statistics/heartbeats_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'heartbeats_logs' ? 'selected' : null ?>>📉 <?= l('admin_statistics.heartbeats_logs.menu') ?></option>
                    <option value="<?= url('admin/statistics/domain_names?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'domain_names' ? 'selected' : null ?>>🌐 <?= l('admin_domain_names.menu') ?></option>
                    <option value="<?= url('admin/statistics/status_pages?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'status_pages' ? 'selected' : null ?>>📶 <?= l('admin_status_pages.menu') ?></option>
                    <option value="<?= url('admin/statistics/incidents?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'incidents' ? 'selected' : null ?>>❗ <?= l('admin_incidents.menu') ?></option>
                </optgroup>

                <optgroup label="<?= l('admin_statistics.tools_category') ?>">
                    <option value="<?= url('admin/statistics/tools_views?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'tools_views' ? 'selected' : null ?>>👁️ <?= l('admin_statistics.tools_views.menu') ?></option>
                    <option value="<?= url('admin/statistics/tools_submissions?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'tools_submissions' ? 'selected' : null ?>>➕ <?= l('admin_statistics.tools_submissions.menu') ?></option>
                    <option value="<?= url('admin/statistics/tools_ratings?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" <?= $data->type == 'tools_ratings' ? 'selected' : null ?>>⭐ <?= l('admin_statistics.tools_ratings.menu') ?></option>
                </optgroup>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'game_servers' ? 'active' : null ?>" href="<?= url('admin/statistics/game_servers?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-gamepad mr-1"></i> <?= l('admin_game_servers.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'game_servers_logs' ? 'active' : null ?>" href="<?= url('admin/statistics/game_servers_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-th-list mr-1"></i> <?= l('admin_statistics.game_servers_logs.menu') ?></a>
                    ...
                    <a class="nav-link <?= $data->type == 'incidents' ? 'active' : null ?>" href="<?= url('admin/statistics/incidents?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-exclamation-circle mr-1"></i> <?= l('admin_incidents.menu') ?></a>
