                    ...
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/monitors') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-server text-primary-600"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/dns-monitors') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-plug text-primary-600"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/server-monitors') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-microchip text-primary-600"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/heartbeats') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-heartbeat text-primary-600"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/domain-names') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-network-wired text-primary-600"></i>
                            </a>
                        </div>
                    </div>
        ...
        <?php if(settings()->monitors_heartbeats->game_servers_is_enabled): ?>
            <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
                <div class="card d-flex flex-row h-100 overflow-hidden">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/game-servers') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-gamepad text-primary-600"></i>
                            </a>
                        </div>
                    </div>

                    <div class="card-body d-flex align-items-center font-weight-450">
                        <?= l('game_servers.title') ?>
                    </div>
                </div>
            </div>
        <?php endif ?>
        ...
        <?php if(settings()->monitors_heartbeats->monitors_is_enabled || settings()->monitors_heartbeats->heartbeats_is_enabled): ?>
            <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
                <div class="card d-flex flex-row h-100 overflow-hidden">
                    <div class="pl-3 d-flex flex-column justify-content-center">
                        <div class="p-2 rounded-2x api-widget-icon d-flex align-items-center justify-content-center bg-primary-100">
                            <a href="<?= url('api-documentation/incidents') ?>" class="stretched-link">
                                <i class="fas fa-fw fa-sm fa-exclamation-circle text-primary-600"></i>
                            </a>
                        </div>
                    </div>
