...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="<?= url('server-monitor/' . $data->id) ?>"><i class="fas fa-fw fa-sm fa-microchip mr-2"></i> <?= l('global.view') ?></a>
...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'server_monitor_duplicate_modal', 'resource_id' => 'server_monitor_id', 'path' => 'server-monitors/duplicate']), 'modals', 'server_monitor_duplicate_modal'); ?>
