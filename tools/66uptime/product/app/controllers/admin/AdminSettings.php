...
class AdminSettings extends Controller {
    ...
    public function custom_images() {
        ...
        if(!empty($_POST)) {
            ...
            $images_keys = [
                'index/custom-domains.jpg',
                'index/custom-request.jpg',
                'index/custom-response.jpg',
                'index/dns-monitor.webp',
                'index/domain-names.webp',
                'index/heartbeat.webp',
                'index/incidents.webp',
                'index/monitor.webp',
                'index/notifications.jpg',
                'index/ping-servers.jpg',
                'index/projects.jpg',
                'index/server-monitors.webp',
                'index/status-page.webp',
                'index/game-servers.webp',
    ...
    public function status_pages() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                'report_is_enabled' => isset($_POST['report_is_enabled']),
    ...
    public function monitors_heartbeats() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'game_servers_is_enabled' => isset($_POST['game_servers_is_enabled']),
                ...
                'monitors_batch_iterations_per_cron' => $_POST['monitors_batch_iterations_per_cron'],
                'monitors_checks_per_batch_iteration_per_cron' => $_POST['monitors_checks_per_batch_iteration_per_cron'],
                'monitors_batch_iterations_per_cron_advanced' => $_POST['monitors_batch_iterations_per_cron_advanced'],
                'monitors_checks_per_batch_iteration_per_cron_advanced' => $_POST['monitors_checks_per_batch_iteration_per_cron_advanced'],

                'heartbeats_checks_per_cron' => $_POST['heartbeats_checks_per_cron'],
                'heartbeats_checks_per_batch_iteration_per_cron' => $_POST['heartbeats_checks_per_batch_iteration_per_cron'],

                'dns_monitors_checks_per_cron' => $_POST['dns_monitors_checks_per_cron'],
                'dns_monitors_checks_per_batch_iteration_per_cron' => $_POST['dns_monitors_checks_per_batch_iteration_per_cron'],

                'domain_names_checks_per_cron' => $_POST['domain_names_checks_per_cron'],
                'domain_names_checks_per_batch_iteration_per_cron' => $_POST['domain_names_checks_per_batch_iteration_per_cron'],

				'game_servers_checks_per_cron' => $_POST['game_servers_checks_per_cron'],
				'game_servers_checks_per_batch_iteration_per_cron' => $_POST['game_servers_checks_per_batch_iteration_per_cron'],

                'monitors_email_reports_per_cron' => $_POST['monitors_email_reports_per_cron'],
                'heartbeats_email_reports_per_cron' => $_POST['heartbeats_email_reports_per_cron'],
            ]);
