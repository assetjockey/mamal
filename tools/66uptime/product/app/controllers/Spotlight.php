    ...
    public function index() {
        ...
        if(is_logged_in()) {
			...
			if(settings()->monitors_heartbeats->game_servers_is_enabled) {
				$available_pages[] = [
					'name' => l('game_servers.title'),
					'url' => 'game-servers'
				];

				$available_pages[] = [
					'name' => l('game_servers_import.title'),
					'url' => 'game-servers-import'
				];

				$available_pages[] = [
					'name' => l('game_server_create.title'),
					'url' => 'game-server-create'
				];
			}
            ...
            if(settings()->monitors_heartbeats->server_monitors_is_enabled) {
                ...
                $available_pages[] = [
                    'name' => l('server_monitors_import.title'),
                    'url' => 'server-monitors-import'
                ];
            ...
            if(settings()->monitors_heartbeats->heartbeats_is_enabled) {
                ...
                $available_pages[] = [
                    'name' => l('heartbeats_import.title'),
                    'url' => 'heartbeats-import'
                ];
            ...
            if(settings()->monitors_heartbeats->domain_names_is_enabled) {
                ...
                $available_pages[] = [
                    'name' => l('domain_names_import.title'),
                    'url' => 'domain-names-import'
                ];
            ...
            if(settings()->monitors_heartbeats->dns_monitors_is_enabled) {
                ...
                $available_pages[] = [
                    'name' => l('dns_monitors_import.title'),
                    'url' => 'dns-monitors-import'
                ];
            ...
            if(user()->type == 1 && file_exists(APP_PATH . 'languages/admin/' . \Altum\Language::$name . '#' . \Altum\Language::$code . '.php')) {
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_incidents.menu'),
                    'url'  => 'admin/incidents'
                ];
                $available_pages[] = [
