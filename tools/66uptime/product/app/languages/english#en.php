...
return [
	...
	'global.plan_settings.game_servers_limit' => '%s game servers',
	'global.plan_settings.game_servers_check_intervals' => 'Check intervals: %s',
    ...
    'global.plan_settings.search_engine_visibility_is_enabled_help' => 'You will be able to toggle search engines (like Google) from indexing your status pages.',
	...
	'dashboard.game_servers.header' => 'Latest game servers',
    ...
    'index.game_servers.header' => 'Game servers',
    'index.game_servers.subheader' => 'Track uptime, performance, and player activity for your game servers.',
    'index.game_servers.uptime' => 'Uptime & latency monitoring',
    'index.game_servers.players' => 'Online players & slots tracking',
    'index.game_servers.status' => 'Server status & version detection',
    'index.game_servers.games' => '%s games supported',
    ...
    'index.pricing.subheader' => 'Choose the plan that is right for you',
    ...
    'incidents.failed_checks_help' => 'Including instant retries',
    ...
    'incidents.is_solved' => 'Mark incident as resolved',
    ...
    'monitors_import.breadcrumb' => 'Import monitors',
    'monitors_import.title' => 'Import monitors',
    'monitors_import.menu' => 'Import monitors',
    'monitors_import.header' => 'Import monitors',
    ...
    'monitor.checks.incident_checks' => 'Last incident checks',
    ...
    'status_page.language_code' => 'Language',
    ...
    'status_page.error_message.blacklisted_url' => 'This custom URL is not available for usage.',
    ...
    'status_page_statistics.country_from_continent_code' => 'Countries of %s',
    ...
    'heartbeats_import.breadcrumb' => 'Import heartbeats',
    'heartbeats_import.title' => 'Import heartbeats',
    'heartbeats_import.menu' => 'Import heartbeats',
    'heartbeats_import.header' => 'Import heartbeats',
    ...
    'server_monitors_import.breadcrumb' => 'Import server monitors',
    'server_monitors_import.title' => 'Import server monitors',
    'server_monitors_import.menu' => 'Import server monitors',
    'server_monitors_import.header' => 'Import server monitors',
	...
	'game_servers.breadcrumb' => 'Game servers',
	'game_servers.title' => 'Game servers',
	'game_servers.menu' => 'Game servers',
	'game_servers.header' => 'Game servers',
	'game_servers.subheader' => 'Track your game server status, players and data.',
	'game_servers.create' => 'Create game server',
	'game_servers.last_check_datetime_x' => 'Last check %s',
	'game_servers.last_check_datetime' => 'Last check datetime',
	'game_servers.average_response_time' => 'Avg. response time',
    'game_servers.average_online_players' => 'Avg. online players',
	'game_servers.players' => 'Players',
	'game_servers.online_players' => 'Online players',
	'game_servers.maximum_online_players' => 'Maximum online players',
	'game_servers.game_server' => 'Game server',
	'game_servers.is_ok' => 'Server is online',
	'game_servers.is_not_ok' => 'Server is down',
	'game_servers.pending_check' => 'Pending first check',
	'game_servers.response_time' => 'Response time',
	'game_servers.is_enabled_paused' => 'Game server is paused',
	'game_servers.uptime' => 'Uptime',
	'game_servers.checks.error' => 'Error',
	'game_servers.no_data' => 'There are no tracked game servers',
	'game_servers.no_data_help' => 'Start by setting up your game server.',


	'game_servers_import.breadcrumb' => 'Import game servers',
	'game_servers_import.title' => 'Import game servers',
	'game_servers_import.menu' => 'Import game servers',
	'game_servers_import.header' => 'Import game servers',


	'game_server.breadcrumb' => 'Game server',
	'game_server.title' => 'Game server - %s',
	'game_server.menu' => 'Game server',
	'game_server.header' => '%s game server',
	'game_server.total_checks_tooltip' => 'Based on %s total checks',
	'game_server.total_ok_checks_tooltip' => 'Based on %s ok checks',
    'game_server.total_checks' => 'Total checks',
    'game_server.currently_up_for' => 'Currently up for',
    'game_server.currently_down_for' => 'Currently down for',
    'game_server.last_not_ok_datetime_tooltip' => 'Last incident on %s',
    'game_server.check_interval_seconds_tooltip' => 'Checked every %s seconds',
    'game_server.downtime_tooltip' => '%s downtime',
	'game_server.last_check_datetime' => 'Last check',
	'game_server.is_enabled' => 'Game server is receiving data',
	'game_server.pending_log' => 'Game server is expecting data',
	'game_server.input.check_interval_seconds' => 'Check interval',
	'game_server.input.check_interval_seconds_help' => 'How often should we check your game server for data.',
    'game_server.input.type' => 'Game',
    'game_server.input.target' => 'Address',
	'game_server.input.target_placeholder' => '123.45.67.89',
	'game_server.input.port' => 'Port',
	'game_server.input.port_placeholder' => '25565',
    'game_server.input.query_port' => 'Query port',
    'game_server.input.query_port_placeholder' => '25565',
	'game_server.input.timeout_seconds' => 'Request timeout',
	'game_server.input.is_enabled' => 'Game server is active',
	'game_server.input.advanced' => 'Advanced settings',
	'game_server.no_data' => 'We are waiting for your first data',
	'game_server.no_data_help' => '%s\'s first data is expected!',
	'game_server.no_logs' => 'There are no logs on this date',
	'game_server.no_logs_help' => 'We\'ve found no data logged on this date for your game server.',

    'game_server.main' => 'Main details',
    'game_server.version' => 'Version',
    'game_server.favicon' => 'Icon',
    'game_server.motd' => 'MOTD',
    'game_server.motd_plain_text' => 'MOTD plain text',
    'game_server.mod_type' => 'Mod type',
    'game_server.hostname' => 'Hostname',
    'game_server.bots' => 'Online bots',
    'game_server.secure' => 'VAC',
    'game_server.password' => 'Password',
    'game_server.map' => 'Map',
    'game_server.online_players' => 'Online players',
    'game_server.frags' => 'Frags',
    'game_server.online_time' => 'Online time',
    'game_server.variables' => 'Game variables',
    'game_server.key' => 'Name',
    'game_server.value' => 'Value',
    'game_server.players_list' => 'Online players list',
    'game_server.players_list.no_data' => 'There are no online players right now.',

    'game_server.last_checks' => 'Last checks',
    'game_server.incident_checks' => 'Last incident checks',
    'game_server.response_time' => 'Response time',
    'game_server.response_status_code' => 'Response status code',
    'game_server.datetime' => 'Date',
    'game_server.higher_than_average' => '%s higher than the %s average',
    'game_server.lower_than_average' => '%s lower than the %s average',
    'game_server.last_checks_no_data' => 'There are no logged checks in this time period.',
    'game_server.error' => 'Error',


    'game_server_logs.breadcrumb' => 'Game server logs',
    'game_server_logs.title' => 'Game server logs - %s',
    'game_server_logs.menu' => 'Logs',
    'game_server_logs.header' => '%s game server logs',


	'game_server_create.breadcrumb' => 'Create game server',
	'game_server_create.title' => 'Create game server',
	'game_server_create.header' => 'Create a new game server',
	'game_server_create.success_message' => 'Your new game server has been created and is now waiting for the first run.',


	'game_server_update.breadcrumb' => 'Edit game server',
	'game_server_update.title' => 'Edit game server - %s',
    ...
    'domain_names_import.breadcrumb' => 'Import domain names',
    'domain_names_import.title' => 'Import domain names',
    'domain_names_import.menu' => 'Import domain names',
    'domain_names_import.header' => 'Import domain names',
    ...
    'dns_monitors_import.breadcrumb' => 'Import DNS monitors',
    'dns_monitors_import.title' => 'Import DNS monitors',
    'dns_monitors_import.menu' => 'Import DNS monitors',
    'dns_monitors_import.header' => 'Import DNS monitors',
